...
\item \describefun{int}{pnl_object_mpi_reduce}{\refstruct{PnlObject} \ptr Recvbuf, const
  \refstruct{PnlObject} \ptr Sendbuf, MPI_Op op, int root, MPI_Comm comm}
  \sshortdescribe This function performs the reduction described by \var{op} on
