...
\item \describefun{\refstruct{PnlRng}\ptr }{pnl_rng_copy}{const
  ...
  \sshortdescribe Creates a copy of \var{rng}.
...
\item \describefun{\refstruct{PnlRng}\ptr}{pnl_rng_dcmt_create_id}{int id, ulong
    seed}
  \sshortdescribe Creates a generator with type \var{PNL_RNG_DCMT} and identifier
...
\item \describefun{\refstruct{PnlRng}\ptr \ptr
    ...
    count}
  \sshortdescribe Creates an array of generators with types \var{PNL_RNG_DCMT}
