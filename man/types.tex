...
struct _PnlObject
{
  ...
  new_func     *constructor; /*!< Constructor function */
...
\item \describefun{\refstruct{PnlList}\ptr }{pnl_list_copy}{const \refstruct{PnlList}\ptr A}
  \sshortdescribe Creates a copy of a \refstruct{PnlList}. Each element of the
...
\item \describefun{void}{pnl_list_clone}{\refstruct{PnlList} \ptr dest, const
  ...
  \sshortdescribe Copies the content of \var{src} into the already existing
...
\item \describefun{\refstruct{PnlArray} \ptr }{pnl_array_create}{int n}
  \sshortdescribe Creates an array of length \var{n}.
\item \describefun{\refstruct{PnlArray}\ptr }{pnl_array_copy}{const \refstruct{PnlArray}\ptr A}
  \sshortdescribe Creates a copy of a \refstruct{PnlArray}. Each element of the
...
\item \describefun{int}{pnl_array_resize}{\refstruct{PnlArray} \ptr  T, int size}
  \sshortdescribe Resizes \var{T} to be \var{size} long. As much as possible of
