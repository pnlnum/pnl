...
\item \describefun{void}{pnl_qsort}{void *a, int n, int es, int lda, int *t,
  ...
  \sshortdescribe Sorts the array \var{a} using the comparaison function
  \var{cmp}. \var{n} is the number elements in \var{a}, each element being of
...
\begin{itemize}
\item \describefun{double}{pnl_sf_gamma}{double a, double x}
  \sshortdescribe   computes $\Gamma(x), x \geq 0$
\item \describefun{double}{pnl_sf_log_gamma}{double a, double x}
