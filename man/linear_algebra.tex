...
\item \describefun{\refstruct{PnlVect}}{pnl_vect_wrap_subvect}{const
  ...
  \item \describefun{\refstruct{PnlVect}}{pnl_vect_create_wrap_subvect_with_last}{const \refstruct{PnlVect} \ptr x, int i, int j}
...
\item \describefun{void}{pnl_bandmat_map_map}{\refstruct{PnlBandMat} \ptr lhs, const
