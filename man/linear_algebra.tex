...
with row interchanges needed in the LU decomposition.  We use the {\it Blas}
convention for storing permutation. Consider a \verb!PnlPermutation p! generated
by a LU decomposition of matrix \verb!A! : to compute de decomposition, row
\verb!i! of \verb!A! was interchanged with row \verb!p(i)!.
