...
\item \describefun{\refstruct{PnlVect} \ptr }{pnl_vect_create_from_scalar}
  {int size, double x}
...
\item \describefun{\refstruct{PnlVect} \ptr }{pnl_vect_create_from_ptr}{int
  ...
  to \var{array}.  
\item \describefun{\refstruct{PnlVect} \ptr }{pnl_vect_create_from_mat}{
  const PnlMat *M}
  \sshortdescribe Create a new \refstruct{PnlVect} pointer of size \var{M->mn}
...
\item \describefun{void}{pnl_vect_set_all}{\refstruct{PnlVect} \ptr v, double x}
...
\item \describefun{void}{pnl_vect_plus_scalar}{\refstruct{PnlVect} \ptr lhs, double x}
  \sshortdescribe In-place vector scalar addition  
\item \describefun{void}{pnl_vect_minus_scalar}{\refstruct{PnlVect} \ptr lhs, double x}
  \sshortdescribe In-place vector scalar substraction  
\item \describefun{void}{pnl_vect_mult_scalar}{\refstruct{PnlVect} \ptr lhs, double x}
  \sshortdescribe In-place vector scalar multiplication  
\item \describefun{void}{pnl_vect_div_scalar}{\refstruct{PnlVect} \ptr lhs, double x}
...
\item \describefun{int}{pnl_vect_eq}{const \refstruct{PnlVect} \ptr V1,
  ...
  \var{FALSE}.
\item \describefun{int}{pnl_vect_eq_all}{const \refstruct{PnlVect} \ptr v,
    double x}
...
\item \describefun{\refstruct{PnlMat} \ptr }{pnl_mat_create_from_scalar}{int m, int n, double x}
  \sshortdescribe Create a \refstruct{PnlMat} with \var{m} rows and \var{n}
  columns and sets all the elements to \var{x}.

\item \describefun{\refstruct{PnlMat} \ptr }{pnl_mat_create_from_zero}{int m, int n}
  \sshortdescribe Create a \refstruct{PnlMat} with \var{m} rows and \var{n}
...
\item \describefun{void}{pnl_mat_set_subblock}{\refstruct{PnlMat} \ptr
    M, const \refstruct{PnlMat} \ptr block, int i, int j}
...
\item \describefun{void}{pnl_mat_set_all}{\refstruct{PnlMat} \ptr M, double x}
...
\item \describefun{void}{pnl_mat_add_row}{\refstruct{PnlMat} \ptr M, int i, const \refstruct{PnlVect} \ptr r}
...
\item \describefun{void}{pnl_mat_del_row}{\refstruct{PnlMat} \ptr M, int i}
...
\begin{itemize}
  \item \describefun{void}{pnl_mat_plus_scalar}{\refstruct{PnlMat} \ptr lhs, double x}
  \sshortdescribe In-place matrix scalar addition  

\item \describefun{void}{pnl_mat_minus_scalar}{\refstruct{PnlMat} \ptr lhs, double x}
  \sshortdescribe In-place matrix scalar substraction  

\item \describefun{void}{pnl_mat_mult_scalar}{\refstruct{PnlMat} \ptr lhs, double x}
  \sshortdescribe In-place matrix scalar multiplication  

\item \describefun{void}{pnl_mat_div_scalar}{\refstruct{PnlMat} \ptr lhs, double x}
...
\item \describefun{int}{pnl_mat_eq}{const \refstruct{PnlMat} \ptr M1,
  ...
  \var{FALSE}.
\item \describefun{int}{pnl_mat_eq_all}{const \refstruct{PnlMat} \ptr M,
    double x}
...
\item \describefun{double}{pnl_mat_trace}{const \refstruct{PnlMat} \ptr M}
...
\begin{itemize}
  \item \describefun{\refstruct{PnlMatComplex}\ptr }{pnl_mat_complex_create_from_mat}{const \refstruct{PnlMat} \ptr R}
...
\begin{itemize}
  ...
  \item \describefun{\refstruct{PnlTridiagMat} \ptr }{pnl_tridiag_mat_create_from_scalar}{int size, double x}
    \sshortdescribe Create a \refstruct{PnlTridiagMat} with the 3 diagonals
    filled with \var{x}
  \item \describefun{\refstruct{PnlTridiagMat} \ptr }{pnl_tridiag_mat_create_from_two_scalar}{int size, double x, double y}
...
\begin{itemize}
  ...
  \item \describefun{void}{pnl_tridiag_mat_minus_tridiag_mat}{\refstruct{PnlTridiagMat} \ptr lhs, const \refstruct{PnlTridiagMat} \ptr rhs}
    \sshortdescribe In-place matrix matrix substraction  
  \item \describefun{void}{pnl_tridiag_mat_plus_scalar}{\refstruct{PnlTridiagMat} \ptr lhs, double x}
    \sshortdescribe In-place matrix scalar addition  
  \item \describefun{void}{pnl_tridiag_mat_minus_scalar}{\refstruct{PnlTridiagMat} \ptr lhs, double x}
    \sshortdescribe In-place matrix scalar substraction  
  \item \describefun{void}{pnl_tridiag_mat_mult_scalar}{\refstruct{PnlTridiagMat} \ptr lhs, double x}
    \sshortdescribe In-place matrix scalar multiplication  
  \item \describefun{void}{pnl_tridiag_mat_div_scalar}{\refstruct{PnlTridiagMat} \ptr lhs, double x}
    \sshortdescribe In-place matrix scalar division
\end{itemize}
...
\item \describefun{void}{pnl_band_mat_set_all}{\refstruct{PnlBandMat}
    \ptr M, double x}
...
\begin{itemize}
  \item \describefun{void}{pnl_band_mat_plus_scalar}{\refstruct{PnlBandMat} \ptr lhs, 
  double x} 
    \sshortdescribe In-place addition, \var{lhs += x} 

  \item \describefun{void}{pnl_band_mat_minus_scalar}{\refstruct{PnlBandMat} \ptr lhs, 
  double x} 
  \sshortdescribe In-place substraction \var{lhs -= x} 

\item \describefun{void}{pnl_band_mat_div_scalar}{\refstruct{PnlBandMat}
  \ptr lhs, double x} 
  \sshortdescribe \var{lhs = lhs ./ x}

\item \describefun{void}{pnl_band_mat_mult_scalar}{\refstruct{PnlBandMat}
  \ptr lhs, double x} 
  \sshortdescribe \var{lhs = lhs * x}
...
\begin{itemize}
  ...
  \item \describefun{int}{pnl_sp_mat_resize}{\PnlSpMat \ptr M, int m, int n, int nzmax}
    \sshortdescribe Modify the sparse matrix \var{M} to have \var{m} rows and
    \var{n} columns and to hold at most \var{nz} non zero elements. Note that if
    \var{nz < M->nzmax}, no memory is freed and \var{M->nzmax} is left
    unchanged. Return \var{OK} or \var{FAIL}.

  \item \describefun{void}{pnl_sp_mat_set}{\PnlSpMat \ptr M, int i, int j, double x}
    \sshortdescribe Set \var{M(i,j) = x}.
...
\item 
  \describefun{\refstruct{PnlHmat} \ptr }{pnl_hmat_create_from_scalar}{int ndim, const int \ptr dims, double x}
...
\item \describefun{void}{pnl_hmat_mult_scalar}{\refstruct{PnlHmat} \ptr lhs, double x}
