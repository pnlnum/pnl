...
\item \describefun{\PnlMat}{pnl_mat_wrap_vect}
  ...
  the array of \var{V}. The new matrix has size \var{V->size x 1} and shares its data with the vector \var{V}, which means that any modification to one of them will affect the other.
