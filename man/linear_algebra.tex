...
\item \describefun{\PnlVect \ptr }{pnl_vect_create_from_file}
  ...
  \PnlVect. The data might be stored as a row or column vector. Entries can be separated by spaces, tabs, commas or semicolons. Anything after a '\#' is ignored up to the end of line.
...
\item \describefun{\PnlMat \ptr }{pnl_mat_create_from_file}{const char \ptr file}
  ...
  the elements of a row can be separated by spaces, tabs, commas or semicolons. Anything after a '\#' is
