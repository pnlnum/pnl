...
\item \describefun{void}{pnl_qsort_index}{\refstruct{PnlMat} \ptr ,
...
\begin{itemize}
\item 
  \describefun{void}{pnl_pnl_bandmat_set}{\refstruct{PnlBandMat}
...
\item \describefun{void}{pnl_bandmat_div_mat_term}{\refstruct{PnlBandMat}
    \ptr lhs, const \refstruct{PnlBandMat} \ptr rhs} 
  \sshortdescribe In-place term by term  division \var{lhs = lhs ./ rhs}

\item \describefun{void}{pnl_bandmat_mult_mat_term}{\refstruct{PnlBandMat}
    \ptr lhs, const \refstruct{PnlBandMat} \ptr rhs} 
...
\item \describefun{void}{pnl_bandmat_map}{\refstruct{PnlBandMat} \ptr lhs, const
  ...
  stores the result in \var{lhs}. \var{lhs(i) = f(rhs(i))}

\item \describefun{void}{pnl_bandmat_map_inplace}{\refstruct{PnlBandMat} \ptr lhs, double(\ptr f)(double)}
  \sshortdescribe Same function as \reffun{pnl_bandmat_map} but the result is
  stored in \var{lhs} itself. \var{lhs(i) = f(lhs(i))}
\end{itemize}
