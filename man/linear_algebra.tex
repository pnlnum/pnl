...
\item \describefun{void}{pnl_vect_extract_subblock}{\refstruct{PnlVect} \ptr
    M_sub, const \refstruct{PnlMat} \ptr M, int i, int len_i, int j, int
    len_j}
  \sshortdescribe \var{M_sub = M(i:i+len_i, j:j+len_j)};
