...
\item \describefun{void}{pnl_sparse_mat_map_inplace}{\refstruct{PnlSparseMat} $\ast$lhs, double($\ast$f)(double)}
  \sshortdescribe Same function as \reffun{pnl_sparse_mat_map} but the result is
  stored in \var{lhs} itself.
\end{itemize}
