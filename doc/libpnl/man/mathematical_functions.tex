...
\begin{itemize}
\item \describefun{double}{pnl_sp_erf}{double x}
  \sshortdescribe Computes $\frac{2}{\pi}\int_0^\infty \expp{-t^2} ft$
\item \describefun{double}{pnl_sp_erfc}{double x}
  \sshortdescribe Computes $1. - \frac{2}{\pi}\int_0^\infty \expp{-t^2} ft$
\item \describefun{double}{pnl_sp_log_erf}{double x}
  \sshortdescribe Computes $\log(pnl_sp_erf (x))$
\item \describefun{double}{pnl_sp_log_erfc}{double x}
  \sshortdescribe Computes$\log(pnl_sp_erfc (x))$
\end{itemize}
...
\begin{itemize}
\item \describefun{double}{pnl_gamma_inc}{double a, double x}
  \sshortdescribe   computes $\Gamma(a, x), \quad a \in \R , x \geq 0$
\item \describefun{void}{pnl_gamma_inc_P}{double a, double x}
  \sshortdescribe  computes $P(a, x), \quad a > 0 , x \geq 0$
\item \describefun{void}{pnl_gamma_inc_Q}{double a, double x}
...
\begin{itemize}
\item 
  \describefun{double}{pnl_bs_call}{double s,double k,double T,double r,double divid,double sigma}
...
\item 
  \describefun{double}{pnl_bs_put}{double s,double k,double T,double r,double divid,double sigma}
...
\item 
  \describefun{double}{pnl_bs_call_put}{int iscall, double s,double k,double T,double r,
...
\item 
  \describefun{double}{pnl_bs_vega}{double s,double k,double T,double r,double divid,double sigma}
...
\item 
  \describefun{double}{pnl_bs_gamma}{double s,double k,double T,double r,double divid,double sigma}
...
\item 
  ...
  \var{error} is \var{OK} if the computed of the implied volatility succeeded
  or \var{FAIL} if it failed.

\item 
  \describefun{int}{pnl_bs_matrix_implicit_vol}{const \refstruct{PnlMatInt}
    $\ast$iscall, const \refstruct{PnlMat} $\ast$Price, double s, 
    double r, double divid, const \refstruct{PnlVect} $\ast$K, 
    const \refstruct{PnlVect} $\ast$T, \refstruct{PnlMat} $\ast$Vol}
  \sshortdescribe Computes the matrix of implied volatilities \var{Vol(i,j)} of a put option if
  \var{iscall(i,j)=0} or a call option if \var{iscall(i,j)=1} with spot \var{s} and
  strike \var{K(j)} in the Black-Scholes model with instantaneous interest rate
  \var{r}, maturity \var{T(j)} and dividend rate \var{divid}. This function
