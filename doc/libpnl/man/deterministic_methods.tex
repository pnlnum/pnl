...
\item \describefun{int}{pnl_fit_least_squares}{\refstruct{PnlVect}$\ast$ coef, 
    ...
    \refstruct{PnlBasis}$\ast$ P, int N}
...
\item \describefun{double}{pnl_basis_eval}{\refstruct{PnlVect}$\ast$ coef, double
    $\ast$x, \refstruct{PnlBasis}$\ast$ *P}
...
\item \describefun{double}{pnl_basis_eval_D}{\refstruct{PnlVect}$\ast$ coef, double
    $\ast$x, \refstruct{PnlBasis}$\ast$ *P, int i}
...
\item \describefun{double}{pnl_basis_eval_D2}{\refstruct{PnlVect}$\ast$ coef, double
    $\ast$x, \refstruct{PnlBasis}$\ast$ *P, int i, int j}
  \sshortdescribe Computes the derivative with repsect to \var{x_i} of the
  linear combination of \var{P_k(x)} defined by \var{coef}. Given the
  coefficients computed by the function \reffun{pnl_fit_least_squares}, this
