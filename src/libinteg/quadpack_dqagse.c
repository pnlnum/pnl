/*
 * This file contains the routine dqagse from the quadpack distribution
...
extern int pnl_dqk21(PnlFunc *, double *, double *, 
...
int pnl_dqagse(PnlFunc *f, double *a, double *b, double 
