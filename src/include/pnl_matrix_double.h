...
extern void pnl_mat_lu (PnlMat *A, PnlVectInt *p);
extern void pnl_mat_lu_syslin (PnlVect *x, PnlMat *LU,
...
extern void pnl_mat_inverse_with_chol (PnlMat *inverse, const PnlMat *A);
...
extern void pnl_mat_qr (PnlMat *Q, PnlMat *R, PnlVectInt *p, const PnlMat *A);
