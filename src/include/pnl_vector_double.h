...
extern PnlVect* pnl_vect_create_subvect (const PnlVect *V, const PnlVectInt *ind);
extern void pnl_vect_extract_subvect (PnlVect *V_sub, const PnlVect *V, const PnlVectInt *ind);
...
extern void pnl_vect_find(PnlVectInt *ind, PnlVect *val, const PnlVect *V, int(*f)(double));
extern void pnl_vect_find_vect(PnlVectInt *ind, PnlVect *val, const PnlVect *V1, const PnlVect *V2, int(*f)(double,double));
