...
extern dcomplex pnl_sf_w(dcomplex z);
extern double pnl_sf_w_im(double x);
extern dcomplex pnl_sf_complex_erfcx(dcomplex z);
extern double pnl_sf_erfcx(double x);
extern dcomplex pnl_sf_complex_erf(dcomplex z);
extern double pnl_sf_erf(double x);
extern dcomplex pnl_sf_complex_erfi(dcomplex z);
extern double pnl_sf_erfi(double x);
extern dcomplex pnl_sf_complex_erfc(dcomplex x);
extern double pnl_sf_erfc(double x);
extern dcomplex pnl_sf_complex_dawson(dcomplex z);
extern double pnl_sf_dawson(double x);
