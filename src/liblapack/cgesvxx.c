...
#include "pnl/pnl_f2c.h"
 ...
 int cgesvxx_(char *fact, char *trans, int *n, int *
	nrhs, complex *a, int *lda, complex *af, int *ldaf, int *
	ipiv, char *equed, float *r__, float *c__, complex *b, int *ldb, 
	complex *x, int *ldx, float *rcond, float *rpvgrw, float *berr, 
	...
	info)
{
    ...
    /* Local variables */
    int j;
    extern double cla_rpvgrw__(int *, int *, complex *, int *,
	     complex *, int *);
    float amax;
    extern int lsame_(char *, char *);
    float rcmin, rcmax;
    int equil;
    extern  int claqge_(int *, int *, complex *, 
	    int *, float *, float *, float *, float *, float *, char *)
	    ;
    float colcnd;
    extern double slamch_(char *);
    int nofact;
    extern  int cgetrf_(int *, int *, complex *, 
	    int *, int *, int *), clacpy_(char *, int *, 
    ...
    extern  int clascl2_(int *, int *, float *, 
	    complex *, int *), cgeequb_(int *, int *, complex *, 
	    int *, float *, float *, float *, float *, float *, int *), 
	    cgerfsx_(char *, char *, int *, int *, complex *, int 
	    *, complex *, int *, int *, float *, float *, complex *, 
	    int *, complex *, int *, float *, float *, int *, float *
, float *, int *, float *, complex *, float *, int *);
