...
static int c_false = FALSE;
 ...
 int csyrfsx_(char *uplo, char *equed, int *n, int *
	nrhs, complex *a, int *lda, complex *af, int *ldaf, int *
	ipiv, float *s, complex *b, int *ldb, complex *x, int *ldx, 
	float *rcond, float *berr, int *n_err_bnds__, float *err_bnds_norm__, 
	 float *err_bnds_comp__, int *nparams, float *params, complex *work, 
	 float *rwork, int *info)
{
    ...
    int prec_type__;
    float cwise_wrong__;
    extern  int cla_syrfsx_extended__(int *, char *, 
    ...
    float anorm;
    int rcequ;
    extern double cla_syrcond_c__(char *, int *, complex *, int *,
	     complex *, int *, int *, float *, int *, int *, 
	    complex *, float *, unsigned long), cla_syrcond_x__(char *, int *, 
	    complex *, int *, complex *, int *, int *, complex *, 
	    int *, complex *, float *, unsigned long), slamch_(char *);
    extern  int xerbla_(char *, int *);
    extern double clansy_(char *, char *, int *, complex *, int *, 
	     float *);
    extern  int csycon_(char *, int *, complex *, int 
	    *, int *, float *, float *, complex *, int *);
...
/*     Perform refinement on each right-hand side */
	...
	cla_syrfsx_extended__(&prec_type__, uplo, n, nrhs, &a[a_offset], lda, 
		...
		ignore_cwise__, info, (unsigned long)1);
    }
/* Computing MAX */
