...
static float c_b28 = 0.f;
 ...
 int clarrv_(int *n, float *vl, float *vu, float *d__, float *
	l, float *pivmin, int *isplit, int *m, int *dol, int *
	dou, float *minrgp, float *rtol1, float *rtol2, float *w, float *werr, 
	float *wgap, int *iblock, int *indexw, float *gers, complex *
	...
	int *info)
{
    ...
    extern  int scopy_(int *, float *, int *, float *, 
	    int *);
    float rqtol;
    int iindc1, iindc2, indin1, indin2;
    extern  int clar1v_(int *, int *, int *, float 
...
, float *, float *, float *);
    ...
    int tryrqc;
    int isupmx;
    extern  int slarrf_(int *, float *, float *, float *, 
