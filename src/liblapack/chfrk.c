...
#include "pnl/pnl_f2c.h"
 ...
 int chfrk_(char *transr, char *uplo, char *trans, int *n, 
	 int *k, float *alpha, complex *a, int *lda, float *beta, 
	complex *c__)
{
    ...
    extern  int cgemm_(char *, char *, int *, int *, 
	    ...
	    complex *, complex *, int *), cherk_(char *, 
	    char *, int *, int *, float *, complex *, int *, float *
, complex *, int *);
...
/*  where alpha and beta are float scalars, C is an n--by--n Hermitian */
