	...
	work, double *rwork, int *info)
{
    ...
    extern  int dcopy_(int *, double *, int *, 
	    double *, int *), zcopy_(int *, doublecomplex *, 
	    int *, doublecomplex *, int *);
    extern double dlamch_(char *);
    int nofact;
    extern  int xerbla_(char *, int *);
    extern double zlanht_(char *, int *, double *, doublecomplex *
);
    extern  int zlacpy_(char *, int *, int *, 
	    doublecomplex *, int *, doublecomplex *, int *), 
	    zptcon_(int *, double *, doublecomplex *, double *, 
	    double *, double *, int *), zptrfs_(char *, int *, 
	     int *, double *, doublecomplex *, double *, 
	    doublecomplex *, doublecomplex *, int *, doublecomplex *, 
	    int *, double *, double *, doublecomplex *, 
	    double *, int *), zpttrf_(int *, double *, 
	     doublecomplex *, int *), zpttrs_(char *, int *, int *
