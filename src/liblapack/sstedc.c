	...
	int *liwork, int *info)
{
    ...
    extern  int sswap_(int *, float *, int *, float *, 
	    int *), slaed0_(int *, int *, int *, float *, float 
...
/*  The eigenvectors of a full or band float symmetric matrix can also be */
