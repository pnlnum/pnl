	...
	doublecomplex *work, double *rwork, int *info)
{
    ...
    extern double zla_porpvgrw__(char *, int *, doublecomplex *, 
	    int *, doublecomplex *, int *, double *, unsigned long);
    ...
    double smlnum;
    extern  int zpotrf_(char *, int *, doublecomplex *, 
	    int *, int *), zpotrs_(char *, int *, int 
	    *, doublecomplex *, int *, doublecomplex *, int *, 
	    int *), zlascl2_(int *, int *, double *, 
	    doublecomplex *, int *), zpoequb_(int *, doublecomplex *, 
	    int *, double *, double *, double *, int *), 
	    zporfsx_(char *, char *, int *, int *, doublecomplex *, 
