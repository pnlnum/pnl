...
static int c_false = FALSE;
 ...
 int cherfsx_(char *uplo, char *equed, int *n, int *
	 ...
	 float *rwork, int *info)
{
    ...
    int prec_type__;
    float cwise_wrong__;
    extern  int cla_herfsx_extended__(int *, char *, 
    ...
    extern double cla_hercond_c__(char *, int *, complex *, int *,
	     complex *, int *, int *, float *, int *, int *, 
	    complex *, float *, unsigned long);
    float anorm;
    int rcequ;
    extern double cla_hercond_x__(char *, int *, complex *, int *,
	     complex *, int *, int *, complex *, int *, complex *,
	     float *, unsigned long), clanhe_(char *, char *, int *, complex *, 
	    int *, float *);
    extern  int checon_(char *, int *, complex *, int 
