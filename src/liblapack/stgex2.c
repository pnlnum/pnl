	...
	int *lwork, int *info)
{
    ...
    float f, g;
    int i__, m;
    float s[16]	/* was [4][4] */, t[16]	/* was [4][4] */, be[2], ai[2], ar[2],
	     sa, sb, li[16]	/* was [4][4] */, ir[16]	/* was [4][4] 
	    */, ss, ws, eps;
    int weak;
    float ddum;
    int idum;
    float taul[4], dsum, taur[4], scpy[16]	/* was [4][4] */, tcpy[16]	
	    /* was [4][4] */;
    extern  int srot_(int *, float *, int *, float *, 
	    int *, float *, float *);
    float scale, bqra21, brqa21;
    extern  int sscal_(int *, float *, float *, int *);
    float licop[16]	/* was [4][4] */;
    int linfo;
    extern  int sgemm_(char *, char *, int *, int *, 
	    int *, float *, float *, int *, float *, int *, float *, 
	    float *, int *);
    float ircop[16]	/* was [4][4] */, dnorm;
    int iwork[4];
    extern  int slagv2_(float *, int *, float *, int *, 
	    float *, float *, float *, float *, float *, float *, float *), sgeqr2_(
	    int *, int *, float *, int *, float *, float *, int *
), sgerq2_(int *, int *, float *, int *, float *, float *
, int *), sorg2r_(int *, int *, int *, float *, 
	    int *, float *, float *, int *), sorgr2_(int *, int 
	    *, int *, float *, int *, float *, float *, int *), 
	    sorm2r_(char *, char *, int *, int *, int *, float *, 
	    int *, float *, float *, int *, float *, int *), sormr2_(char *, char *, int *, int *, int *, 
	    float *, int *, float *, float *, int *, float *, int *);
    float dscale;
    extern  int stgsy2_(char *, int *, int *, int 
...
, int *, float *, int *, float *, int *, float *, float *, 
    ...
    extern  int slaset_(char *, int *, int *, float *, 
	    float *, float *, int *), slassq_(int *, float *, 
	    int *, float *, float *);
    float smlnum;
    int strong;
...
/*  (A, B) must be in generalized float Schur canonical form (as returned */
...
/*  the internal int parameter WANDS to .FALSE.. See ref. [2] for */
/*  details. */
