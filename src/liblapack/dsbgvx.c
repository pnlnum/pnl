	...
	int *iwork, int *ifail, int *info)
{
    ...
    extern  int dcopy_(int *, double *, int *, 
	    ...
	    *, double *, int *);
    int upper, wantz, alleig, indeig;
    int indibl;
    int valeig;
    extern  int dlacpy_(char *, int *, int *, 
	    double *, int *, double *, int *), 
	    xerbla_(char *, int *), dpbstf_(char *, int *, 
	    int *, double *, int *, int *), dsbtrd_(
	    char *, char *, int *, int *, double *, int *, 
	    double *, double *, double *, int *, double *, 
	     int *);
    int indisp;
    extern  int dsbgst_(char *, char *, int *, int *, 
	    int *, double *, int *, double *, int *, 
	    double *, int *, double *, int *),
	     dstein_(int *, double *, double *, int *, 
