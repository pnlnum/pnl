...
static int c_n1 = -1;
 ...
 int cheevr_(char *jobz, char *range, char *uplo, int *n, 
	complex *a, int *lda, float *vl, float *vu, int *il, int *
	iu, float *abstol, int *m, float *w, complex *z__, int *ldz, 
	int *isuppz, complex *work, int *lwork, float *rwork, int *
	lrwork, int *iwork, int *liwork, int *info)
{
    ...
    /* Local variables */
    int i__, j, nb, jj;
    float eps, vll, vuu, tmp1, anrm;
    int imax;
    float rmin, rmax;
    int test;
    int itmp1, indrd, indre;
    float sigma;
    ...
    int iscale, ieeeok, indibl, indrdd, indifl, indree;
    int valeig;
    extern double slamch_(char *);
    extern  int chetrd_(char *, int *, complex *, int 
	    *, float *, float *, complex *, complex *, int *, int *), csscal_(int *, float *, complex *, int *);
    float safmin;
    ...
    float abstll, bignum;
    int indtau, indisp;
    extern  int cstein_(int *, float *, float *, int *, 
	    float *, int *, int *, complex *, int *, float *, 
	    int *, int *, int *);
    int indiwo, indwkn;
    extern double clansy_(char *, char *, int *, complex *, int *, 
	     float *);
    extern  int cstemr_(char *, char *, int *, float *, 
	    float *, float *, float *, int *, int *, int *, float *, 
	    complex *, int *, int *, int *, int *, float *, 
	    int *, int *, int *, int *);
    int indrwk, liwmin;
    int tryrac;
    extern  int ssterf_(int *, float *, float *, int *);
    int lrwmin, llwrkn, llwork, nsplit;
    float smlnum;
    extern  int cunmtr_(char *, char *, char *, int *, 
	    int *, complex *, int *, complex *, complex *, int *, 
	    complex *, int *, int *), sstebz_(
	    char *, char *, int *, float *, float *, int *, int *, 
...
/*     RWORK(INDRD:INDRD+N-1) stores the float tridiagonal's diagonal */
/*     entries. */
    indrd = 1;
...
/*     -written while computing the eigenvalues in SSTERF and CSTEMR. */
    indree = indrdd + *n;
/*     INDRWK is the starting offset of the left-over float workspace, and */
...
/*     returns INFO > 0. */
    indifl = indisp + *n;
/*     INDIWO is the offset of the remaining int workspace. */
    indiwo = indisp + *n;
