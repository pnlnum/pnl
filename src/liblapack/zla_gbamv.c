...
#include "pnl/pnl_f2c.h"
 ...
 int zla_gbamv__(int *trans, int *m, int *n, 
	int *kl, int *ku, double *alpha, doublecomplex *ab, 
	int *ldab, doublecomplex *x, int *incx, double *beta, 
	double *y, int *incy)
{
    ...
    /* Builtin functions */
    double d_imag(doublecomplex *), d_sign(double *, double *);

    /* Local variables */
    extern int ilatrans_(char *);
    int i__, j;
    int symb_zero__;
    int kd, iy, jx, kx, ky, info;
    double temp;
    int lenx, leny;
    double safe1;
