...
/* Character */ VOID chla_transtype__(char *ret_val, unsigned long ret_val_len, 
	int *trans)
{
...
/*  This subroutine translates from a BLAST-specified int constant to */
/*  the character string specifying a transposition operation. */

/*  CHLA_TRANSTYPE returns an CHARACTER*1.  If CHLA_TRANSTYPE is 'X', */
/*  then input is not an int indicating a transposition operator. */
