	...
	info)
{
    ...
    int nbmin, iinfo;
    int upper;
    extern  int ssytd2_(char *, int *, float *, int *, 
	    float *, float *, float *, int *), ssyr2k_(char *, char *
, int *, int *, float *, float *, int *, float *, 
	    int *, float *, float *, int *), xerbla_(
	    char *, int *);
    extern int ilaenv_(int *, char *, char *, int *, int *, 
	    int *, int *);
    extern  int slatrd_(char *, int *, int *, float *, 
...
/*  SSYTRD reduces a float symmetric matrix A to float symmetric */
