...
#include "pnl/pnl_f2c.h"
 ...
 int csysvxx_(char *fact, char *uplo, int *n, int *
	...
	nparams, float *params, complex *work, float *rwork, int *info)
{
    ...
    extern double cla_syrpvgrw__(char *, int *, int *, complex *, 
    ...
    float bignum;
    int infequ;
    extern  int claqsy_(char *, int *, complex *, int 
	    *, float *, float *, float *, char *), csytrf_(char *
, int *, complex *, int *, int *, complex *, int *
, int *);
    float smlnum;
    extern  int clascl2_(int *, int *, float *, 
	    complex *, int *), csytrs_(char *, int *, int *, 
	    complex *, int *, int *, complex *, int *, int *), csyequb_(char *, int *, complex *, int *, float *, 
	     float *, float *, complex *, int *), csyrfsx_(char *, 
