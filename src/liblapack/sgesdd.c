...
static int c_n1 = -1;
static int c__0 = 0;
static float c_b227 = 0.f;
static float c_b248 = 1.f;
	 ...
	 float *work, int *lwork, int *iwork, int *info)
{
    ...
    int bdspac;
    extern  int sbdsdc_(char *, char *, int *, float *, 
	    float *, float *, int *, float *, int *, float *, int *, 
	    float *, int *, int *), sgebrd_(int *, 
    ...
    extern  int sgelqf_(int *, int *, float *, int 
	    ...
	    *, int *, int *, float *, int *, float *, int *), slaset_(char *, int *, int *, float *, float *, 
	    float *, int *), sorgbr_(char *, int *, int *, 
...
/*  SGESDD computes the singular value decomposition (SVD) of a float */
