	...
	int *info)
{
    ...
    address a__1[2];
    int a_dim1, a_offset, c_dim1, c_offset, i__1, i__2, i__3[2], i__4, 
	    i__5;
    char ch__1[2];
    ...
    int i1, i2, i3, ib, ic, ja, jc, nb, mi, ni, nq, nw, iws;
    int left;
    extern int lsame_(char *, char *);
    int nbmin, iinfo;
    extern  int dormr3_(char *, char *, int *, int *, 
	    int *, int *, double *, int *, double *, 
	    double *, int *, double *, int *),
	     xerbla_(char *, int *);
    extern int ilaenv_(int *, char *, char *, int *, int *, 
	    int *, int *);
    extern  int dlarzb_(char *, char *, char *, char *, 
	    int *, int *, int *, int *, double *, int 
	    *, double *, int *, double *, int *, double *, 
	     int *), dlarzt_(char *, char 
	    *, int *, int *, double *, int *, double *, 
	    double *, int *);
    int notran;
    int ldwork;
...
/*  DORMRZ overwrites the general float M-by-N matrix C with */
