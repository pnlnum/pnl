	 ...
	 int *lwork, int *iwork, int *liwork, int *info)
{
    ...
    extern  int slascl_(char *, int *, int *, float *, 
	    float *, int *, int *, float *, int *, int *), sstedc_(char *, int *, float *, float *, float *, 
	    int *, float *, int *, int *, int *, int *), slacpy_(char *, int *, int *, float *, int *, 
	    float *, int *);
    int indwrk, liwmin;
...
/*  a float symmetric band matrix A. If eigenvectors are desired, it uses */
