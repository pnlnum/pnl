...
static int c__1 = 1;
 ...
 int cptsvx_(char *fact, int *n, int *nrhs, float *d__, 
	...
	*x, int *ldx, float *rcond, float *ferr, float *berr, complex *work, 
	float *rwork, int *info)
{
    ...
    extern  int ccopy_(int *, complex *, int *, 
	    complex *, int *), scopy_(int *, float *, int *, float *
, int *);
    extern double slamch_(char *), clanht_(char *, int *, 
	    float *, complex *);
    int nofact;
    extern  int clacpy_(char *, int *, int *, complex 
	    *, int *, complex *, int *), xerbla_(char *, 
	    int *), cptcon_(int *, float *, complex *, float *, 
	    float *, float *, int *), cptrfs_(char *, int *, int *, 
	    float *, complex *, float *, complex *, complex *, int *, 
	    complex *, int *, float *, float *, complex *, float *, int *
), cpttrf_(int *, float *, complex *, int *), 
	    cpttrs_(char *, int *, int *, float *, complex *, complex *
, int *, int *);
