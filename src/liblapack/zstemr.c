...
static double c_b18 = .001;
 ...
 int zstemr_(char *jobz, char *range, int *n, double *
	 ...
	 int *lwork, int *iwork, int *liwork, int *info)
{
    ...
    int itmp;
    double tnrm;
    extern  int dlae2_(double *, double *, double 
	    *, double *, double *);
    int inde2, itmp2;
    double rtol1, rtol2;
    ...
    extern  int zswap_(int *, doublecomplex *, int *, 
	    doublecomplex *, int *), dlaev2_(double *, double *, 
    ...
    int iindbl;
    int valeig;
    extern  int dlarrc_(char *, int *, double *, 
	    double *, double *, double *, double *, int *, 
	     int *, int *, int *), dlarre_(char *, 
    ...
    int wbegin;
    double safmin;
    extern  int dlarrj_(int *, double *, double *, 
    ...
    extern  int dlarrr_(int *, double *, double *, 
	     int *), dlasrt_(char *, int *, double *, int *);
    double thresh;
    int iinspl, indwrk, ifirst, liwmin, nzcmin;
    double pivmin;
    int nsplit;
    double smlnum;
    extern  int zlarrv_(int *, double *, double *, 
	     double *, double *, double *, int *, int *, 
	    int *, int *, double *, double *, double *, 
	    double *, double *, double *, int *, int *, 
	    double *, doublecomplex *, int *, int *, double *, 
	     int *, int *);
    int lquery, zquery;
...
/*           WANTZ .EQ. FALSE. */
	...
	if (zquery && *info == 0) {
	    i__1 = z_dim1 + 1;
	    z__[i__1].r = (double) nzcmin, z__[i__1].i = 0.;
