	...
	lwork, int *info)
{
    ...
    /* Local variables */
    int nbf, nbl, here, lwmin;
    extern  int stgex2_(int *, int *, int *, float 
...
/*  STGEXC reorders the generalized float Schur decomposition of a float */
...
/*          On entry, the matrix A in generalized float Schur canonical */
/*          form. */
/*          On exit, the updated matrix A, again in generalized */
/*          float Schur canonical form. */

/*  LDA     (input)  INTEGER */
/*          The leading dimension of the array A. LDA >= MAX(1,N). */

/*  B       (input/output) REAL array, dimension (LDB,N) */
/*          On entry, the matrix B in generalized float Schur canonical */
/*          form (A,B). */
/*          On exit, the updated matrix B, again in generalized */
/*          float Schur canonical form (A,B). */
