...
static int c__1 = 1;
 ...
 int cppcon_(char *uplo, int *n, complex *ap, float *anorm, 
	 float *rcond, complex *work, float *rwork, int *info)
{
    ...
    float scaleu;
    extern  int xerbla_(char *, int *), clatps_(
	    char *, char *, char *, char *, int *, complex *, complex *, 
	    float *, float *, int *);
    float ainvnm;
