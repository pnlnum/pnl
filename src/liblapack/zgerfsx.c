...
static int c_false = FALSE;
 ...
 int zgerfsx_(char *trans, char *equed, int *n, int *
	nrhs, doublecomplex *a, int *lda, doublecomplex *af, int *
	ldaf, int *ipiv, double *r__, double *c__, doublecomplex *
	b, int *ldb, doublecomplex *x, int *ldx, double *rcond, 
	...
	doublecomplex *work, double *rwork, int *info)
{
    ...
    extern  int zla_gerfsx_extended__(int *, int *, 
    ...
    double anorm;
    extern double zla_gercond_c__(char *, int *, doublecomplex *, 
	    int *, doublecomplex *, int *, int *, double *, 
	    int *, int *, doublecomplex *, double *, unsigned long), 
	    zla_gercond_x__(char *, int *, doublecomplex *, int *, 
    ...
    extern double zlange_(char *, int *, int *, doublecomplex *, 
	    int *, double *);
    extern  int zgecon_(char *, int *, doublecomplex *, 
