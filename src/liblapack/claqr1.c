...
#include "pnl/pnl_f2c.h"
 ...
 int claqr1_(int *n, complex *h__, int *ldh, complex *
...
/*     .. Executable Statements .. */
	...
	s = (r__1 = q__1.r, ABS(r__1)) + (r__2 = r_imag(&q__1), ABS(r__2)) 
		+ ((r__3 = h__[i__2].r, ABS(r__3)) + (r__4 = r_imag(&h__[
		h_dim1 + 2]), ABS(r__4)));
	if (s == 0.f) {
	    v[1].r = 0.f, v[1].i = 0.f;
	    v[2].r = 0.f, v[2].i = 0.f;
	...
	s = (r__1 = q__1.r, ABS(r__1)) + (r__2 = r_imag(&q__1), ABS(r__2)) 
		+ ((r__3 = h__[i__2].r, ABS(r__3)) + (r__4 = r_imag(&h__[
		h_dim1 + 2]), ABS(r__4))) + ((r__5 = h__[i__3].r, ABS(r__5))
		 + (r__6 = r_imag(&h__[h_dim1 + 3]), ABS(r__6)));
	if (s == 0.f) {
	    v[1].r = 0.f, v[1].i = 0.f;
	    v[2].r = 0.f, v[2].i = 0.f;
	    v[3].r = 0.f, v[3].i = 0.f;
