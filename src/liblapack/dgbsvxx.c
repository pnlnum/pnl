...
#include "pnl/pnl_f2c.h"
 ...
 int dgbsvxx_(char *fact, char *trans, int *n, int *
	...
	double *work, int *iwork, int *info)
{
    ...
    int i__, j;
    double amax;
    extern double dla_gbrpvgrw__(int *, int *, int *, int 
    ...
    double colcnd;
    extern  int dgbtrf_(int *, int *, int *, 
    ...
    extern  int dlascl2_(int *, int *, double *, 
	    double *, int *), dgbequb_(int *, int *, int *
, int *, double *, int *, double *, double *, 
	    double *, double *, double *, int *), dgbrfsx_(
