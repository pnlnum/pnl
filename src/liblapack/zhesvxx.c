...
#include "pnl/pnl_f2c.h"
 ...
 int zhesvxx_(char *fact, char *uplo, int *n, int *
	nrhs, doublecomplex *a, int *lda, doublecomplex *af, int *
	ldaf, int *ipiv, char *equed, double *s, doublecomplex *b, 
	int *ldb, doublecomplex *x, int *ldx, double *rcond, 
	double *rpvgrw, double *berr, int *n_err_bnds__, 
	double *err_bnds_norm__, double *err_bnds_comp__, int *
	nparams, double *params, doublecomplex *work, double *rwork, 
	int *info)
{
    ...
    extern double zla_herpvgrw__(char *, int *, int *, 
    ...
    double bignum;
    extern  int zlaqhe_(char *, int *, doublecomplex *, 
	    int *, double *, double *, double *, char *);
    int infequ;
    extern  int zhetrf_(char *, int *, doublecomplex *, 
	    int *, int *, doublecomplex *, int *, int *), zlacpy_(char *, int *, int *, doublecomplex *, 
	    int *, doublecomplex *, int *);
    double smlnum;
    extern  int zhetrs_(char *, int *, int *, 
	    doublecomplex *, int *, int *, doublecomplex *, int *, 
	     int *), zlascl2_(int *, int *, double *, 
	    doublecomplex *, int *), zheequb_(char *, int *, 
	    doublecomplex *, int *, double *, double *, 
	    double *, doublecomplex *, int *), zherfsx_(char *
, char *, int *, int *, doublecomplex *, int *, 
	    doublecomplex *, int *, int *, double *, 
	    doublecomplex *, int *, doublecomplex *, int *, 
	    double *, double *, int *, double *, double *, 
	     int *, double *, doublecomplex *, double *, int *
);
