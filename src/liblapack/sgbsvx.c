...
, int *), xerbla_(char *, int *);
    float bignum;
    extern double slantb_(char *, char *, char *, int *, int *, 
	    float *, int *, float *);
    extern  int sgbequ_(int *, int *, int *, 
	    int *, float *, int *, float *, float *, float *, float *, 
	    float *, int *);
    int infequ;
    int colequ;
    extern  int sgbrfs_(char *, int *, int *, int 
	    *, int *, float *, int *, float *, int *, int *, 
	    float *, int *, float *, int *, float *, float *, float *, 
	    int *, int *), sgbtrf_(int *, int *, 
...
/*  SGBSVX uses the LU factorization to compute the solution to a float */
