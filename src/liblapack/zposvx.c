	...
	info)
{
    ...
    extern  int zlacpy_(char *, int *, int *, 
	    ...
	    zpocon_(char *, int *, doublecomplex *, int *, double 
	    *, double *, doublecomplex *, double *, int *)
	    ;
    double smlnum;
    extern  int zpoequ_(int *, doublecomplex *, int *, 
	     double *, double *, double *, int *), zporfs_(
	    char *, int *, int *, doublecomplex *, int *, 
	    doublecomplex *, int *, doublecomplex *, int *, 
	    doublecomplex *, int *, double *, double *, 
	    doublecomplex *, double *, int *), zpotrf_(char *, 
	     int *, doublecomplex *, int *, int *), 
	    zpotrs_(char *, int *, int *, doublecomplex *, int *, 
