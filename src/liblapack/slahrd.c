	...
	int *lda, float *tau, float *t, int *ldt, float *y, int *ldy)
{
    ...
    extern  int sscal_(int *, float *, float *, int *), 
	    ...
	    float *, int *, float *, float *, int *), scopy_(
	    int *, float *, int *, float *, int *), saxpy_(int *
, float *, float *, int *, float *, int *), strmv_(char *, 
	    char *, char *, int *, float *, int *, float *, int *), slarfg_(int *, float *, float *, 
	    int *, float *);
...
/*  SLAHRD reduces the first NB columns of a float general n-by-(n-k+1) */
