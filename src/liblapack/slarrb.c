...
#include "pnl/pnl_f2c.h"
 ...
 int slarrb_(int *n, float *d__, float *lld, int *
	ifirst, int *ilast, float *rtol1, float *rtol2, int *offset, 
	float *w, float *wgap, float *werr, float *work, int *iwork, float *
	pivmin, float *spdiam, int *twist, int *info)
{
    ...
    float gap, mid, tmp, back, lgap, rgap, left;
    int iter, nint, prev, next;
    float cvrgd, right, width;
    extern int slaneg_(int *, float *, float *, float *, float *, int 
	    *);
    int negcnt;
    float mnwdth;
    int olnint, maxitr;
...
/*     .. Executable Statements .. */
    ...
    *info = 0;
    ...
    maxitr = (int) ((log(*spdiam + *pivmin) - log(*pivmin)) / log(2.f)) + 
	    2;
    mnwdth = *pivmin * 2.f;
