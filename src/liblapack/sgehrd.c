	...
	int *lda, float *tau, float *work, int *lwork, int *info)
{
    ...
    extern  int sgemm_(char *, char *, int *, int *, 
	    ...
	    float *, int *), strmm_(char *, char *, char *, 
	     char *, int *, int *, float *, float *, int *, float *, 
	    int *), saxpy_(int *, 
	    float *, float *, int *, float *, int *), sgehd2_(int *, 
	    int *, int *, float *, int *, float *, float *, int *
), slahr2_(int *, int *, int *, float *, int *, 
	    float *, float *, int *, float *, int *), slarfb_(char *, 
	    char *, char *, char *, int *, int *, int *, float *, 
...
/*  SGEHRD reduces a float general matrix A to upper Hessenberg form H by */
