	 ...
	 float *ab, int *ldab, int *ipiv, int *info)
{
    ...
    /* Local variables */
    int i__, j, km, jp, ju, kv;
    extern  int sger_(int *, int *, float *, float *, 
	    int *, float *, int *, float *, int *), sscal_(int *
, float *, float *, int *), sswap_(int *, float *, int *, 
...
/*  SGBTF2 computes an LU factorization of a float m-by-n band matrix A */
