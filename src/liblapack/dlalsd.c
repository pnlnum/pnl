	...
	int *info)
{
    ...
    extern  int dgemm_(char *, char *, int *, int *, 
	    ...
	    *);
    int poles, sizei, nsize, nwork, icmpq1, icmpq2;
    ...
    extern  int dlasda_(int *, int *, int *, 
	    ...
	    double *, double *, double *, double *, int *, 
	     int *), dlalsa_(int *, int *, int *, int *, 
	    double *, int *, double *, int *, double *, 
	    int *, double *, int *, double *, double *, 
	    double *, double *, int *, int *, int *, 
	    int *, double *, double *, double *, double *, 
	     int *, int *), dlascl_(char *, int *, int *, 
    ...
    extern  int dlasdq_(char *, int *, int *, int 
	    *, int *, int *, double *, double *, double *, 
	    ...
	    double *, int *), dlacpy_(char *, int *, 
	    int *, double *, int *, double *, int *), dlartg_(double *, double *, double *, 
	    double *, double *), dlaset_(char *, int *, int *, 
	     double *, double *, double *, int *), 
	    xerbla_(char *, int *);
    int givcol;
    extern double dlanst_(char *, int *, double *, double *);
    extern  int dlasrt_(char *, int *, double *, 
	    int *);
    double orgnrm;
    int givnum, givptr, smlszp;
