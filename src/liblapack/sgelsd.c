	...
	rank, float *work, int *lwork, int *iwork, int *info)
{
    ...
    extern  int slabad_(float *, float *), sgebrd_(int *, 
    ...
    extern  int sgelqf_(int *, int *, float *, int 
	    *, float *, float *, int *, int *), slalsd_(char *, int 
	    *, int *, int *, float *, float *, float *, int *, float *
, int *, float *, int *, int *), slascl_(char *
, int *, int *, float *, float *, int *, int *, 
	    float *, int *, int *);
    int wlalsd;
    extern  int sgeqrf_(int *, int *, float *, int 
	    *, float *, float *, int *, int *), slacpy_(char *, int 
...
/*  SGELSD computes the minimum-norm solution to a float linear least */
/*  squares problem: */
