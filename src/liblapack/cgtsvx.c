	...
	complex *work, float *rwork, int *info)
{
    ...
    extern  int ccopy_(int *, complex *, int *, 
	    complex *, int *);
    extern double slamch_(char *), clangt_(char *, int *, 
	    complex *, complex *, complex *);
    int nofact;
    extern  int clacpy_(char *, int *, int *, complex 
	    *, int *, complex *, int *), cgtcon_(char *, 
	    int *, complex *, complex *, complex *, complex *, int *, 
	    float *, float *, complex *, int *), xerbla_(char *, 
	    int *), cgtrfs_(char *, int *, int *, complex 
	    *, complex *, complex *, complex *, complex *, complex *, complex 
	    *, int *, complex *, int *, complex *, int *, float *, 
	    float *, complex *, float *, int *), cgttrf_(int *, 
