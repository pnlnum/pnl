...
static int c__2 = 2;
 ...
 int claqr5_(int *wantt, int *wantz, int *kacc22, 
	...
	int *ldwh)
{
    ...
    extern  int ctrmm_(char *, char *, char *, char *, 
	    ...
	    int *), claqr1_(int *, 
	    complex *, int *, complex *, complex *, complex *), slabad_(
	    float *, float *), clarfg_(int *, complex *, complex *, int 
	    *, complex *);
...
/*                    .    Otherwise, use the new one. ==== */
			...
			i__7 = k + 1 + (k + 1) * h_dim1;
			i__8 = k + 2 + (k + 2) * h_dim1;
			if ((r__1 = q__1.r, ABS(r__1)) + (r__2 = r_imag(&
				q__1), ABS(r__2)) + ((r__3 = q__4.r, ABS(
				r__3)) + (r__4 = r_imag(&q__4), ABS(r__4))) 
				> ulp * ((r__5 = h__[i__6].r, ABS(r__5)) + (
				r__6 = r_imag(&h__[k + k * h_dim1]), ABS(
				r__6)) + ((r__7 = h__[i__7].r, ABS(r__7)) + (
				r__8 = r_imag(&h__[k + 1 + (k + 1) * h_dim1]),
				 ABS(r__8))) + ((r__9 = h__[i__8].r, ABS(
...
/* Computing MAX */
		    ...
		    if ((r__1 = h__[i__5].r, ABS(r__1)) + (r__2 = r_imag(&
			    h__[k + 1 + k * h_dim1]), ABS(r__2)) <= MAX(
			    r__3,r__4)) {
/* Computing MAX */
			i__5 = k + 1 + k * h_dim1;
			i__7 = k + (k + 1) * h_dim1;
