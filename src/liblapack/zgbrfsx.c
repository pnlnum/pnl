...
static int c_false = FALSE;
 ...
 int zgbrfsx_(char *trans, char *equed, int *n, int *
	kl, int *ku, int *nrhs, doublecomplex *ab, int *ldab, 
	doublecomplex *afb, int *ldafb, int *ipiv, double *r__, 
	double *c__, doublecomplex *b, int *ldb, doublecomplex *x, 
	...
	work, double *rwork, int *info)
{
    ...
    extern  int zla_gbrfsx_extended__(int *, int *, 
	    int *, int *, int *, int *, doublecomplex *, 
	    int *, doublecomplex *, int *, int *, int *, 
    ...
    double anorm;
    extern double zla_gbrcond_c__(char *, int *, int *, int *,
	     doublecomplex *, int *, doublecomplex *, int *, int *
	    , double *, int *, int *, doublecomplex *, double 
	    *, unsigned long), zla_gbrcond_x__(char *, int *, int *, int 
	    *, doublecomplex *, int *, doublecomplex *, int *, 
	    int *, doublecomplex *, int *, doublecomplex *, 
	    double *, unsigned long), dlamch_(char *);
    extern  int xerbla_(char *, int *);
    extern double zlangb_(char *, int *, int *, int *, 
	    doublecomplex *, int *, double *);
    extern  int zgbcon_(char *, int *, int *, int 
	    *, doublecomplex *, int *, int *, double *, 
	    double *, doublecomplex *, double *, int *);
