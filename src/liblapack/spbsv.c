	...
	nrhs, float *ab, int *ldab, float *b, int *ldb, int *info)
{
    ...
    extern  int xerbla_(char *, int *), spbtrf_(
	    char *, int *, int *, float *, int *, int *), spbtrs_(char *, int *, int *, int *, float *, 
	    int *, float *, int *, int *);
...
/*  SPBSV computes the solution to a float system of linear equations */
/*     A * X = B, */
