...
static int c__1 = 1;
static int c__0 = 0;
static float c_b74 = 0.f;
static float c_b108 = 1.f;
	...
	rank, float *work, int *lwork, int *info)
{
    ...
    /* Local variables */
    int i__, bl, ie, il, mm;
    float eps, thr, anrm, bnrm;
    int itau;
    float vdum[1];
    int iascl, ibscl, chunk;
    ...
    int bdspac;
    extern  int sgebrd_(int *, int *, float *, int 
    ...
    extern  int sgelqf_(int *, int *, float *, int 
	    *, float *, float *, int *, int *), slascl_(char *, int 
	    *, int *, float *, float *, int *, int *, float *, 
	    int *, int *), sgeqrf_(int *, int *, float 
	    *, int *, float *, float *, int *, int *), slacpy_(char 
	    *, int *, int *, float *, int *, float *, int *), slaset_(char *, int *, int *, float *, float *, 
	    float *, int *), sbdsqr_(char *, int *, int *, 
	    int *, int *, float *, float *, float *, int *, float *, 
	    int *, float *, int *, float *, int *), sorgbr_(
	    char *, int *, int *, int *, float *, int *, float *
, float *, int *, int *);
    int ldwork;
    extern  int sormbr_(char *, char *, char *, int *, 
	    int *, int *, float *, int *, float *, float *, int *
, float *, int *, int *);
    int minwrk, maxwrk;
    float smlnum;
    extern  int sormlq_(char *, char *, int *, int *, 
...
/*  SGELSS computes the minimum norm solution to a float linear least */
/*  squares problem: */
