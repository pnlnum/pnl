	...
	info)
{
    ...
    int ilst;
    float rnrm;
    extern  int slag2_(float *, int *, float *, int *, 
	    float *, float *, float *, float *, float *, float *);
    extern double snrm2_(int *, float *, int *);
    float root1, root2, scale;
    ...
    int lwmin;
    int wants;
    float tmpir, tmpri, dummy[1], tmprr;
    extern double slapy2_(float *, float *);
    float dummy1[1], alphai, alphar;
    extern double slamch_(char *);
    extern  int xerbla_(char *, int *);
    int wantbh, wantdf;
    extern  int slacpy_(char *, int *, int *, float *, 
	    int *, float *, int *), stgexc_(int *, int 
    ...
    float alprqt, smlnum;
    int lquery;
    extern  int stgsyl_(char *, int *, int *, int 
...
/*  generalized float Schur canonical form (or of any matrix pair */
/*  (Q*A*Z', Q*B*Z') with orthogonal matrices Q and Z, where */
/*  Z' denotes the transpose of Z. */

/*  (A, B) must be in generalized float Schur form (as returned by SGGES), */
...
/*          the specified condition numbers; for each selected float */
...
/*  a) If the i-th eigenvalue w = (a,b) is float */
...
/*         MIN( d1, MAX( 1, |float(s11)/float(s22)| )*d2 ) */
...
/*     This is done by computing (using float arithmetic) the */
