...
#include "pnl/pnl_f2c.h"
 ...
 int sgbsvxx_(char *fact, char *trans, int *n, int *
	kl, int *ku, int *nrhs, float *ab, int *ldab, float *afb, 
	int *ldafb, int *ipiv, char *equed, float *r__, float *c__, 
	float *b, int *ldb, float *x, int *ldx, float *rcond, float *
	rpvgrw, float *berr, int *n_err_bnds__, float *err_bnds_norm__, 
	...
	int *iwork, int *info)
{
    ...
    int i__, j;
    float amax;
    extern double sla_gbrpvgrw__(int *, int *, int *, int 
	    *, float *, int *, float *, int *);
    ...
    extern  int slaqgb_(int *, int *, int *, 
    ...
    int infequ;
    int colequ;
    extern  int sgbtrf_(int *, int *, int *, 
	    int *, float *, int *, int *, int *), slacpy_(char 
    ...
    float smlnum;
    int rowequ;
    extern  int slascl2_(int *, int *, float *, float *, 
	     int *), sgbequb_(int *, int *, int *, int *, 
	    float *, int *, float *, float *, float *, float *, float *, 
	    int *), sgbrfsx_(char *, char *, int *, int *, 
	    int *, int *, float *, int *, float *, int *, 
...
/*     float system of linear equations  A * X = B,  where A is an */
