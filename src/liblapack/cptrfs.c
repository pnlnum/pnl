...
static complex c_b16 = {1.f,0.f};
 ...
 int cptrfs_(char *uplo, int *n, int *nrhs, float *d__, 
	 complex *e, float *df, complex *ef, complex *b, int *ldb, complex 
	...
	int *info)
{
    ...
    float lstres;
    extern  int cpttrs_(char *, int *, int *, float *, 
...
/*        ABS(A)*ABS(x) + ABS(b) for use in the backward error bound. */
	...
	if (upper) {
		...
		rwork[1] = (r__1 = bi.r, ABS(r__1)) + (r__2 = r_imag(&bi), 
			ABS(r__2)) + ((r__3 = dx.r, ABS(r__3)) + (r__4 = 
			r_imag(&dx), ABS(r__4))) + ((r__5 = e[1].r, ABS(
			r__5)) + (r__6 = r_imag(&e[1]), ABS(r__6))) * ((r__7 
			= x[i__2].r, ABS(r__7)) + (r__8 = r_imag(&x[j * 
			x_dim1 + 2]), ABS(r__8)));
		i__2 = *n - 1;
		for (i__ = 2; i__ <= i__2; ++i__) {
		    ...
		    rwork[i__] = (r__1 = bi.r, ABS(r__1)) + (r__2 = r_imag(&
			    ...
			    dx.r, ABS(r__7)) + (r__8 = r_imag(&dx), ABS(
			    r__8))) + ((r__9 = e[i__5].r, ABS(r__9)) + (
			    r__10 = r_imag(&e[i__]), ABS(r__10))) * ((r__11 =
			     x[i__6].r, ABS(r__11)) + (r__12 = r_imag(&x[i__ 
			    + 1 + j * x_dim1]), ABS(r__12)));
/* L30: */
		}
		i__2 = *n + j * b_dim1;
		bi.r = b[i__2].r, bi.i = b[i__2].i;
		...
		rwork[*n] = (r__1 = bi.r, ABS(r__1)) + (r__2 = r_imag(&bi), 
			...
			= r_imag(&e[*n - 1]), ABS(r__4))) * ((r__5 = x[i__3]
			.r, ABS(r__5)) + (r__6 = r_imag(&x[*n - 1 + j * 
			x_dim1]), ABS(r__6))) + ((r__7 = dx.r, ABS(r__7)) + 
			(r__8 = r_imag(&dx), ABS(r__8)));
	    }
	} else {
	    if (*n == 1) {
		i__2 = j * b_dim1 + 1;
