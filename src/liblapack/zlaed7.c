	...
	work, double *rwork, int *iwork, int *info)
{
    ...
    extern  int dlaed9_(int *, int *, int *, 
	    int *, double *, double *, int *, double *, 
	    double *, double *, double *, int *, int *), 
	    zlaed8_(int *, int *, int *, doublecomplex *, int 
	    *, double *, double *, int *, double *, 
	    double *, doublecomplex *, int *, double *, int *, 
	     int *, int *, int *, int *, int *, 
	    double *, int *), dlaeda_(int *, int *, int *, 
	     int *, int *, int *, int *, int *, 
	    double *, double *, int *, double *, double *, 
	     int *);
    int idlmda;
    extern  int dlamrg_(int *, int *, double *, 
	    int *, int *, int *), xerbla_(char *, int *), zlacrm_(int *, int *, doublecomplex *, int *, 
