...
static int c_n1 = -1;
 ...
 int chegvx_(int *itype, char *jobz, char *range, char *
	...
	m, float *w, complex *z__, int *ldz, complex *work, int *lwork, 
	 float *rwork, int *iwork, int *ifail, int *info)
{
    ...
    extern  int ctrsm_(char *, char *, char *, char *, 
	    int *, int *, complex *, complex *, int *, complex *, 
	    int *);
    int upper, wantz, alleig, indeig, valeig;
    extern  int chegst_(int *, char *, int *, complex 
	    *, int *, complex *, int *, int *);
    extern int ilaenv_(int *, char *, char *, int *, int *, 
	    int *, int *);
    extern  int xerbla_(char *, int *), cheevx_(
	    char *, char *, char *, int *, complex *, int *, float *, 
	    float *, int *, int *, float *, int *, float *, complex *
, int *, complex *, int *, float *, int *, int *, 
	    int *), cpotrf_(char *, int *, 
	    complex *, int *, int *);
    int lwkopt;
    int lquery;
