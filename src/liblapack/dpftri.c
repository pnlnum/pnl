...
static double c_b11 = 1.;
 ...
 int dpftri_(char *transr, char *uplo, int *n, double 
	*a, int *info)
{
    ...
    int nisodd;
    extern  int dlauum_(char *, int *, double *, 
	    int *, int *), dtftri_(char *, char *, char *, 
	    int *, double *, int *);
...
/*  DPFTRI computes the inverse of a (float) symmetric positive definite */
