	...
	iwork, int *info)
{
    ...
    extern double dlansp_(char *, char *, int *, double *, 
	    double *);
    extern  int dppcon_(char *, int *, double *, 
	    double *, double *, double *, int *, int *), dlaqsp_(char *, int *, double *, double *, 
	    double *, double *, char *);
    int infequ;
    extern  int dppequ_(char *, int *, double *, 
	    double *, double *, double *, int *), 
	    dpprfs_(char *, int *, int *, double *, double *, 
	    double *, int *, double *, int *, double *, 
	    double *, double *, int *, int *), 
	    dpptrf_(char *, int *, double *, int *);
    double smlnum;
    extern  int dpptrs_(char *, int *, int *, 
	    double *, double *, int *, int *);
