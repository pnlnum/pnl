	...
	int *lwork, double *rwork, int *iwork, int *info)
{
    ...
    extern  int zlacp2_(char *, int *, int *, 
	    double *, int *, doublecomplex *, int *);
    int mnthr1, mnthr2;
    ...
    extern  int dlascl_(char *, int *, int *, 
	    ...
	    int *, int *), xerbla_(char *, int *),
	     zgebrd_(int *, int *, doublecomplex *, int *, 
	    double *, double *, doublecomplex *, doublecomplex *, 
...
), zlacrm_(int *, int *, doublecomplex *, int *, 
	    double *, int *, doublecomplex *, int *, double *)
	    , zlarcm_(int *, int *, double *, int *, 
	    doublecomplex *, int *, doublecomplex *, int *, 
	    double *), zlascl_(char *, int *, int *, double *, 
	     double *, int *, int *, doublecomplex *, int *, 
	    int *), zgeqrf_(int *, int *, doublecomplex *, 
	     int *, doublecomplex *, doublecomplex *, int *, int *
);
    int ldwrkl;
    ...
    extern  int zungbr_(char *, int *, int *, int 
	    *, doublecomplex *, int *, doublecomplex *, doublecomplex *, 
	    int *, int *);
    int ldwkvt;
    double smlnum;
    int wntqas;
    extern  int zunmbr_(char *, char *, char *, int *, 
