...
#include "pnl/pnl_f2c.h"
 ...
 int dsysvxx_(char *fact, char *uplo, int *n, int *
	...
	double *params, double *work, int *iwork, int *info)
{
    ...
    extern double dla_syrpvgrw__(char *, int *, int *, double 
    ...
    double smlnum;
    extern  int dsytrf_(char *, int *, double *, 
	    int *, int *, double *, int *, int *),
	     dlascl2_(int *, int *, double *, double *, 
	    int *), dsytrs_(char *, int *, int *, double *, 
	    int *, int *, double *, int *, int *),
	     dsyequb_(char *, int *, double *, int *, double *
, double *, double *, double *, int *), 
	    dsyrfsx_(char *, char *, int *, int *, double *, 
	    int *, double *, int *, int *, double *, 
