	...
	work, int *ldwork)
{
    ...
    extern  int sgemm_(char *, char *, int *, int *, 
	    ...
	    float *, int *), scopy_(int *, float *, 
	    int *, float *, int *), strmm_(char *, char *, char *, 
...
/*  SLARZB applies a float block reflector H or its transpose H**T to */
/*  a float distributed M-by-N  C from the left or the right. */
