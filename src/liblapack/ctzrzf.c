...
static int c__2 = 2;
 ...
 int ctzrzf_(int *m, int *n, complex *a, int *lda, 
	 complex *tau, complex *work, int *lwork, int *info)
{
    ...
    extern  int clarzb_(char *, char *, char *, char *, 
	    int *, int *, int *, int *, complex *, int *, 
	    complex *, int *, complex *, int *, complex *, int *), xerbla_(char *, int *);
    extern int ilaenv_(int *, char *, char *, int *, int *, 
	    int *, int *);
    extern  int clarzt_(char *, char *, int *, int *, 
	    complex *, int *, complex *, complex *, int *), clatrz_(int *, int *, int *, complex *, 
	    int *, complex *, complex *);
    int ldwork, lwkopt;
    int lquery;
