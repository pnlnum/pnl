...
static int c__1 = 1;
 ...
 int sgerfsx_(char *trans, char *equed, int *n, int *
	nrhs, float *a, int *lda, float *af, int *ldaf, int *ipiv, 
	float *r__, float *c__, float *b, int *ldb, float *x, int *ldx, 
	float *rcond, float *berr, int *n_err_bnds__, float *err_bnds_norm__, 
	 float *err_bnds_comp__, int *nparams, float *params, float *work, 
	int *iwork, int *info)
{
    ...
    extern double sla_gercond__(char *, int *, float *, int *, 
	    float *, int *, int *, int *, float *, int *, float *
	    , int *, unsigned long);
    float cwise_wrong__;
    extern  int sla_gerfsx_extended__(int *, int *, 
    ...
    extern double slamch_(char *), slange_(char *, int *, 
	    int *, float *, int *, float *);
    extern  int xerbla_(char *, int *), sgecon_(
