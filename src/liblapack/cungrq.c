...
static int c__2 = 2;
 ...
 int cungrq_(int *m, int *n, int *k, complex *a, 
	...
	info)
{
    ...
    /* Local variables */
    int i__, j, l, ib, nb, ii, kk, nx, iws, nbmin, iinfo;
    extern  int cungr2_(int *, int *, int *, 
	    complex *, int *, complex *, complex *, int *), clarfb_(
