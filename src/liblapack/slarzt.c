	...
	k, float *v, int *ldv, float *tau, float *t, int *ldt)
{
    ...
    extern  int sgemv_(char *, int *, int *, float *, 
	    float *, int *, float *, int *, float *, float *, int *), strmv_(char *, char *, char *, int *, float *, 
	    int *, float *, int *), xerbla_(
	    char *, int *);
...
/*  SLARZT forms the triangular factor T of a float block reflector */
