...
static float c_b8 = 1.f;
 ...
 int sla_gbrfsx_extended__(int *prec_type__, int *
	trans_type__, int *n, int *kl, int *ku, int *nrhs, 
	float *ab, int *ldab, float *afb, int *ldafb, int *ipiv, 
	int *colequ, float *c__, float *b, int *ldb, float *y, int *
	ldy, float *berr_out__, int *n_norms__, float *err_bnds_norm__, 
	float *err_bnds_comp__, float *res, float *ayb, float *dy, float *y_tail__,
	 float *rcond, int *ithresh, float *rthresh, float *dz_ub__, int 
	*ignore_cwise__, int *info)
{
    ...
    int i__, j, m;
    extern  int sla_gbamv__(int *, int *, int *, 
    ...
    extern  int sla_lin_berr__(int *, int *, int *
	    , float *, float *, float *), blas_sgbmv_x__(int *, int *, 
	    int *, int *, int *, float *, float *, int *, float *
	    , int *, float *, float *, int *, int *);
    int y_prec_state__;
    extern  int blas_sgbmv2_x__(int *, int *, int 
	    *, int *, int *, float *, float *, int *, float *, float *
	    , int *, float *, float *, int *, int *), sgbmv_(char *, 
    ...
    extern  int sgbtrs_(char *, int *, int *, int 
