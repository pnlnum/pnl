...
, doublecomplex *, int *);
    ...
    extern  int xerbla_(char *, int *), zhpgst_(
	    int *, char *, int *, doublecomplex *, doublecomplex *, 
	    int *), zhpevx_(char *, char *, char *, int *, 
	    doublecomplex *, double *, double *, int *, int *, 
	     double *, int *, double *, doublecomplex *, int *
, doublecomplex *, double *, int *, int *, int *), zpptrf_(char *, int *, doublecomplex 
	    *, int *);
