...
/*  SLAGV2 computes the Generalized Schur factorization of a float 2-by-2 */
/*  matrix pencil (A,B) where B is upper triangular. This routine */
/*  computes orthogonal (rotation) matrices given by CSL, SNL and CSR, */
/*  SNR such that */

/*  1) if the pencil (A,B) has two float eigenvalues (include 0/0 or 1/0 */
/*     types), then */
...
/* Computing MAX */
    r__4 = (r__3 = b[b_dim1 + 1], ABS(r__3)), r__5 = (r__1 = b[(b_dim1 << 1) 
	    + 1], ABS(r__1)) + (r__2 = b[(b_dim1 << 1) + 2], ABS(r__2)), 
	    r__4 = MAX(r__4,r__5);
...
/*           two float eigenvalues, compute s*A-w*B */
...
/* Computing MAX */
	    r__5 = (r__1 = a[a_dim1 + 1], ABS(r__1)) + (r__2 = a[(a_dim1 << 
		    1) + 1], ABS(r__2)), r__6 = (r__3 = a[a_dim1 + 2], ABS(
		    r__3)) + (r__4 = a[(a_dim1 << 1) + 2], ABS(r__4));
	    h1 = MAX(r__5,r__6);
/* Computing MAX */
	    r__5 = (r__1 = b[b_dim1 + 1], ABS(r__1)) + (r__2 = b[(b_dim1 << 
		    1) + 1], ABS(r__2)), r__6 = (r__3 = b[b_dim1 + 2], ABS(
		    r__3)) + (r__4 = b[(b_dim1 << 1) + 2], ABS(r__4));
	    h2 = MAX(r__5,r__6);
