	...
	int *info)
{
    ...
    extern  int dlacpy_(char *, int *, int *, 
	    ...
	    xerbla_(char *, int *), dtgexc_(int *, int *, 
	    int *, double *, int *, double *, int *, 
	    double *, int *, double *, int *, int *, 
	    int *, double *, int *, int *), dlassq_(int *, 
	     double *, int *, double *, double *);
    int liwmin;
    extern  int dtgsyl_(char *, int *, int *, int 
...
/*  DTGSEN reorders the generalized float Schur decomposition of a float */
