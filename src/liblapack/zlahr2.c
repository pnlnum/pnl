...
static int c__1 = 1;
 ...
 int zlahr2_(int *n, int *k, int *nb, 
	...
	int *ldt, doublecomplex *y, int *ldy)
{
    ...
    extern  int zscal_(int *, doublecomplex *, 
	    doublecomplex *, int *), zgemm_(char *, char *, int *, 
	    int *, int *, doublecomplex *, doublecomplex *, int *, 
	     doublecomplex *, int *, doublecomplex *, doublecomplex *, 
	    int *), zgemv_(char *, int *, int *, 
	    doublecomplex *, doublecomplex *, int *, doublecomplex *, 
	    int *, doublecomplex *, doublecomplex *, int *), 
	    zcopy_(int *, doublecomplex *, int *, doublecomplex *, 
	    int *), ztrmm_(char *, char *, char *, char *, int *, 
	    int *, doublecomplex *, doublecomplex *, int *, 
	    doublecomplex *, int *), 
	    zaxpy_(int *, doublecomplex *, doublecomplex *, int *, 
	    doublecomplex *, int *), ztrmv_(char *, char *, char *, 
	    int *, doublecomplex *, int *, doublecomplex *, int *), zlarfg_(int *, doublecomplex *, 
	    doublecomplex *, int *, doublecomplex *), zlacgv_(int *, 
	    doublecomplex *, int *), zlacpy_(char *, int *, int *, 
