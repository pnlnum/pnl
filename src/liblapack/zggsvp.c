	...
	rwork, doublecomplex *tau, doublecomplex *work, int *info)
{
    ...
    extern  int zgeqr2_(int *, int *, doublecomplex *, 
	     int *, doublecomplex *, doublecomplex *, int *), zgerq2_(
	    int *, int *, doublecomplex *, int *, doublecomplex *, 
	     doublecomplex *, int *), zung2r_(int *, int *, 
	    int *, doublecomplex *, int *, doublecomplex *, 
	    doublecomplex *, int *), zunm2r_(char *, char *, int *, 
	    int *, int *, doublecomplex *, int *, doublecomplex *, 
	     doublecomplex *, int *, doublecomplex *, int *), zunmr2_(char *, char *, int *, int *, int *, 
	    doublecomplex *, int *, doublecomplex *, doublecomplex *, 
	    int *, doublecomplex *, int *), xerbla_(
	    char *, int *), zgeqpf_(int *, int *, 
	    doublecomplex *, int *, int *, doublecomplex *, 
	    doublecomplex *, double *, int *), zlacpy_(char *, 
	    int *, int *, doublecomplex *, int *, doublecomplex *, 
	     int *);
    int forwrd;
    extern  int zlaset_(char *, int *, int *, 
	    doublecomplex *, doublecomplex *, doublecomplex *, int *), zlapmt_(int *, int *, int *, doublecomplex *, 
	     int *, int *);
