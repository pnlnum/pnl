	...
	lwork, int *info)
{
    ...
    extern  int sgemm_(char *, char *, int *, int *, 
	    ...
	    float *, int *);
    int minmn;
    extern  int sgebd2_(int *, int *, float *, int 
	    *, float *, float *, float *, float *, float *, int *), slabrd_(
	    int *, int *, int *, float *, int *, float *, float *
, float *, float *, float *, int *, float *, int *), xerbla_(
	    char *, int *);
...
/*  SGEBRD reduces a general float M-by-N matrix A to upper or lower */
