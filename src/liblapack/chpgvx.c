...
static int c__1 = 1;
 ...
 int chpgvx_(int *itype, char *jobz, char *range, char *
	uplo, int *n, complex *ap, complex *bp, float *vl, float *vu, 
	int *il, int *iu, float *abstol, int *m, float *w, complex *
	z__, int *ldz, complex *work, float *rwork, int *iwork, 
	int *ifail, int *info)
{
    ...
    extern  int xerbla_(char *, int *), chpgst_(
	    int *, char *, int *, complex *, complex *, int *), chpevx_(char *, char *, char *, int *, complex *, 
	    float *, float *, int *, int *, float *, int *, float *, 
	    complex *, int *, complex *, float *, int *, int *, 
	    int *), cpptrf_(char *, int *, 
	    complex *, int *);
