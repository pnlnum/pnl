...
static float c_b38 = 0.f;
 ...
 int slahr2_(int *n, int *k, int *nb, float *a, 
	int *lda, float *tau, float *t, int *ldt, float *y, int *ldy)
{
    ...
    extern  int sscal_(int *, float *, float *, int *), 
	    ...
	    strmm_(char *, char *, char *, char *, int *, int *, float 
	    *, float *, int *, float *, int *), saxpy_(int *, float *, float *, int *, float *, 
	    int *), strmv_(char *, char *, char *, int *, float *, 
	    int *, float *, int *), slarfg_(
	    int *, float *, float *, int *, float *), slacpy_(char *, 
...
/*  SLAHR2 reduces the first NB columns of A float general n-BY-(n-k+1) */
