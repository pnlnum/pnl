	...
	int *ldq, doublecomplex *work, int *ncycle, int *info)
{
    ...
    extern  int zcopy_(int *, doublecomplex *, int *, 
	    doublecomplex *, int *), zlags2_(int *, double *, 
    ...
    extern  int dlartg_(double *, double *, 
	    double *, double *, double *), xerbla_(char *, 
	    int *), zdscal_(int *, double *, 
	    doublecomplex *, int *), zlapll_(int *, doublecomplex *, 
	    int *, doublecomplex *, int *, double *), zlaset_(
