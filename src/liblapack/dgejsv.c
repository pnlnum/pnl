	...
	int *iwork, int *info)
{
    ...
    extern  int dtrsm_(char *, char *, char *, char *, 
	    ...
	    double *, int *);
    int l2aber;
    extern  int dgeqp3_(int *, int *, double *, 
	    int *, int *, double *, double *, int *, 
	    int *);
    double condr1, condr2, uscal1, uscal2;
    int l2kill, l2rank, l2tran, l2pert;
    extern double dlamch_(char *);
    extern  int dgelqf_(int *, int *, double *, 
    ...
    extern  int dpocon_(char *, int *, double *, 
	    ...
	    int *), dgesvj_(char *, char *, char *, int *, 
	    int *, double *, int *, double *, int *, 
	    double *, int *, double *, int *, int *), dlassq_(int *, double *, int 
	    *, double *, double *), dlaswp_(int *, double *, 
	    int *, int *, int *, int *, int *);
    double entrat;
    int almort;
    extern  int dorgqr_(int *, int *, int *, 
	    double *, int *, double *, double *, int *, 
	    int *), dormlq_(char *, char *, int *, int *, int 
	    *, double *, int *, double *, double *, int *, 
	     double *, int *, int *);
    double maxprj;
    int errest;
...
/*  Purpose */
/*  ~~~~~~~ */
/*  DGEJSV computes the singular value decomposition (SVD) of a float M-by-N */
...
/*     column norm left from the underflow threshold (extreme case). */
    ...
    scalem = 1. / sqrt((double) (*m) * (double) (*n));
    noscal = TRUE;
    goscal = TRUE;
    i__1 = *n;
    for (p = 1; p <= i__1; ++p) {
