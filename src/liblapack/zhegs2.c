	...
	int *info)
{
    ...
    extern  int zaxpy_(int *, doublecomplex *, 
	    doublecomplex *, int *, doublecomplex *, int *), ztrmv_(
	    char *, char *, char *, int *, doublecomplex *, int *, 
	    doublecomplex *, int *), ztrsv_(char *
, char *, char *, int *, doublecomplex *, int *, 
	    doublecomplex *, int *), xerbla_(char 
	    *, int *), zdscal_(int *, double *, 
	    doublecomplex *, int *), zlacgv_(int *, doublecomplex *, 
	    int *);
