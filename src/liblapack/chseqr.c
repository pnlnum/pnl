	...
	int *ldz, complex *work, int *lwork, int *info)
{
    ...
    complex workl[49];
    int wantt, wantz;
    extern  int claqr0_(int *, int *, int *, 
	    int *, int *, complex *, int *, complex *, int *, 
	    int *, complex *, int *, complex *, int *, int *),
	     clahqr_(int *, int *, int *, int *, int *, 
	    complex *, int *, complex *, int *, int *, complex *, 
	    int *, int *), clacpy_(char *, int *, int *, 
	    complex *, int *, complex *, int *), claset_(char 
...
/* Computing MAX */
	r__2 = work[1].r, r__3 = (float) MAX(1,*n);
	r__1 = MAX(r__2,r__3);
	q__1.r = r__1, q__1.i = 0.f;
	work[1].r = q__1.r, work[1].i = q__1.i;
	return 0;
...
/* Computing MAX */
	r__2 = (float) MAX(1,*n), r__3 = work[1].r;
	r__1 = MAX(r__2,r__3);
	q__1.r = r__1, q__1.i = 0.f;
	work[1].r = q__1.r, work[1].i = q__1.i;
    }
