...
static int c__1 = 1;
 ...
 int ctgsen_(int *ijob, int *wantq, int *wantz, 
	int *select, int *n, complex *a, int *lda, complex *b, 
	int *ldb, complex *alpha, complex *beta, complex *q, int *ldq, 
	 complex *z__, int *ldz, int *m, float *pl, float *pr, float *
	...
	int *info)
{
    ...
    extern  int clacpy_(char *, int *, int *, complex 
	    *, int *, complex *, int *);
    float safmin;
    extern  int ctgexc_(int *, int *, int *, 
	    complex *, int *, complex *, int *, complex *, int *, 
	    complex *, int *, int *, int *, int *), xerbla_(
	    char *, int *), classq_(int *, complex *, int 
	    *, float *, float *);
    int liwmin;
