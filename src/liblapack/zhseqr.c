	 ...
	 int *info)
{
    ...
    address a__1[2];
    int h_dim1, h_offset, z_dim1, z_offset, i__1, i__2, i__3[2];
...
/* Computing MAX */
	d__2 = work[1].r, d__3 = (double) MAX(1,*n);
	d__1 = MAX(d__2,d__3);
	z__1.r = d__1, z__1.i = 0.;
	work[1].r = z__1.r, work[1].i = z__1.i;
	return 0;
...
/* Writing concatenation */
	...
	s_cat(ch__1, a__1, i__3, &c__2, (unsigned long)2);
...
/* Computing MAX */
	d__2 = (double) MAX(1,*n), d__3 = work[1].r;
	d__1 = MAX(d__2,d__3);
	z__1.r = d__1, z__1.i = 0.;
	work[1].r = z__1.r, work[1].i = z__1.i;
    }
