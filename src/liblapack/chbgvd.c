	...
	int *info)
{
    ...
    extern  int cstedc_(char *, int *, float *, float *, 
	    ...
	    int *, int *, int *), chbtrd_(char *, char *, 
	    int *, int *, complex *, int *, float *, float *, 
	    complex *, int *, complex *, int *), 
	    chbgst_(char *, char *, int *, int *, int *, complex *
, int *, complex *, int *, complex *, int *, complex *
, float *, int *), clacpy_(char *, int *, 
	    int *, complex *, int *, complex *, int *), 
	    xerbla_(char *, int *), cpbstf_(char *, int *, 
	    int *, complex *, int *, int *);
    int indwrk, liwmin;
