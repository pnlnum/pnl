...
static int c__1 = 1;
 ...
 int dgerfsx_(char *trans, char *equed, int *n, int *
	...
	double *work, int *iwork, int *info)
{
    ...
    extern double dla_gercond__(char *, int *, double *, int *
	    , double *, int *, int *, int *, double *, 
	    int *, double *, int *, unsigned long);
    double cwise_wrong__;
    extern  int dla_gerfsx_extended__(int *, int *, 
    ...
    extern  int dgecon_(char *, int *, double *, 
