...
static double c_b33 = 1.;
 ...
 int zla_syrfsx_extended__(int *prec_type__, char *uplo, 
	int *n, int *nrhs, doublecomplex *a, int *lda, 
	doublecomplex *af, int *ldaf, int *ipiv, int *colequ, 
	double *c__, doublecomplex *b, int *ldb, doublecomplex *y, 
	int *ldy, double *berr_out__, int *n_norms__, double *
	err_bnds_norm__, double *err_bnds_comp__, doublecomplex *res, 
	double *ayb, doublecomplex *dy, doublecomplex *y_tail__, 
	double *rcond, int *ithresh, double *rthresh, double *
	dz_ub__, int *ignore_cwise__, int *info, unsigned long uplo_len)
{
    ...
    int incr_prec__;
    double prev_dz_z__;
    extern  int zla_syamv__(int *, int *, double *
	    , doublecomplex *, int *, doublecomplex *, int *, 
	    double *, double *, int *);
    double yk, final_dx_x__, final_dz_z__;
    extern  int zla_wwaddw__(int *, doublecomplex *, 
	    doublecomplex *, doublecomplex *);
    double prevnormdx;
    int cnt;
    double dyk, eps, incr_thresh__, dx_x__, dz_z__, ymin;
    extern  int zla_lin_berr__(int *, int *, int *
	    , doublecomplex *, double *, double *);
    int y_prec_state__, uplo2;
    extern  int blas_zsymv_x__(int *, int *, 
	    doublecomplex *, doublecomplex *, int *, doublecomplex *, 
	    int *, doublecomplex *, doublecomplex *, int *, int *)
	    ;
    extern int lsame_(char *, char *);
    double dxrat, dzrat;
    extern  int blas_zsymv2_x__(int *, int *, 
	    doublecomplex *, doublecomplex *, int *, doublecomplex *, 
    ...
    extern  int zcopy_(int *, doublecomplex *, int *, 
	    ...
	    doublecomplex *, int *, doublecomplex *, int *), zsymv_(
	    char *, int *, doublecomplex *, doublecomplex *, int *, 
	    doublecomplex *, int *, doublecomplex *, doublecomplex *, 
	    int *);
    extern double dlamch_(char *);
    double normdx;
    extern  int zsytrs_(char *, int *, int *, 
