...
static int c__1 = 1;
 ...
 int chptrd_(char *uplo, int *n, complex *ap, float *d__, 
	float *e, complex *tau, int *info)
{
    ...
    int i__, i1, ii, i1i1;
    complex taui;
    extern  int chpr2_(char *, int *, complex *, complex *
, int *, complex *, int *, complex *);
    complex alpha;
    extern /* Complex */ VOID cdotc_(complex *, int *, complex *, int 
	    *, complex *, int *);
    extern int lsame_(char *, char *);
    extern  int chpmv_(char *, int *, complex *, complex *
, complex *, int *, complex *, complex *, int *), 
	    caxpy_(int *, complex *, complex *, int *, complex *, 
	    int *);
    int upper;
    extern  int clarfg_(int *, complex *, complex *, 
	    int *, complex *), xerbla_(char *, int *);
...
/*  float symmetric tridiagonal form T by a unitary similarity */
