...
static int c__12 = 12;
 ...
 int slaqr3_(int *wantt, int *wantz, int *n, 
	int *ktop, int *kbot, int *nw, float *h__, int *ldh, 
	int *iloz, int *ihiz, float *z__, int *ldz, int *ns, 
	int *nd, float *sr, float *si, float *v, int *ldv, int *nh, 
	float *t, int *ldt, int *nv, float *wv, int *ldwv, float *
	work, int *lwork)
{
    ...
    extern  int slarf_(char *, int *, int *, float *, 
	    int *, float *, float *, int *, float *), sgemm_(
...
, float *, float *, float *, float *, float *), slaqr4_(int *, 
	    int *, int *, int *, int *, float *, int *, 
	    float *, float *, int *, int *, float *, int *, float *, 
	    int *, int *), slabad_(float *, float *);
    ...
    extern  int slarfg_(int *, float *, float *, int *, 
	    float *), slahqr_(int *, int *, int *, int *, 
	    int *, float *, int *, float *, float *, int *, int *
, float *, int *, int *), slacpy_(char *, int *, 
	    int *, float *, int *, float *, int *), slaset_(
	    char *, int *, int *, float *, float *, float *, int *);
    int sorted;
    extern  int strexc_(char *, int *, float *, int *, 
	    float *, int *, int *, int *, float *, int *), sormhr_(char *, char *, int *, int *, int *, 
...
/* Computing MAX */
	    ...
	    if ((r__1 = s * v[*ns * v_dim1 + 1], ABS(r__1)) <= MAX(r__2,
		    r__3)) {
...
L40:
	if (k <= kend) {
		...
		evi = (r__3 = t[i__ + i__ * t_dim1], ABS(r__3)) + sqrt((r__1 
			= t[i__ + 1 + i__ * t_dim1], ABS(r__1))) * sqrt((
			r__2 = t[i__ + (i__ + 1) * t_dim1], ABS(r__2)));
	    }
