	...
	iwork, int *info)
{
    ...
    extern  int dlaqge_(int *, int *, double *, 
	    int *, double *, double *, double *, double *, 
	     double *, char *), dgecon_(char *, int *, 
	    double *, int *, double *, double *, double *, 
	     int *, int *);
    double colcnd;
    int nofact;
    extern  int dgeequ_(int *, int *, double *, 
	    int *, double *, double *, double *, double *, 
	     double *, int *), dgerfs_(char *, int *, int *, 
	    double *, int *, double *, int *, int *, 
	    double *, int *, double *, int *, double *, 
	    double *, double *, int *, int *), 
	    dgetrf_(int *, int *, double *, int *, int *, 
	    int *), dlacpy_(char *, int *, int *, double *, 
	    int *, double *, int *), xerbla_(char *, 
	    int *);
    double bignum;
    extern double dlantr_(char *, char *, char *, int *, int *, 
	    double *, int *, double *);
    int infequ;
    int colequ;
