	...
	doublecomplex *work, double *rwork, int *info)
{
    ...
    int minmn;
    int wantq;
    extern  int xerbla_(char *, int *), zlaset_(
	    char *, int *, int *, doublecomplex *, doublecomplex *, 
	    doublecomplex *, int *), zlartg_(doublecomplex *, 
	    doublecomplex *, double *, doublecomplex *, doublecomplex *), 
	    zlargv_(int *, doublecomplex *, int *, doublecomplex *, 
	    int *, double *, int *);
    int wantpt;
    extern  int zlartv_(int *, doublecomplex *, int *, 
	     doublecomplex *, int *, double *, doublecomplex *, 
	    int *);
...
/*  ZGBBRD reduces a complex general m-by-n band matrix A to float upper */
