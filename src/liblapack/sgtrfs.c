	...
	ferr, float *berr, float *work, int *iwork, int *info)
{
    ...
    extern  int scopy_(int *, float *, int *, float *, 
	    ...
	    int *), slacn2_(int *, float *, float *, int *, float *, 
	    int *, int *);
    extern double slamch_(char *);
    float safmin;
    extern  int xerbla_(char *, int *), slagtm_(
...
/*        error bound. */
	...
	if (notran) {
	    if (*n == 1) {
		work[1] = (r__1 = b[j * b_dim1 + 1], ABS(r__1)) + (r__2 = 
			d__[1] * x[j * x_dim1 + 1], ABS(r__2));
	    } else {
		work[1] = (r__1 = b[j * b_dim1 + 1], ABS(r__1)) + (r__2 = 
			d__[1] * x[j * x_dim1 + 1], ABS(r__2)) + (r__3 = du[
			1] * x[j * x_dim1 + 2], ABS(r__3));
		i__2 = *n - 1;
		for (i__ = 2; i__ <= i__2; ++i__) {
		    work[i__] = (r__1 = b[i__ + j * b_dim1], ABS(r__1)) + (
			    r__2 = dl[i__ - 1] * x[i__ - 1 + j * x_dim1], 
			    ABS(r__2)) + (r__3 = d__[i__] * x[i__ + j * 
			    x_dim1], ABS(r__3)) + (r__4 = du[i__] * x[i__ + 
			    1 + j * x_dim1], ABS(r__4));
/* L30: */
		}
		...
		work[1] = (r__1 = b[j * b_dim1 + 1], ABS(r__1)) + (r__2 = 
			d__[1] * x[j * x_dim1 + 1], ABS(r__2)) + (r__3 = dl[
			1] * x[j * x_dim1 + 2], ABS(r__3));
		i__2 = *n - 1;
		for (i__ = 2; i__ <= i__2; ++i__) {
		    work[i__] = (r__1 = b[i__ + j * b_dim1], ABS(r__1)) + (
			    ...
			    ABS(r__2)) + (r__3 = d__[i__] * x[i__ + j * 
			    x_dim1], ABS(r__3)) + (r__4 = dl[i__] * x[i__ + 
			    1 + j * x_dim1], ABS(r__4));
/* L40: */
		}
		work[*n] = (r__1 = b[*n + j * b_dim1], ABS(r__1)) + (r__2 = 
