...
static float c_b31 = 1.f;
 ...
 int cla_gbrfsx_extended__(int *prec_type__, int *
	trans_type__, int *n, int *kl, int *ku, int *nrhs, 
	complex *ab, int *ldab, complex *afb, int *ldafb, int *
	ipiv, int *colequ, float *c__, complex *b, int *ldb, complex *
	y, int *ldy, float *berr_out__, int *n_norms__, float *
	...
	rthresh, float *dz_ub__, int *ignore_cwise__, int *info)
{
    ...
    int i__, j, m;
    extern  int cla_gbamv__(int *, int *, int *, 
    ...
    extern  int cgbtrs_(char *, int *, int *, int 
	    *, int *, complex *, int *, int *, complex *, int 
	    *, int *);
    float normdx;
