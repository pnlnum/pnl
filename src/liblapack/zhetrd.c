...
static double c_b23 = 1.;
 ...
 int zhetrd_(char *uplo, int *n, doublecomplex *a, 
	...
	doublecomplex *work, int *lwork, int *info)
{
    ...
    int nbmin, iinfo;
    int upper;
    extern  int zhetd2_(char *, int *, doublecomplex *, 
	    int *, double *, double *, doublecomplex *, int *), zher2k_(char *, char *, int *, int *, 
	    doublecomplex *, doublecomplex *, int *, doublecomplex *, 
	    int *, double *, doublecomplex *, int *), xerbla_(char *, int *);
    extern int ilaenv_(int *, char *, char *, int *, int *, 
	    int *, int *);
    extern  int zlatrd_(char *, int *, int *, 
...
/*  ZHETRD reduces a complex Hermitian matrix A to float symmetric */
