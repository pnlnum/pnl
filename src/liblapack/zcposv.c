...
static int c__1 = 1;
 ...
 int zcposv_(char *uplo, int *n, int *nrhs, 
	...
	double *rwork, int *iter, int *info)
{
    ...
    extern  int zhemm_(char *, char *, int *, int *, 
	    ...
	    int *, doublecomplex *, doublecomplex *, int *), zaxpy_(int *, doublecomplex *, doublecomplex *, 
	    int *, doublecomplex *, int *), zlag2c_(int *, 
	    int *, doublecomplex *, int *, complex *, int *, 
	    int *), clag2z_(int *, int *, complex *, int *, 
	    doublecomplex *, int *, int *), zlat2c_(char *, int *, 
	     doublecomplex *, int *, complex *, int *, int *);
    ...
    extern  int cpotrf_(char *, int *, complex *, int 
	    *, int *), zlacpy_(char *, int *, int *, 
	    doublecomplex *, int *, doublecomplex *, int *), 
	    cpotrs_(char *, int *, int *, complex *, int *, 
	    complex *, int *, int *), zpotrf_(char *, int 
	    *, doublecomplex *, int *, int *), zpotrs_(char *, 
