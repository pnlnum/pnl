...
static int c__1 = 1;
 ...
 int ctrsna_(char *job, char *howmny, int *select, 
	...
	complex *vr, int *ldvr, float *s, float *sep, int *mm, int *
	m, complex *work, int *ldwork, float *rwork, int *info)
{
    ...
    extern  int clatrs_(char *, char *, char *, char *, 
	    ...
	    int *), csrscl_(int *, 
	    float *, complex *, int *), ctrexc_(char *, int *, complex 
	    *, int *, complex *, int *, int *, int *, int 
	    *);
    int somcon;
    char normin[1];
    float smlnum;
...
/*                 overflow. */
		    ...
		    i__2 = ix + work_dim1;
		    xnorm = (r__1 = work[i__2].r, ABS(r__1)) + (r__2 = 
			    r_imag(&work[ix + work_dim1]), ABS(r__2));
