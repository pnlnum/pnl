	...
	ifail, int *info)
{
    ...
    extern  int dcopy_(int *, double *, int *, 
	    double *, int *), zgemv_(char *, int *, int *, 
    ...
    extern  int dsterf_(int *, double *, double *, 
	     int *), dstebz_(char *, char *, int *, double *, 
	    double *, int *, int *, double *, double *, 
	    double *, int *, int *, double *, int *, 
	    int *, double *, int *, int *), 
	    zhbtrd_(char *, char *, int *, int *, doublecomplex *, 
	    int *, double *, double *, doublecomplex *, int *, 
	     doublecomplex *, int *);
    int indrwk, indwrk;
    extern  int zhbgst_(char *, char *, int *, int *, 
	    int *, doublecomplex *, int *, doublecomplex *, int *, 
	     doublecomplex *, int *, doublecomplex *, double *, 
	    int *), zlacpy_(char *, int *, int *, 
	    doublecomplex *, int *, doublecomplex *, int *);
    int nsplit;
    extern  int zpbstf_(char *, int *, int *, 
	    doublecomplex *, int *, int *), zstein_(int *, 
	     double *, double *, int *, double *, int *, 
	    int *, doublecomplex *, int *, double *, int *, 
	    int *, int *), zsteqr_(char *, int *, double *, 
