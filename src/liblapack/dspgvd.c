	...
	int *liwork, int *info)
{
    ...
    extern  int dtpmv_(char *, char *, char *, int *, 
	    ...
	    double *, int *);
    int wantz;
    extern  int xerbla_(char *, int *), dspevd_(
	    char *, char *, int *, double *, double *, double 
	    *, int *, double *, int *, int *, int *, 
	    int *);
    int liwmin;
    extern  int dpptrf_(char *, int *, double *, 
	    int *), dspgst_(int *, char *, int *, 
	    double *, double *, int *);
    int lquery;
