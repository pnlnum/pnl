...
static int c__1 = 1;
static double c_b36 = 10.;
static double c_b72 = .5;

 int zggbal_(char *job, int *n, doublecomplex *a, int 
...
/* Computing MAX */
	...
	ir = (int) (lscale[i__] + d_sign(&c_b72, &lscale[i__]));
/* Computing MIN */
...
/* Computing MAX */
	...
	jc = (int) (rscale[i__] + d_sign(&c_b72, &rscale[i__]));
/* Computing MIN */
