	...
	rwork, int *info)
{
    ...
    int isave[3];
    int upper;
    extern  int ztbmv_(char *, char *, char *, int *, 
	    int *, doublecomplex *, int *, doublecomplex *, int *), zcopy_(int *, doublecomplex *, 
	    int *, doublecomplex *, int *), ztbsv_(char *, char *, 
	    char *, int *, int *, doublecomplex *, int *, 
	    doublecomplex *, int *), zaxpy_(
