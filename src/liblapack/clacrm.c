...
static float c_b7 = 0.f;
 ...
 int clacrm_(int *m, int *n, complex *a, int *lda, 
	 float *b, int *ldb, complex *c__, int *ldc, float *rwork)
{
    /* System generated locals */
    int b_dim1, b_offset, a_dim1, a_offset, c_dim1, c_offset, i__1, i__2, 
	    i__3, i__4, i__5;
    float r__1;
    complex q__1;
...
/*           C := A * B, */
/*  where A is M by N and complex; B is N by N and float; */
