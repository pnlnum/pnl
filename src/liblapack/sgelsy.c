...
static int c_n1 = -1;
static int c__0 = 0;
static float c_b31 = 0.f;
static int c__2 = 2;
static float c_b54 = 1.f;
	...
	int *rank, float *work, int *lwork, int *info)
{
    ...
    extern  int strsm_(char *, char *, char *, char *, 
	    ...
	    float *, float *, float *, float *, float *, float *, float *), sgeqp3_(
...
, int *, int *), slabad_(float *, float *);
    ...
    extern  int sormqr_(char *, char *, int *, int *, 
	    ...
	    int *, int *), sormrz_(char *, char *, 
	    int *, int *, int *, int *, float *, int *, 
	    float *, float *, int *, float *, int *, int *), stzrzf_(int *, int *, float *, int *, float *, 
	    float *, int *, int *);
...
/*  SGELSY computes the minimum-norm solution to a float linear least */
/*  squares problem: */
/*      minimize || A * X - B || */
