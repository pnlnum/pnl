...
static int c__2 = 2;
 ...
 int slarre_(char *range, int *n, float *vl, float *vu, 
	int *il, int *iu, float *d__, float *e, float *e2, float *rtol1, 
	float *rtol2, float *spltol, int *nsplit, int *isplit, int *
	m, float *w, float *werr, float *wgap, int *iblock, int *indexw, 
	float *gers, float *pivmin, float *work, int *iwork, int *info)
{
    ...
    int wbegin;
    float safmin, spdiam;
    extern  int slarra_(int *, float *, float *, float *, 
	    float *, float *, int *, int *, int *);
    int usedqd;
    float clwdth, isleft;
    extern  int slarrb_(int *, float *, float *, int *, 
	    int *, float *, float *, int *, float *, float *, float *, 
	    float *, int *, float *, float *, int *, int *), slarrc_(
	    char *, int *, float *, float *, float *, float *, float *, 
	    int *, int *, int *, int *), slarrd_(char 
	    *, char *, int *, float *, float *, int *, int *, float *
, float *, float *, float *, float *, float *, int *, int *, 
	    int *, float *, float *, float *, float *, int *, int *, 
	    float *, int *, int *), slarrk_(int *, 
	    int *, float *, float *, float *, float *, float *, float *, float *, 
	     float *, int *);
    float isrght, bsrtol, dpivot;
...
/*  To find the desired eigenvalues of a given float symmetric */
...
/*           the matrix is definite and we need not retreat. */
		...
		avgap = (r__1 = clwdth / (float) (wend - wbegin), ABS(r__1));
		if (sgndef == 1.f) {
/* Computing MAX */
		    r__1 = wgap[wbegin];
...
/*              here floatly only in the case of IRANGE = VALRNG or INDRNG. */
		if (idum == 5) {
		    if (sgndef == 1.f) {
