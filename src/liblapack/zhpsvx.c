	...
	work, double *rwork, int *info)
{
    ...
    extern double zlanhp_(char *, char *, int *, doublecomplex *, 
	    double *);
    extern  int zhpcon_(char *, int *, doublecomplex *, 
	    int *, double *, double *, doublecomplex *, int *), zlacpy_(char *, int *, int *, doublecomplex *, 
	    int *, doublecomplex *, int *), zhprfs_(char *, 
	    int *, int *, doublecomplex *, doublecomplex *, int *, 
	     doublecomplex *, int *, doublecomplex *, int *, 
	    double *, double *, doublecomplex *, double *, 
	    int *), zhptrf_(char *, int *, doublecomplex *, 
	    int *, int *), zhptrs_(char *, int *, int 
	    *, doublecomplex *, int *, doublecomplex *, int *, 
	    int *);
