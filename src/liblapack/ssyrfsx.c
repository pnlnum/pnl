...
static int c__1 = 1;
 ...
 int ssyrfsx_(char *uplo, char *equed, int *n, int *
	nrhs, float *a, int *lda, float *af, int *ldaf, int *ipiv, 
	float *s, float *b, int *ldb, float *x, int *ldx, float *rcond, 
	float *berr, int *n_err_bnds__, float *err_bnds_norm__, float *
	err_bnds_comp__, int *nparams, float *params, float *work, int *
	iwork, int *info)
{
    ...
    float rcond_tmp__;
    int prec_type__;
    extern double sla_syrcond__(char *, int *, float *, int *, 
	    float *, int *, int *, int *, float *, int *, float *
	    , int *, unsigned long);
    float cwise_wrong__;
    extern  int sla_syrfsx_extended__(int *, char *, 
    ...
    extern double slansy_(char *, char *, int *, float *, int *, 
	    float *);
    extern  int ssycon_(char *, int *, float *, int *, 
...
/*     Perform refinement on each right-hand side */
	...
	sla_syrfsx_extended__(&prec_type__, uplo, n, nrhs, &a[a_offset], lda, 
		...
		unstable_thresh__, &ignore_cwise__, info, (unsigned long)1);
    }
/* Computing MAX */
