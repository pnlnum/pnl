	...
	double *rwork, int *info)
{
    ...
    extern  int zgerc_(int *, int *, doublecomplex *, 
    ...
    extern  int zlar2v_(int *, doublecomplex *, 
	    ...
	    zdscal_(int *, double *, doublecomplex *, int *);
    int update;
    extern  int zlacgv_(int *, doublecomplex *, int *)
	    , zlaset_(char *, int *, int *, doublecomplex *, 
	    doublecomplex *, doublecomplex *, int *), zlartg_(
	    doublecomplex *, doublecomplex *, double *, doublecomplex *, 
	    doublecomplex *), zlargv_(int *, doublecomplex *, int *, 
	    doublecomplex *, int *, double *, int *), zlartv_(
