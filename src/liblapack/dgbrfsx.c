...
static int c__1 = 1;
 ...
 int dgbrfsx_(char *trans, char *equed, int *n, int *
	...
	int *info)
{
    ...
    extern double dla_gbrcond__(char *, int *, int *, int *, 
	    double *, int *, double *, int *, int *, 
	    int *, double *, int *, double *, int *, 
	    unsigned long);
    double cwise_wrong__;
    extern  int dla_gbrfsx_extended__(int *, int *, 
    ...
    double anorm;
    extern double dlangb_(char *, int *, int *, int *, 
	    double *, int *, double *), dlamch_(char *);
    extern  int dgbcon_(char *, int *, int *, int 
