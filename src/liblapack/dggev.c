	...
	int *info)
{
    ...
    extern  int dlabad_(double *, double *), dggbak_(
	    char *, char *, int *, int *, int *, double *, 
	    double *, int *, double *, int *, int *), dggbal_(char *, int *, double *, int 
    ...
    extern  int dgeqrf_(int *, int *, double *, 
	    ...
	    int *, double *, double *, double *, int *), dtgevc_(char *, char *, int *, int *, double 
	    *, int *, double *, int *, double *, int *, 
	    double *, int *, int *, int *, double *, 
	    int *);
    int ldumma[1];
...
/*  DGGEV computes for a pair of N-by-N float nonsymmetric matrices (A,B) */
