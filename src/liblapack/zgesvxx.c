...
#include "pnl/pnl_f2c.h"
 ...
 int zgesvxx_(char *fact, char *trans, int *n, int *
	...
	work, double *rwork, int *info)
{
    ...
    /* Local variables */
    int j;
    extern double zla_rpvgrw__(int *, int *, doublecomplex *, 
    ...
    double bignum;
    extern  int zlaqge_(int *, int *, doublecomplex *, 
...
, double *, char *);
    ...
    double rowcnd;
    int notran;
    extern  int zgetrf_(int *, int *, doublecomplex *, 
	     int *, int *, int *), zlacpy_(char *, int *, 
    ...
    extern  int zlascl2_(int *, int *, double *, 
	    doublecomplex *, int *), zgeequb_(int *, int *, 
	    doublecomplex *, int *, double *, double *, 
	    double *, double *, double *, int *), zgerfsx_(
	    char *, char *, int *, int *, doublecomplex *, int *, 
	    doublecomplex *, int *, int *, double *, double *, 
