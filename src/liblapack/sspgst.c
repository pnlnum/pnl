	 ...
	 float *bp, int *info)
{
    ...
    extern  int sspr2_(char *, int *, float *, float *, 
	    int *, float *, int *, float *);
    extern int lsame_(char *, char *);
    extern  int sscal_(int *, float *, float *, int *);
    int upper;
    extern  int saxpy_(int *, float *, float *, int *, 
	    float *, int *), sspmv_(char *, int *, float *, float *, 
	    float *, int *, float *, float *, int *), stpmv_(
	    char *, char *, char *, int *, float *, float *, int *), stpsv_(char *, char *, char *, int *, 
...
/*  SSPGST reduces a float symmetric-definite generalized eigenproblem */
