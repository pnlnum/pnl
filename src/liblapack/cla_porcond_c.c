...
double cla_porcond_c__(char *uplo, int *n, complex *a, int *lda, 
	complex *af, int *ldaf, float *c__, int *capply, int *info,
	 complex *work, float *rwork, unsigned long uplo_len)
{
