	...
	ldq, float *work, int *ncycle, int *info)
{
    ...
    /* Local variables */
    int i__, j;
    float a1, a2, a3, b1, b2, b3, csq, csu, csv, snq, rwk, snu, snv;
    ...
    extern  int scopy_(int *, float *, int *, float *, 
	    int *), slags2_(int *, float *, float *, float *, float *, 
	    float *, float *, float *, float *, float *, float *, float *, float *);
    int kcycle;
    extern  int xerbla_(char *, int *), slapll_(
	    int *, float *, int *, float *, int *, float *), slartg_(
	    float *, float *, float *, float *, float *), slaset_(char *, int *
