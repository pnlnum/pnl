...
static float c_b11 = 1.f;
 ...
 int sla_syrfsx_extended__(int *prec_type__, char *uplo, 
	int *n, int *nrhs, float *a, int *lda, float *af, int *
	ldaf, int *ipiv, int *colequ, float *c__, float *b, int *
	ldb, float *y, int *ldy, float *berr_out__, int *n_norms__, 
	float *err_bnds_norm__, float *err_bnds_comp__, float *res, float *ayb, 
	float *dy, float *y_tail__, float *rcond, int *ithresh, float *
