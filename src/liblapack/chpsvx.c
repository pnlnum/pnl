	...
	complex *work, float *rwork, int *info)
{
    ...
    int nofact;
    extern  int chpcon_(char *, int *, complex *, int 
	    *, float *, float *, complex *, int *), clacpy_(char *, 
	    int *, int *, complex *, int *, complex *, int *), xerbla_(char *, int *), chprfs_(char *, 
	    int *, int *, complex *, complex *, int *, complex *, 
	    int *, complex *, int *, float *, float *, complex *, float *
, int *), chptrf_(char *, int *, complex *, 
	    int *, int *), chptrs_(char *, int *, int 
