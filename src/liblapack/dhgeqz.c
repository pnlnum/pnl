	...
	double *work, int *lwork, int *info)
{
    ...
    extern  int drot_(int *, double *, int *, 
	    double *, int *, double *, double *), dlag2_(
    ...
    int maxit;
    double tempi, tempr;
    extern double dlapy2_(double *, double *), dlapy3_(double 
	    *, double *, double *);
    ...
    extern  int dlarfg_(int *, double *, double *, 
	     int *, double *);
...
/*  DHGEQZ computes the eigenvalues of a float matrix pair (H,T), */
