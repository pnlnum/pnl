...
/*  STGSEN reorders the generalized float Schur decomposition of a float */
/*  matrix pair (A, B) (in terms of an orthonormal equivalence trans- */
/*  formation Q' * (A, B) * Z), so that a selected cluster of eigenvalues */
/*  appears in the leading diagonal blocks of the upper quasi-triangular */
/*  matrix A and the upper triangular B. The leading columns of Q and */
/*  Z form orthonormal bases of the corresponding left and right eigen- */
/*  spaces (deflating subspaces). (A, B) must be in generalized float */
...
/*          To select a float eigenvalue w(j), SELECT(j) must be set to */
...
/*          generalized float Schur canonical form. */
...
/*          the float generalized Schur form of (A,B) were further reduced */
...
/*  reordered generalized float Schur form of (C, D) is given by */
