	...
	complex *work, float *rwork, int *info)
{
    ...
    extern  int clacpy_(char *, int *, int *, complex 
	    *, int *, complex *, int *), xerbla_(char *, 
	    int *);
    extern double clansp_(char *, char *, int *, complex *, float *);
    extern  int cspcon_(char *, int *, complex *, int 
	    *, float *, float *, complex *, int *), csprfs_(char *, 
	    int *, int *, complex *, complex *, int *, complex *, 
	    int *, complex *, int *, float *, float *, complex *, float *
, int *), csptrf_(char *, int *, complex *, 
	    int *, int *), csptrs_(char *, int *, int 
