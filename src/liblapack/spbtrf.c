	...
	int *ldab, int *info)
{
    ...
    /* Local variables */
    int i__, j, i2, i3, ib, nb, ii, jj;
    float work[1056]	/* was [33][32] */;
    ...
    extern  int sgemm_(char *, char *, int *, int *, 
	    ...
	    int *), ssyrk_(char *, char *, 
	     int *, int *, float *, float *, int *, float *, float *, 
	    int *), spbtf2_(char *, int *, int *, 
	    float *, int *, int *), spotf2_(char *, int *, 
...
/*  SPBTRF computes the Cholesky factorization of a float symmetric */
