...
double zla_syrcond_c__(char *uplo, int *n, doublecomplex *a, int *
	lda, doublecomplex *af, int *ldaf, int *ipiv, double *c__,
	 int *capply, int *info, doublecomplex *work, double *
	rwork, unsigned long uplo_len)
{
