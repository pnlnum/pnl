	...
	float *work, int *info)
{
    ...
    /* Local variables */
    float d__[16]	/* was [4][4] */;
    int k;
    float u[3], x[4]	/* was [2][2] */;
    int j2, j3, j4;
    float u1[3], u2[3];
    int nd;
    float cs, t11, t22, t33, sn, wi1, wi2, wr1, wr2, eps, tau, tau1, tau2;
    int ierr;
    float temp;
    extern  int srot_(int *, float *, int *, float *, 
	    int *, float *, float *);
    float scale, dnorm, xnorm;
    extern  int slanv2_(float *, float *, float *, float *, float *
, float *, float *, float *, float *, float *), slasy2_(int *, 
    ...
    extern  int slarfg_(int *, float *, float *, int *, 
	    float *), slacpy_(char *, int *, int *, float *, int *, 
	    float *, int *), slartg_(float *, float *, float *, float *
, float *);
    float thresh;
    extern  int slarfx_(char *, int *, int *, float *, 
...
/* Computing MAX */
	r__2 = ABS(d__[2]), r__3 = ABS(d__[6]), r__2 = MAX(r__2,r__3), r__3 
...
/* Computing MAX */
	r__2 = ABS(d__[1]), r__3 = ABS(d__[2]), r__2 = MAX(r__2,r__3), r__3 
...
/* Computing MAX */
	r__1 = ABS(d__[2]), r__2 = ABS(d__[6]), r__1 = MAX(r__1,r__2), r__2 
		= ABS(d__[3]), r__1 = MAX(r__1,r__2), r__2 = ABS(d__[7]);
