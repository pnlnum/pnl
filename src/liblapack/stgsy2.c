	...
	*pq, int *info)
{
    ...
    /* Local variables */
    int i__, j, k, p, q;
    float z__[64]	/* was [8][8] */;
    int ie, je, mb, nb, ii, jj, is, js;
    float rhs[8];
    int isp1, jsp1;
    extern  int sger_(int *, int *, float *, float *, 
	    int *, float *, int *, float *, int *);
    int ierr, zdim, ipiv[8], jpiv[8];
    float alpha;
    ...
    extern  int sscal_(int *, float *, float *, int *), 
	    ...
	    sgesc2_(int *, float *, int *, float *, int *, int *
, float *), sgetc2_(int *, float *, int *, int *, 
	    int *, int *);
    float scaloc;
    extern  int slatdf_(int *, int *, float *, int 
	    *, float *, float *, float *, int *, int *), xerbla_(char *, 
	    int *), slaset_(char *, int *, int *, float *, 
	    float *, float *, int *);
    int notran;
...
/*  N-by-N and M-by-N, respectively, with float entries. (A, D) and (B, E) */
