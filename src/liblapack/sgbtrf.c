	 ...
	 float *ab, int *ldab, int *ipiv, int *info)
{
    ...
    float work13[4160]	/* was [65][64] */, work31[4160]	/* was [65][
	    64] */;
    extern  int scopy_(int *, float *, int *, float *, 
	    int *), sswap_(int *, float *, int *, float *, int *
), strsm_(char *, char *, char *, char *, int *, int *, 
	    float *, float *, int *, float *, int *), sgbtf2_(int *, int *, int *, int 
	    *, float *, int *, int *, int *), xerbla_(char *, 
	    int *);
    extern int ilaenv_(int *, char *, char *, int *, int *, 
	    int *, int *), isamax_(int *, float *, 
	    int *);
...
/*  SGBTRF computes an LU factorization of a float m-by-n band matrix A */
