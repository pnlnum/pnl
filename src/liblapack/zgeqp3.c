...
static int c__2 = 2;
 ...
 int zgeqp3_(int *m, int *n, doublecomplex *a, 
	...
	int *lwork, double *rwork, int *info)
{
    ...
    /* Local variables */
    int j, jb, na, nb, sm, sn, nx, fjb, iws, nfxd, nbmin, minmn, minws;
    extern  int zswap_(int *, doublecomplex *, int *, 
	    doublecomplex *, int *), zlaqp2_(int *, int *, 
	    int *, doublecomplex *, int *, int *, doublecomplex *, 
	     double *, double *, doublecomplex *);
    ...
    int topbmn, sminmn;
    extern  int zlaqps_(int *, int *, int *, 
