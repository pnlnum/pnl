...
static int c_false = FALSE;
 ...
 int zsyrfsx_(char *uplo, char *equed, int *n, int *
	nrhs, doublecomplex *a, int *lda, doublecomplex *af, int *
	ldaf, int *ipiv, double *s, doublecomplex *b, int *ldb, 
	doublecomplex *x, int *ldx, double *rcond, double *berr, 
	int *n_err_bnds__, double *err_bnds_norm__, double *
	err_bnds_comp__, int *nparams, double *params, doublecomplex *
	work, double *rwork, int *info)
{
    ...
    char norm[1];
    extern  int zla_syrfsx_extended__(int *, char *, 
	    int *, int *, doublecomplex *, int *, doublecomplex *,
	     int *, int *, int *, double *, doublecomplex *, 
	    int *, doublecomplex *, int *, double *, int *, 
	    double *, double *, doublecomplex *, double *, 
	    doublecomplex *, doublecomplex *, double *, int *, 
	    double *, double *, int *, int *, unsigned long);
    int ignore_cwise__;
    extern int lsame_(char *, char *);
    double anorm;
    int rcequ;
    extern double zla_syrcond_c__(char *, int *, doublecomplex *, 
	    int *, doublecomplex *, int *, int *, double *, 
	    int *, int *, doublecomplex *, double *, unsigned long), 
	    zla_syrcond_x__(char *, int *, doublecomplex *, int *, 
	    doublecomplex *, int *, int *, doublecomplex *, int *,
	     doublecomplex *, double *, unsigned long), dlamch_(char *);
    extern  int xerbla_(char *, int *);
    extern double zlansy_(char *, char *, int *, doublecomplex *, 
	    int *, double *);
    extern  int zsycon_(char *, int *, doublecomplex *, 
	    int *, int *, double *, double *, doublecomplex *, 
	     int *);
