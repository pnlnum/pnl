	...
	int *lda, float *b, int *ldb, int *info)
{
    ...
    int k;
    float ct, akk, bkk;
    extern  int ssyr2_(char *, int *, float *, float *, 
	    int *, float *, int *, float *, int *);
    extern int lsame_(char *, char *);
    extern  int sscal_(int *, float *, float *, int *);
    int upper;
    extern  int saxpy_(int *, float *, float *, int *, 
	    float *, int *), strmv_(char *, char *, char *, int *, 
	    float *, int *, float *, int *), 
	    strsv_(char *, char *, char *, int *, float *, int *, float 
...
/*  SSYGS2 reduces a float symmetric-definite generalized eigenproblem */
/*  to standard form. */
