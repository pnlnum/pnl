	 ...
	 doublecomplex *ab, int *ldab, int *ipiv, int *info)
{
    ...
    extern  int zgeru_(int *, int *, doublecomplex *, 
	    ...
	    doublecomplex *, int *), zcopy_(int *, doublecomplex *, 
	    int *, doublecomplex *, int *), zswap_(int *, 
	    doublecomplex *, int *, doublecomplex *, int *), ztrsm_(
    ...
    extern int ilaenv_(int *, char *, char *, int *, int *, 
	    int *, int *), izamax_(int *, 
	    doublecomplex *, int *);
    extern  int zlaswp_(int *, doublecomplex *, int *, 
	     int *, int *, int *, int *);
