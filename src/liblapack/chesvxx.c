...
#include "pnl/pnl_f2c.h"
 ...
 int chesvxx_(char *fact, char *uplo, int *n, int *
	nrhs, complex *a, int *lda, complex *af, int *ldaf, int *
	ipiv, char *equed, float *s, complex *b, int *ldb, complex *x, 
	int *ldx, float *rcond, float *rpvgrw, float *berr, int *
	n_err_bnds__, float *err_bnds_norm__, float *err_bnds_comp__, int *
	nparams, float *params, complex *work, float *rwork, int *info)
{
    ...
    extern double cla_herpvgrw__(char *, int *, int *, complex *, 
	    int *, complex *, int *, int *, float *, unsigned long);
    extern int lsame_(char *, char *);
    float scond;
    int equil, rcequ;
    extern  int claqhe_(char *, int *, complex *, int 
	    *, float *, float *, float *, char *);
    extern double slamch_(char *);
    int nofact;
    extern  int chetrf_(char *, int *, complex *, int 
	    *, int *, complex *, int *, int *), clacpy_(
    ...
    float smlnum;
    extern  int clascl2_(int *, int *, float *, 
	    complex *, int *), cheequb_(char *, int *, complex *, 
	    int *, float *, float *, float *, complex *, int *), 
	    cherfsx_(char *, char *, int *, int *, complex *, int 
	    *, complex *, int *, int *, float *, complex *, int *, 
	    complex *, int *, float *, float *, int *, float *, float *, 
	    int *, float *, complex *, float *, int *);
...
/*           leading rank-deficient INFO columns of A. */
		...
		*rpvgrw = cla_herpvgrw__(uplo, n, info, &a[a_offset], lda, &
			af[af_offset], ldaf, &ipiv[1], &rwork[1], (unsigned long)1);
	    }
	    return 0;
	}
    }
...
/*     Compute the reciprocal pivot growth factor RPVGRW. */
	...
	*rpvgrw = cla_herpvgrw__(uplo, n, info, &a[a_offset], lda, &af[
		af_offset], ldaf, &ipiv[1], &rwork[1], (unsigned long)1);
    }
