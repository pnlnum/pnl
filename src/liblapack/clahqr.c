	...
	info)
{
    ...
    extern  int cscal_(int *, complex *, complex *, 
	    int *), ccopy_(int *, complex *, int *, complex *, 
	    int *);
    float rtemp;
    extern  int slabad_(float *, float *), clarfg_(int *, 
	    complex *, complex *, int *, complex *);
    extern /* Complex */ VOID cladiv_(complex *, complex *, complex *);
    extern double slamch_(char *);
    float safmin, safmax, smlnum;
...
/*     ==== ensure that subdiagonal entries are float ==== */
    if (*wantt) {
	jlo = 1;
	jhi = *n;
    } else {
...
/*        Look for a single small subdiagonal element. */
	...
	for (k = i__; k >= i__1; --k) {
	    i__2 = k + (k - 1) * h_dim1;
	    if ((r__1 = h__[i__2].r, ABS(r__1)) + (r__2 = r_imag(&h__[k + (k 
		    - 1) * h_dim1]), ABS(r__2)) <= smlnum) {
		goto L50;
	    }
	    i__2 = k - 1 + (k - 1) * h_dim1;
	    i__3 = k + k * h_dim1;
	    tst = (r__1 = h__[i__2].r, ABS(r__1)) + (r__2 = r_imag(&h__[k - 
		    1 + (k - 1) * h_dim1]), ABS(r__2)) + ((r__3 = h__[i__3]
		    .r, ABS(r__3)) + (r__4 = r_imag(&h__[k + k * h_dim1]), 
		    ABS(r__4)));
	    if (tst == 0.f) {
		if (k - 2 >= *ilo) {
		    i__2 = k - 1 + (k - 2) * h_dim1;
...
/* Computing MAX */
		i__2 = k + (k - 1) * h_dim1;
		i__3 = k - 1 + k * h_dim1;
		r__5 = (r__1 = h__[i__2].r, ABS(r__1)) + (r__2 = r_imag(&h__[
			k + (k - 1) * h_dim1]), ABS(r__2)), r__6 = (r__3 = 
			h__[i__3].r, ABS(r__3)) + (r__4 = r_imag(&h__[k - 1 
			+ k * h_dim1]), ABS(r__4));
		ab = MAX(r__5,r__6);
/* Computing MIN */
		i__2 = k + (k - 1) * h_dim1;
...
/* Computing MAX */
		i__4 = k + k * h_dim1;
		r__5 = (r__1 = h__[i__4].r, ABS(r__1)) + (r__2 = r_imag(&h__[
...
/*           negligible. */
	    ...
	    i__2 = m + 1 + m * h_dim1;
	    h21 = h__[i__2].r;
	    s = (r__1 = h11s.r, ABS(r__1)) + (r__2 = r_imag(&h11s), ABS(
		    r__2)) + ABS(h21);
	    ...
	    if (ABS(h10) * ABS(h21) <= ulp * (((r__1 = h11s.r, ABS(r__1)) 
		    + (r__2 = r_imag(&h11s), ABS(r__2))) * ((r__3 = h11.r, 
		    ABS(r__3)) + (r__4 = r_imag(&h11), ABS(r__4)) + ((r__5 =
...
/*           V(2) is always float before the call to CLARFG, and hence */
/*           after the call T2 ( = T1*V(2) ) is also float. */
