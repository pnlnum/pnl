...
static float c_b11 = 1.f;
 ...
 int sla_porfsx_extended__(int *prec_type__, char *uplo, 
	int *n, int *nrhs, float *a, int *lda, float *af, int *
	ldaf, int *colequ, float *c__, float *b, int *ldb, float *y, 
	int *ldy, float *berr_out__, int *n_norms__, float *
	err_bnds_norm__, float *err_bnds_comp__, float *res, float *ayb, float *
	dy, float *y_tail__, float *rcond, int *ithresh, float *rthresh, 
	float *dz_ub__, int *ignore_cwise__, int *info, unsigned long 
	uplo_len)
{
    ...
    int i__, j;
    int incr_prec__;
    extern  int sla_syamv__(int *, int *, float *, 
	    float *, int *, float *, int *, float *, float *, int *);
    float prev_dz_z__, yk, final_dx_x__, final_dz_z__;
    extern  int sla_wwaddw__(int *, float *, float *, float *
	    );
    float prevnormdx;
    int cnt;
    float dyk, eps, incr_thresh__, dx_x__, dz_z__, ymin;
    extern  int sla_lin_berr__(int *, int *, int *
	    , float *, float *, float *);
    int y_prec_state__, uplo2;
    extern  int blas_ssymv_x__(int *, int *, float *, 
	    float *, int *, float *, int *, float *, float *, int *, 
	    int *);
    extern int lsame_(char *, char *);
    float dxrat, dzrat;
    extern  int blas_ssymv2_x__(int *, int *, float *, 
	    float *, int *, float *, float *, int *, float *, float *, 
	    int *, int *), scopy_(int *, float *, int *, float *
, int *);
    float normx, normy;
    extern  int saxpy_(int *, float *, float *, int *, 
	    float *, int *), ssymv_(char *, int *, float *, float *, 
	    int *, float *, int *, float *, float *, int *);
    extern double slamch_(char *);
    float normdx;
    extern  int spotrs_(char *, int *, int *, float *, 
	    int *, float *, int *, int *);
    float hugeval;
