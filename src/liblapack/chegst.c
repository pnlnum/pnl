...
static float c_b18 = 1.f;
 ...
 int chegst_(int *itype, char *uplo, int *n, complex *
	a, int *lda, complex *b, int *ldb, int *info)
{
    ...
    /* Local variables */
    int k, kb, nb;
    extern  int chemm_(char *, char *, int *, int *, 
	    complex *, complex *, int *, complex *, int *, complex *, 
	    complex *, int *);
    extern int lsame_(char *, char *);
    extern  int ctrmm_(char *, char *, char *, char *, 
	    int *, int *, complex *, complex *, int *, complex *, 
	    int *), ctrsm_(char *, char *, 
	     char *, char *, int *, int *, complex *, complex *, 
	    int *, complex *, int *);
    int upper;
    extern  int chegs2_(int *, char *, int *, complex 
	    *, int *, complex *, int *, int *), cher2k_(
	    char *, char *, int *, int *, complex *, complex *, 
	    int *, complex *, int *, float *, complex *, int *), xerbla_(char *, int *);
