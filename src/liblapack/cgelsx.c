...
static int c__1 = 1;
 ...
 int cgelsx_(int *m, int *n, int *nrhs, complex *
	a, int *lda, complex *b, int *ldb, int *jpvt, float *rcond, 
	 int *rank, complex *work, float *rwork, int *info)
{
    ...
    extern  int ctrsm_(char *, char *, char *, char *, 
	    ...
	    complex *, complex *), cunm2r_(char *, char *, int *, int 
	    *, int *, complex *, int *, complex *, complex *, int 
	    *, complex *, int *), slabad_(float *, float *);
    extern double clange_(char *, int *, int *, complex *, 
	    int *, float *);
    extern  int clascl_(char *, int *, int *, float *, 
	    float *, int *, int *, complex *, int *, int *), cgeqpf_(int *, int *, complex *, int *, 
	    int *, complex *, complex *, float *, int *);
    extern double slamch_(char *);
    extern  int claset_(char *, int *, int *, complex 
	    *, complex *, complex *, int *), xerbla_(char *, 
	    int *);
    float bignum;
    extern  int clatzm_(char *, int *, int *, complex 
	    *, int *, complex *, complex *, complex *, int *, complex 
	    *);
    float sminpr;
    extern  int ctzrqf_(int *, int *, complex *, 
	    int *, complex *, int *);
    float smaxpr, smlnum;
