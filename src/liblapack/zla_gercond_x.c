...
double zla_gercond_x__(char *trans, int *n, doublecomplex *a, int 
	*lda, doublecomplex *af, int *ldaf, int *ipiv, doublecomplex *
	x, int *info, doublecomplex *work, double *rwork, unsigned long 
	trans_len)
{
