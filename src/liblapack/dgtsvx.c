	...
	iwork, int *info)
{
    ...
    extern  int dcopy_(int *, double *, int *, 
	    double *, int *);
    extern double dlamch_(char *), dlangt_(char *, int *, 
    ...
    extern  int dlacpy_(char *, int *, int *, 
	    ...
	    double *, double *, double *, double *, int *, 
	     double *, double *, double *, int *, int *), dgtrfs_(char *, int *, int *, double *, 
	    double *, double *, double *, double *, 
	    double *, double *, int *, double *, int *, 
	    double *, int *, double *, double *, double *, 
	     int *, int *), dgttrf_(int *, double *, 
	    double *, double *, double *, int *, int *);
    int notran;
    extern  int dgttrs_(char *, int *, int *, 
	    double *, double *, double *, double *, int *, 
	     double *, int *, int *);
...
/*  DGTSVX uses the LU factorization to compute the solution to a float */
