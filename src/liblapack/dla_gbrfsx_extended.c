...
static double c_b8 = 1.;
 ...
 int dla_gbrfsx_extended__(int *prec_type__, int *
	...
	*rthresh, double *dz_ub__, int *ignore_cwise__, int *info)
{
    ...
    int i__, j, m;
    extern  int dla_gbamv__(int *, int *, int *, 
    ...
    double ymin;
    extern  int blas_dgbmv_x__(int *, int *, int *
	    , int *, int *, double *, double *, int *, 
	    double *, int *, double *, double *, int *, 
	    int *);
    int y_prec_state__;
    extern  int blas_dgbmv2_x__(int *, int *, int 
	    *, int *, int *, double *, double *, int *, 
	    double *, double *, int *, double *, double *,
	     int *, int *), dgbmv_(char *, int *, int *, 
	    int *, int *, double *, double *, int *, 
