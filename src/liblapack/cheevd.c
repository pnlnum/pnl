...
static float c_b18 = 1.f;
 ...
 int cheevd_(char *jobz, char *uplo, int *n, complex *a, 
	int *lda, float *w, complex *work, int *lwork, float *rwork, 
	int *lrwork, int *iwork, int *liwork, int *info)
{
    ...
    extern  int chetrd_(char *, int *, complex *, int 
	    *, float *, float *, complex *, complex *, int *, int *), clacpy_(char *, int *, int *, complex *, int 
	    *, complex *, int *);
    float safmin;
    ...
    float bignum;
    int indtau, indrwk, indwrk, liwmin;
