	...
	*work, int *iwork, int *info)
{
    ...
    extern  int sppcon_(char *, int *, float *, float *, 
	    float *, float *, int *, int *), slaqsp_(char *, 
	    int *, float *, float *, float *, float *, char *)
	    ;
    float smlnum;
    extern  int sppequ_(char *, int *, float *, float *, 
	    float *, float *, int *), spprfs_(char *, int *, 
	    int *, float *, float *, float *, int *, float *, int *, 
	    float *, float *, float *, int *, int *), spptrf_(
	    char *, int *, float *, int *), spptrs_(char *, 
