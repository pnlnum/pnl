...
static int c__12 = 12;
 ...
 int zlaqr3_(int *wantt, int *wantz, int *n, 
	...
	doublecomplex *work, int *lwork)
{
    ...
    extern  int zgehrd_(int *, int *, int *, 
	    doublecomplex *, int *, doublecomplex *, doublecomplex *, 
	    int *, int *), zlarfg_(int *, doublecomplex *, 
	    doublecomplex *, int *, doublecomplex *), zlahqr_(int *, 
	    int *, int *, int *, int *, doublecomplex *, 
	    int *, doublecomplex *, int *, int *, doublecomplex *, 
	     int *, int *), zlacpy_(char *, int *, int *, 
	    doublecomplex *, int *, doublecomplex *, int *), 
	    zlaset_(char *, int *, int *, doublecomplex *, 
	    doublecomplex *, doublecomplex *, int *);
    double smlnum;
    extern  int ztrexc_(char *, int *, doublecomplex *, 
	    int *, doublecomplex *, int *, int *, int *, 
	    int *);
    int lwkopt;
    extern  int zunmhr_(char *, char *, int *, int *, 
