...
#include "pnl/pnl_f2c.h"
 ...
 int dgesvxx_(char *fact, char *trans, int *n, int *
	...
	int *info)
{
    ...
    /* Local variables */
    int j;
    extern double dla_rpvgrw__(int *, int *, double *, 
	    int *, double *, int *);
    double amax;
    ...
    extern  int dlaqge_(int *, int *, double *, 
	    int *, double *, double *, double *, double *, 
	     double *, char *);
    double colcnd;
    int nofact;
    extern  int dgetrf_(int *, int *, double *, 
	    int *, int *, int *), dlacpy_(char *, int *, 
	    int *, double *, int *, double *, int *), xerbla_(char *, int *);
    double bignum;
    int infequ;
    int colequ;
    ...
    double smlnum;
    int rowequ;
    extern  int dlascl2_(int *, int *, double *, 
	    double *, int *), dgeequb_(int *, int *, 
	    double *, int *, double *, double *, double *, 
	     double *, double *, int *), dgerfsx_(char *, char *, 
