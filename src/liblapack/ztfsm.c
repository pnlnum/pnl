...
static doublecomplex c_b1 = {1.,0.};
 ...
 int ztfsm_(char *transr, char *side, char *uplo, char *trans, 
	 char *diag, int *m, int *n, doublecomplex *alpha, 
	doublecomplex *a, doublecomplex *b, int *ldb)
{
    ...
    /* Local variables */
    int i__, j, k, m1, m2, n1, n2, info;
    int normaltransr, lside;
