...
static double c_b35 = 1.;
 ...
 int dgsvj1_(char *jobv, int *m, int *n, int *n1, 
	...
	lwork, int *info)
{
    ...
    double temp1, large, apoaq, aqoap;
    ...
    extern  int daxpy_(int *, double *, double *, 
	    int *, double *, int *), drotm_(int *, double 
...
/*     Additional steering devices */
	...
	if (i__ > swband + 1 && mxaapq < (double) (*n) * *tol && (
