	...
	int *info)
{
    ...
    extern  int xerbla_(char *, int *), slauum_(
	    char *, int *, float *, int *, int *), strtri_(
	    char *, char *, int *, float *, int *, int *);
...
/*  SPOTRI computes the inverse of a float symmetric positive definite */
