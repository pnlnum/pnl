	...
	doublecomplex *work, double *rwork, int *info)
{
    ...
    extern  int zcopy_(int *, doublecomplex *, int *, 
	    ...
	    doublecomplex *, int *, doublecomplex *, int *), ztpmv_(
	    char *, char *, char *, int *, doublecomplex *, doublecomplex 
	    *, int *), ztpsv_(char *, char *, 
	    char *, int *, doublecomplex *, doublecomplex *, int *), zlacn2_(int *, doublecomplex *, 
