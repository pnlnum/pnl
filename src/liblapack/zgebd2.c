...
static int c__1 = 1;
 ...
 int zgebd2_(int *m, int *n, doublecomplex *a, 
	...
	doublecomplex *taup, doublecomplex *work, int *info)
{
    ...
    extern  int zlarf_(char *, int *, int *, 
	    ...
	    int *, doublecomplex *), xerbla_(char *, int *), zlarfg_(int *, doublecomplex *, doublecomplex *, 
...
/*  float bidiagonal form B by a unitary transformation: Q' * A * P = B. */
