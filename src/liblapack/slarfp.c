...
#include "pnl/pnl_f2c.h"
 ...
 int slarfp_(int *n, float *alpha, float *x, int *incx, 
	float *tau)
{
...
/*  SLARFP generates a float elementary reflector H of order n, such */
/*  that */
...
/*  an (n-1)-element float vector.  H is represented in the form */
