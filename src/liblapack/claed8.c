...
static int c__1 = 1;
 ...
 int claed8_(int *k, int *n, int *qsiz, complex *
	q, int *ldq, float *d__, float *rho, int *cutpnt, float *z__, 
	float *dlamda, complex *q2, int *ldq2, float *w, int *indxp, 
	...
	int *givcol, float *givnum, int *info)
{
    ...
    int i__, j;
    float s, t;
    int k2, n1, n2, jp, n1p1;
    float eps, tau, tol;
    int jlam, imax, jmax;
    extern  int sscal_(int *, float *, float *, int *), 
	    ccopy_(int *, complex *, int *, complex *, int *), 
	    csrot_(int *, complex *, int *, complex *, int *, 
	    float *, float *), scopy_(int *, float *, int *, float *, 
	    int *);
