...
#include "pnl/pnl_f2c.h"
 ...
 int slarrj_(int *n, float *d__, float *e2, int *ifirst, 
	 int *ilast, float *rtol, int *offset, float *w, float *werr, 
	float *work, int *iwork, float *pivmin, float *spdiam, int *info)
{
