...
static int c__2 = 2;
 ...
 int slarrv_(int *n, float *vl, float *vu, float *d__, float *
	l, float *pivmin, int *isplit, int *m, int *dol, int *
	dou, float *minrgp, float *rtol1, float *rtol2, float *w, float *werr, 
	float *wgap, int *iblock, int *indexw, float *gers, float *z__, 
	int *ldz, int *isuppz, float *work, int *iwork, int *
	info)
{
    ...
    float rqtol;
    int iindc1, iindc2;
    extern  int slar1v_(int *, int *, int *, float 
	    *, float *, float *, float *, float *, float *, float *, float *, 
	    int *, int *, float *, float *, int *, int *, float *
, float *, float *, float *);
    int stp2ii;
    float lambda;
    int ibegin, indeig;
    ...
    extern  int slarrb_(int *, float *, float *, int *, 
	    ...
	    float *, int *, float *, float *, int *, int *), slarrf_(
	    int *, float *, float *, float *, int *, int *, float *, 
	    float *, float *, float *, float *, float *, float *, float *, float *, 
	    float *, float *, int *);
    int newcls, oldfst, indwrk, windex, oldlst;
    int usedrq;
    int newfst, newftt, parity, windmn, isupmn, newlst, windpl, zusedl, 
...
/*                          floatity are not. This could have a negative impact */
