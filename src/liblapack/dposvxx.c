...
#include "pnl/pnl_f2c.h"
 ...
 int dposvxx_(char *fact, char *uplo, int *n, int *
	...
	work, int *iwork, int *info)
{
    ...
    extern double dla_porpvgrw__(char *, int *, double *, int 
	    *, double *, int *, double *, unsigned long);
    ...
    extern  int dlaqsy_(char *, int *, double *, 
	    int *, double *, double *, double *, char *), dpotrf_(char *, int *, double *, int 
	    *, int *);
    double smlnum;
    extern  int dpotrs_(char *, int *, int *, 
	    double *, int *, double *, int *, int *), dlascl2_(int *, int *, double *, double *
, int *), dpoequb_(int *, double *, int *, 
	    double *, double *, double *, int *), dporfsx_(
