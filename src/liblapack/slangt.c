...
double slangt_(char *norm, int *n, float *dl, float *d__, float *du)
{
...
/* Computing MAX */
	    r__2 = anorm, r__3 = (r__1 = dl[i__], ABS(r__1));
	    anorm = MAX(r__2,r__3);
/* Computing MAX */
	    r__2 = anorm, r__3 = (r__1 = d__[i__], ABS(r__1));
	    anorm = MAX(r__2,r__3);
/* Computing MAX */
	    r__2 = anorm, r__3 = (r__1 = du[i__], ABS(r__1));
	    anorm = MAX(r__2,r__3);
/* L10: */
	}
...
/* Computing MAX */
	    r__3 = ABS(d__[1]) + ABS(dl[1]), r__4 = (r__1 = d__[*n], ABS(
		    r__1)) + (r__2 = du[*n - 1], ABS(r__2));
	    anorm = MAX(r__3,r__4);
	    i__1 = *n - 1;
	    for (i__ = 2; i__ <= i__1; ++i__) {
/* Computing MAX */
		r__4 = anorm, r__5 = (r__1 = d__[i__], ABS(r__1)) + (r__2 = 
			dl[i__], ABS(r__2)) + (r__3 = du[i__ - 1], ABS(r__3)
			);
		anorm = MAX(r__4,r__5);
/* L20: */
	    }
...
/* Computing MAX */
	    r__3 = ABS(d__[1]) + ABS(du[1]), r__4 = (r__1 = d__[*n], ABS(
		    r__1)) + (r__2 = dl[*n - 1], ABS(r__2));
	    anorm = MAX(r__3,r__4);
	    i__1 = *n - 1;
	    for (i__ = 2; i__ <= i__1; ++i__) {
/* Computing MAX */
		r__4 = anorm, r__5 = (r__1 = d__[i__], ABS(r__1)) + (r__2 = 
			du[i__], ABS(r__2)) + (r__3 = dl[i__ - 1], ABS(r__3)
			);
		anorm = MAX(r__4,r__5);
/* L30: */
	    }
