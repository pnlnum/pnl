	...
	int *info)
{
    ...
    extern  int clacn2_(int *, complex *, complex *, float 
	    *, int *, int *), clagtm_(char *, int *, int *, 
	    float *, complex *, complex *, complex *, complex *, int *, 
	    float *, complex *, int *);
...
/*        error bound. */
	...
	if (notran) {
		...
		rwork[1] = (r__1 = b[i__2].r, ABS(r__1)) + (r__2 = r_imag(&b[
			j * b_dim1 + 1]), ABS(r__2)) + ((r__3 = d__[1].r, 
			ABS(r__3)) + (r__4 = r_imag(&d__[1]), ABS(r__4))) * 
		...
		rwork[1] = (r__1 = b[i__2].r, ABS(r__1)) + (r__2 = r_imag(&b[
			...
			* x_dim1 + 1]), ABS(r__6))) + ((r__7 = du[1].r, ABS(
			r__7)) + (r__8 = r_imag(&du[1]), ABS(r__8))) * ((
			r__9 = x[i__4].r, ABS(r__9)) + (r__10 = r_imag(&x[j *
			 x_dim1 + 2]), ABS(r__10)));
		i__2 = *n - 1;
		for (i__ = 2; i__ <= i__2; ++i__) {
		    ...
		    rwork[i__] = (r__1 = b[i__3].r, ABS(r__1)) + (r__2 = 
			    r_imag(&b[i__ + j * b_dim1]), ABS(r__2)) + ((
			    r__3 = dl[i__4].r, ABS(r__3)) + (r__4 = r_imag(&
			    dl[i__ - 1]), ABS(r__4))) * ((r__5 = x[i__5].r, 
			    ABS(r__5)) + (r__6 = r_imag(&x[i__ - 1 + j * 
			    x_dim1]), ABS(r__6))) + ((r__7 = d__[i__6].r, 
			    ABS(r__7)) + (r__8 = r_imag(&d__[i__]), ABS(
			    r__8))) * ((r__9 = x[i__7].r, ABS(r__9)) + (
			    r__10 = r_imag(&x[i__ + j * x_dim1]), ABS(r__10))
			    ) + ((r__11 = du[i__8].r, ABS(r__11)) + (r__12 = 
			    r_imag(&du[i__]), ABS(r__12))) * ((r__13 = x[
			    i__9].r, ABS(r__13)) + (r__14 = r_imag(&x[i__ + 
			    1 + j * x_dim1]), ABS(r__14)));
/* L30: */
		}
		i__2 = *n + j * b_dim1;
		i__3 = *n - 1;
		...
		i__5 = *n;
		i__6 = *n + j * x_dim1;
		rwork[*n] = (r__1 = b[i__2].r, ABS(r__1)) + (r__2 = r_imag(&
			b[*n + j * b_dim1]), ABS(r__2)) + ((r__3 = dl[i__3]
			.r, ABS(r__3)) + (r__4 = r_imag(&dl[*n - 1]), ABS(
			r__4))) * ((r__5 = x[i__4].r, ABS(r__5)) + (r__6 = 
			r_imag(&x[*n - 1 + j * x_dim1]), ABS(r__6))) + ((
			r__7 = d__[i__5].r, ABS(r__7)) + (r__8 = r_imag(&d__[
			*n]), ABS(r__8))) * ((r__9 = x[i__6].r, ABS(r__9)) 
			+ (r__10 = r_imag(&x[*n + j * x_dim1]), ABS(r__10)));
	    }
	} else {
	    if (*n == 1) {
		i__2 = j * b_dim1 + 1;
		...
		rwork[1] = (r__1 = b[i__2].r, ABS(r__1)) + (r__2 = r_imag(&b[
			...
			* x_dim1 + 1]), ABS(r__6))) + ((r__7 = dl[1].r, ABS(
			r__7)) + (r__8 = r_imag(&dl[1]), ABS(r__8))) * ((
			r__9 = x[i__4].r, ABS(r__9)) + (r__10 = r_imag(&x[j *
			 x_dim1 + 2]), ABS(r__10)));
		i__2 = *n - 1;
		for (i__ = 2; i__ <= i__2; ++i__) {
		    ...
		    rwork[i__] = (r__1 = b[i__3].r, ABS(r__1)) + (r__2 = 
			    r_imag(&b[i__ + j * b_dim1]), ABS(r__2)) + ((
			    r__3 = du[i__4].r, ABS(r__3)) + (r__4 = r_imag(&
			    du[i__ - 1]), ABS(r__4))) * ((r__5 = x[i__5].r, 
			    ABS(r__5)) + (r__6 = r_imag(&x[i__ - 1 + j * 
			    x_dim1]), ABS(r__6))) + ((r__7 = d__[i__6].r, 
			    ABS(r__7)) + (r__8 = r_imag(&d__[i__]), ABS(
			    r__8))) * ((r__9 = x[i__7].r, ABS(r__9)) + (
			    r__10 = r_imag(&x[i__ + j * x_dim1]), ABS(r__10))
			    ) + ((r__11 = dl[i__8].r, ABS(r__11)) + (r__12 = 
			    r_imag(&dl[i__]), ABS(r__12))) * ((r__13 = x[
			    i__9].r, ABS(r__13)) + (r__14 = r_imag(&x[i__ + 
			    1 + j * x_dim1]), ABS(r__14)));
/* L40: */
		}
		...
		i__6 = *n + j * x_dim1;
		rwork[*n] = (r__1 = b[i__2].r, ABS(r__1)) + (r__2 = r_imag(&
			b[*n + j * b_dim1]), ABS(r__2)) + ((r__3 = du[i__3]
			.r, ABS(r__3)) + (r__4 = r_imag(&du[*n - 1]), ABS(
			r__4))) * ((r__5 = x[i__4].r, ABS(r__5)) + (r__6 = 
			r_imag(&x[*n - 1 + j * x_dim1]), ABS(r__6))) + ((
			r__7 = d__[i__5].r, ABS(r__7)) + (r__8 = r_imag(&d__[
			*n]), ABS(r__8))) * ((r__9 = x[i__6].r, ABS(r__9)) 
