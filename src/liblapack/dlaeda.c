	...
	double *z__, double *ztemp, int *info)
{
    ...
    int curr, bsiz1, bsiz2, psiz1, psiz2, zptr1;
    extern  int dgemv_(char *, int *, int *, 
	    double *, double *, int *, double *, int *, 
	    double *, double *, int *), dcopy_(int *, 
	    double *, int *, double *, int *), xerbla_(char *, 
	     int *);
...
/*     roots. */
    ...
    bsiz1 = (int) (sqrt((double) (qptr[curr + 1] - qptr[curr])) + .5);
    bsiz2 = (int) (sqrt((double) (qptr[curr + 2] - qptr[curr + 1])) + 
	    .5);
    i__1 = mid - bsiz1 - 1;
    for (k = 1; k <= i__1; ++k) {
	z__[k] = 0.;
...
/*        square roots. */
	...
	bsiz1 = (int) (sqrt((double) (qptr[curr + 1] - qptr[curr])) + 
		.5);
	bsiz2 = (int) (sqrt((double) (qptr[curr + 2] - qptr[curr + 1])
		) + .5);
	if (bsiz1 > 0) {
