	...
	int *info)
{
    ...
    extern double slansb_(char *, char *, int *, int *, float *, 
	    int *, float *);
    extern  int spbcon_(char *, int *, int *, float *, 
	    int *, float *, float *, float *, int *, int *), 
	    slaqsb_(char *, int *, int *, float *, int *, float *, 
	    float *, float *, char *);
    int infequ;
    extern  int slacpy_(char *, int *, int *, float *, 
	    int *, float *, int *), spbequ_(char *, int *, 
	    int *, float *, int *, float *, float *, float *, int *), spbrfs_(char *, int *, int *, int *, float *, 
	    int *, float *, int *, float *, int *, float *, int *
, float *, float *, float *, int *, int *), spbtrf_(
	    char *, int *, int *, float *, int *, int *);
    float smlnum;
    extern  int spbtrs_(char *, int *, int *, int 
