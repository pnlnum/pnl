...
static int c__1 = 1;
 ...
 int zcgesv_(int *n, int *nrhs, doublecomplex *a, 
	...
	double *rwork, int *iter, int *info)
{
    ...
    extern  int zgemm_(char *, char *, int *, int *, 
	    ...
	    int *), zaxpy_(int *, doublecomplex *, 
	    doublecomplex *, int *, doublecomplex *, int *), clag2z_(
	    int *, int *, complex *, int *, doublecomplex *, 
	    int *, int *), zlag2c_(int *, int *, 
    ...
    extern  int zlacpy_(char *, int *, int *, 
	    ...
	    zgetrf_(int *, int *, doublecomplex *, int *, int 
	    *, int *), zgetrs_(char *, int *, int *, 
