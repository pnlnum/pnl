...
double zla_porcond_x__(char *uplo, int *n, doublecomplex *a, int *
	lda, doublecomplex *af, int *ldaf, doublecomplex *x, int *
	info, doublecomplex *work, double *rwork, unsigned long uplo_len)
{
