	...
	tau, float *work, int *info)
{
    ...
    extern  int sgeqr2_(int *, int *, float *, int 
	    *, float *, float *, int *), sgerq2_(int *, int *, float 
	    *, int *, float *, float *, int *), sorg2r_(int *, 
...
, int *, float *, float *, int *, float *, int *), sormr2_(char *, char *, int *, int *, int *, 
	     float *, int *, float *, float *, int *, float *, int *), xerbla_(char *, int *), sgeqpf_(
	    int *, int *, float *, int *, int *, float *, float *
, int *), slacpy_(char *, int *, int *, float *, 
	    int *, float *, int *), slaset_(char *, int *, 
	    int *, float *, float *, float *, int *), slapmt_(
