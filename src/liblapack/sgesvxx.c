...
#include "pnl/pnl_f2c.h"
 ...
 int sgesvxx_(char *fact, char *trans, int *n, int *
	...
	nparams, float *params, float *work, int *iwork, int *info)
{
    ...
    /* Local variables */
    int j;
    extern double sla_rpvgrw__(int *, int *, float *, int *, 
	    float *, int *);
    float amax;
    ...
    int infequ;
    int colequ;
    extern  int sgetrf_(int *, int *, float *, int 
    ...
    extern  int slascl2_(int *, int *, float *, float *, 
	     int *), sgeequb_(int *, int *, float *, int *, 
	    float *, float *, float *, float *, float *, int *), sgerfsx_(char 
	    *, char *, int *, int *, float *, int *, float *, 
