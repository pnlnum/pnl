...
double zla_porcond_c__(char *uplo, int *n, doublecomplex *a, int *
	lda, doublecomplex *af, int *ldaf, double *c__, int *
	capply, int *info, doublecomplex *work, double *rwork, unsigned long 
	uplo_len)
{
