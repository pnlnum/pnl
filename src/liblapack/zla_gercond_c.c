...
double zla_gercond_c__(char *trans, int *n, doublecomplex *a, int 
	*lda, doublecomplex *af, int *ldaf, int *ipiv, double *
	c__, int *capply, int *info, doublecomplex *work, double *
	rwork, unsigned long trans_len)
{
