...
static int c__1 = 1;
 ...
 int chbgvx_(char *jobz, char *range, char *uplo, int *n, 
	...
	int *ldbb, complex *q, int *ldq, float *vl, float *vu, int *
	il, int *iu, float *abstol, int *m, float *w, complex *z__, 
	int *ldz, complex *work, float *rwork, int *iwork, int *
	ifail, int *info)
{
    /* System generated locals */
    int ab_dim1, ab_offset, bb_dim1, bb_offset, q_dim1, q_offset, z_dim1, 
	    z_offset, i__1, i__2;
...
, int *);
    ...
    int indibl;
    extern  int chbtrd_(char *, char *, int *, int *, 
	    complex *, int *, float *, float *, complex *, int *, 
	    complex *, int *);
    int valeig;
    extern  int chbgst_(char *, char *, int *, int *, 
	    int *, complex *, int *, complex *, int *, complex *, 
	    int *, complex *, float *, int *), clacpy_(
	    char *, int *, int *, complex *, int *, complex *, 
	    int *), xerbla_(char *, int *), cpbstf_(
    ...
    extern  int csteqr_(char *, int *, float *, float *, 
	    complex *, int *, float *, int *), ssterf_(int 
	    *, float *, float *, int *);
    int nsplit;
