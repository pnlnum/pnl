	...
	info)
{
    ...
    char trans[1];
    int upper, wantz;
    extern  int ztpmv_(char *, char *, char *, int *, 
	    doublecomplex *, doublecomplex *, int *), ztpsv_(char *, char *, char *, int *, doublecomplex *
, doublecomplex *, int *), xerbla_(
	    char *, int *);
    int liwmin;
    extern  int zhpevd_(char *, char *, int *, 
	    doublecomplex *, double *, doublecomplex *, int *, 
	    doublecomplex *, int *, double *, int *, int *, 
	    int *, int *);
    int lrwmin;
    extern  int zhpgst_(int *, char *, int *, 
	    doublecomplex *, doublecomplex *, int *);
    int lquery;
    extern  int zpptrf_(char *, int *, doublecomplex *, 
	    int *);
...
/* Computing MAX */
    d__1 = (double) lwmin, d__2 = work[1].r;
    lwmin = (int) MAX(d__1,d__2);
/* Computing MAX */
    d__1 = (double) lrwmin;
    lrwmin = (int) MAX(d__1,rwork[1]);
/* Computing MAX */
    d__1 = (double) liwmin, d__2 = (double) iwork[1];
    liwmin = (int) MAX(d__1,d__2);
