	...
	info)
{
    ...
    void z_div(doublecomplex *, doublecomplex *, doublecomplex *), pow_zi(
	    doublecomplex *, doublecomplex *, int *), z_sqrt(
    ...
    int ilazro;
    int icompz, ifirst;
    extern  int zlartg_(doublecomplex *, doublecomplex *, 
	    double *, doublecomplex *, doublecomplex *);
    int ifrstm;
