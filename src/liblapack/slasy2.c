	...
	*xnorm, int *info)
{
    ...
    /* Local variables */
    int i__, j, k;
    float x2[2], l21, u11, u12;
    int ip, jp;
    float u22, t16[16]	/* was [4][4] */, gam, bet, eps, sgn, tmp[4], tau1, 
	    btmp[4], smin;
    int ipiv;
    float temp;
    int jpiv[4];
...
/* Computing MAX */
/* Computing MAX */
    r__7 = (r__1 = tl[tl_dim1 + 1], ABS(r__1)), r__8 = (r__2 = tr[tr_dim1 + 
	    1], ABS(r__2)), r__7 = MAX(r__7,r__8), r__8 = (r__3 = tr[(
	    tr_dim1 << 1) + 1], ABS(r__3)), r__7 = MAX(r__7,r__8), r__8 = (
	    r__4 = tr[tr_dim1 + 2], ABS(r__4)), r__7 = MAX(r__7,r__8), r__8 =
	     (r__5 = tr[(tr_dim1 << 1) + 2], ABS(r__5));
...
/* Computing MAX */
/* Computing MAX */
    r__7 = (r__1 = tr[tr_dim1 + 1], ABS(r__1)), r__8 = (r__2 = tl[tl_dim1 + 
	    1], ABS(r__2)), r__7 = MAX(r__7,r__8), r__8 = (r__3 = tl[(
	    tl_dim1 << 1) + 1], ABS(r__3)), r__7 = MAX(r__7,r__8), r__8 = (
	    r__4 = tl[tl_dim1 + 2], ABS(r__4)), r__7 = MAX(r__7,r__8), r__8 =
	     (r__5 = tl[(tl_dim1 << 1) + 2], ABS(r__5));
    r__6 = eps * MAX(r__7,r__8);
    smin = MAX(r__6,smlnum);
    tmp[0] = tl[tl_dim1 + 1] + sgn * tr[tr_dim1 + 1];
...
/*     Set pivots less than SMIN to SMIN. */
    ...
    *scale = 1.f;
    if (smlnum * 2.f * ABS(btmp[1]) > ABS(u22) || smlnum * 2.f * ABS(btmp[
	    0]) > ABS(u11)) {
/* Computing MAX */
	...
	*xnorm = (r__1 = x[x_dim1 + 1], ABS(r__1)) + (r__2 = x[(x_dim1 << 1) 
	...
	x[x_dim1 + 2] = x2[1];
/* Computing MAX */
	r__3 = (r__1 = x[x_dim1 + 1], ABS(r__1)), r__4 = (r__2 = x[x_dim1 + 
		2], ABS(r__2));
	*xnorm = MAX(r__3,r__4);
    }
    return 0;
...
/* Computing MAX */
    r__5 = (r__1 = tr[tr_dim1 + 1], ABS(r__1)), r__6 = (r__2 = tr[(tr_dim1 <<
	     1) + 1], ABS(r__2)), r__5 = MAX(r__5,r__6), r__6 = (r__3 = tr[
	    tr_dim1 + 2], ABS(r__3)), r__5 = MAX(r__5,r__6), r__6 = (r__4 = 
	    tr[(tr_dim1 << 1) + 2], ABS(r__4));
    smin = MAX(r__5,r__6);
/* Computing MAX */
    r__5 = smin, r__6 = (r__1 = tl[tl_dim1 + 1], ABS(r__1)), r__5 = MAX(r__5,
	    r__6), r__6 = (r__2 = tl[(tl_dim1 << 1) + 1], ABS(r__2)), r__5 = 
	    MAX(r__5,r__6), r__6 = (r__3 = tl[tl_dim1 + 2], ABS(r__3)), r__5 
	    = MAX(r__5,r__6), r__6 = (r__4 = tl[(tl_dim1 << 1) + 2], ABS(
	    r__4));
    smin = MAX(r__5,r__6);
/* Computing MAX */
    r__1 = eps * smin;
...
/* L100: */
    ...
    *scale = 1.f;
    if (smlnum * 8.f * ABS(btmp[0]) > ABS(t16[0]) || smlnum * 8.f * ABS(
	    btmp[1]) > ABS(t16[5]) || smlnum * 8.f * ABS(btmp[2]) > ABS(
	    t16[10]) || smlnum * 8.f * ABS(btmp[3]) > ABS(t16[15])) {
/* Computing MAX */
	r__1 = ABS(btmp[0]), r__2 = ABS(btmp[1]), r__1 = MAX(r__1,r__2), 
		r__2 = ABS(btmp[2]), r__1 = MAX(r__1,r__2), r__2 = ABS(btmp[
		3]);
