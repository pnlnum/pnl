	...
	rwork, int *iwork, int *info)
{
    ...
    int jfloat, inode, ndiml, ndimr;
    extern  int zcopy_(int *, doublecomplex *, int *, 
	    doublecomplex *, int *), zlals0_(int *, int *, 
	    int *, int *, int *, doublecomplex *, int *, 
	    doublecomplex *, int *, int *, int *, int *, 
	    int *, double *, int *, double *, double *, 
	    double *, double *, int *, double *, double *, 
	     double *, int *), dlasdt_(int *, int *, int *
, int *, int *, int *, int *), xerbla_(char *, 
	    int *);
...
/*        performed in two steps (float and imaginary parts). */
