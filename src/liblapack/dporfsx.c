...
static int c__1 = 1;
 ...
 int dporfsx_(char *uplo, char *equed, int *n, int *
	...
	int *info)
{
    ...
    double rcond_tmp__;
    int prec_type__;
    extern double dla_porcond__(char *, int *, double *, int *
	    , double *, int *, int *, double *, int *, 
	    double *, int *, unsigned long);
    double cwise_wrong__;
    extern  int dla_porfsx_extended__(int *, char *, 
    ...
    extern  int xerbla_(char *, int *), dpocon_(
