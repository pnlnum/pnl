...
static float c_b31 = 1.f;
 ...
 int cla_gerfsx_extended__(int *prec_type__, int *
	trans_type__, int *n, int *nrhs, complex *a, int *lda, 
	complex *af, int *ldaf, int *ipiv, int *colequ, float *c__,
	 complex *b, int *ldb, complex *y, int *ldy, float *berr_out__,
	 int *n_norms__, float *errs_n__, float *errs_c__, complex *res, 
	...
	int *info)
{
    ...
    int i__, j;
    extern  int cla_geamv__(int *, int *, int *, 
	    float *, complex *, int *, complex *, int *, float *, float *
	    , int *);
    int incr_prec__;
    ...
    extern  int cla_lin_berr__(int *, int *, int *
	    , complex *, float *, float *);
    float ymin;
    extern  int blas_cgemv_x__(int *, int *, int *
	    , complex *, complex *, int *, complex *, int *, complex *
	    , complex *, int *, int *);
    int y_prec_state__;
    extern  int blas_cgemv2_x__(int *, int *, int 
	    *, complex *, complex *, int *, complex *, complex *, int 
	    *, complex *, complex *, int *, int *), cgemv_(char *, 
	    int *, int *, complex *, complex *, int *, complex *, 
	    int *, complex *, complex *, int *), ccopy_(
    ...
    extern  int cgetrs_(char *, int *, int *, complex 
