...
#include "pnl/pnl_f2c.h"
 ...
 int clargv_(int *n, complex *x, int *incx, complex *
...
/*  CLARGV generates a vector of complex plane rotations with float */
...
/* Computing MAX */
	r__9 = (r__3 = g.r, ABS(r__3)), r__10 = (r__4 = r_imag(&g), ABS(
		r__4));
