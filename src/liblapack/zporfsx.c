...
static int c_false = FALSE;
 ...
 int zporfsx_(char *uplo, char *equed, int *n, int *
	nrhs, doublecomplex *a, int *lda, doublecomplex *af, int *
	ldaf, double *s, doublecomplex *b, int *ldb, doublecomplex *x, 
	...
	work, double *rwork, int *info)
{
    ...
    extern  int zla_porfsx_extended__(int *, char *, 
	    ...
	    doublecomplex *, double *, int *, double *, 
	    double *, int *, int *, unsigned long);
    char norm[1];
    int ignore_cwise__;
    extern int lsame_(char *, char *);
    double anorm;
    int rcequ;
    extern double zla_porcond_c__(char *, int *, doublecomplex *, 
	    int *, doublecomplex *, int *, double *, int *, 
	    int *, doublecomplex *, double *, unsigned long), 
	    zla_porcond_x__(char *, int *, doublecomplex *, int *, 
	    doublecomplex *, int *, doublecomplex *, int *, 
	    doublecomplex *, double *, unsigned long), dlamch_(char *);
    extern  int xerbla_(char *, int *);
    extern double zlanhe_(char *, char *, int *, doublecomplex *, 
	    int *, double *);
    extern  int zpocon_(char *, int *, doublecomplex *, 
