...
static int c__1 = 1;
static float c_b49 = 1.f;
static float c_b72 = -1.f;

 int cbdsqr_(char *uplo, int *n, int *ncvt, int *
	nru, int *ncc, float *d__, float *e, complex *vt, int *ldvt, 
	complex *u, int *ldu, complex *c__, int *ldc, float *rwork, 
	int *info)
{
    ...
    float oldcs;
    extern  int clasr_(char *, char *, char *, int *, 
    ...
    extern  int csrot_(int *, complex *, int *, 
	    complex *, int *, float *, float *), slasq1_(int *, float *, 
	    float *, float *, int *), slasv2_(float *, float *, float *, float *
