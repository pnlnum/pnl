...
#include "pnl/pnl_f2c.h"
 ...
 int cposvxx_(char *fact, char *uplo, int *n, int *
	nrhs, complex *a, int *lda, complex *af, int *ldaf, char *
	equed, float *s, complex *b, int *ldb, complex *x, int *ldx, 
	float *rcond, float *rpvgrw, float *berr, int *n_err_bnds__, float *
	...
	params, complex *work, float *rwork, int *info)
{
    ...
    extern double cla_porpvgrw__(char *, int *, complex *, int *, 
	    complex *, int *, float *, unsigned long);
    ...
    float bignum;
    int infequ;
    extern  int cpotrf_(char *, int *, complex *, int 
	    *, int *), cpotrs_(char *, int *, int *, 
	    complex *, int *, complex *, int *, int *);
    float smlnum;
    extern  int clascl2_(int *, int *, float *, 
	    complex *, int *), cpoequb_(int *, complex *, int *, 
	    float *, float *, float *, int *), cporfsx_(char *, char *, 
	    int *, int *, complex *, int *, complex *, int *, 
	    float *, complex *, int *, complex *, int *, float *, float *
, int *, float *, float *, int *, float *, complex *, float *, 
	     int *);
...
/*           leading rank-deficient INFO columns of A. */
	    ...
	    *rpvgrw = cla_porpvgrw__(uplo, n, &a[a_offset], lda, &af[
		    af_offset], ldaf, &rwork[1], (unsigned long)1);
	    return 0;
	}
    }
