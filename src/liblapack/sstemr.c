...
static float c_b18 = .003f;
 ...
 int sstemr_(char *jobz, char *range, int *n, float *d__, 
	float *e, float *vl, float *vu, int *il, int *iu, int *m, 
	float *w, float *z__, int *ldz, int *nzc, int *isuppz, 
...
), slarre_(char *, int *, float *, float *, int *, 
...
, int *, float *, float *, float *, int *, int *)
    ...
    extern  int slarrj_(int *, float *, float *, int *, 
	    ...
	    float *, float *, int *), slarrr_(int *, float *, float *, 
	    int *);
    int nsplit;
    extern  int slarrv_(int *, float *, float *, float *, 
