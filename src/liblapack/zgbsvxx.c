...
#include "pnl/pnl_f2c.h"
 ...
 int zgbsvxx_(char *fact, char *trans, int *n, int *
	...
	doublecomplex *work, double *rwork, int *info)
{
    ...
    int i__, j;
    double amax;
    extern double zla_gbrpvgrw__(int *, int *, int *, int 
    ...
    double colcnd;
    int nofact;
    extern  int xerbla_(char *, int *), zlaqgb_(
    ...
    int colequ;
    double rowcnd;
    extern  int zgbtrf_(int *, int *, int *, 
    ...
    int rowequ;
    extern  int zlascl2_(int *, int *, double *, 
	    doublecomplex *, int *), zgbequb_(int *, int *, 
	    int *, int *, doublecomplex *, int *, double *, 
	    double *, double *, double *, double *, int *)
	    , zgbrfsx_(char *, char *, int *, int *, int *, 
	    int *, doublecomplex *, int *, doublecomplex *, int *, 
	     int *, double *, double *, doublecomplex *, int *
, doublecomplex *, int *, double *, double *, int 
	    *, double *, double *, int *, double *, 
	    doublecomplex *, double *, int *);
