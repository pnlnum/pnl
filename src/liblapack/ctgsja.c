...
static float c_b42 = 1.f;
 ...
 int ctgsja_(char *jobu, char *jobv, char *jobq, int *m, 
	...
	lda, complex *b, int *ldb, float *tola, float *tolb, float *alpha, 
	...
	info)
{
    ...
    float error, ssmin;
    int wantu, wantv;
    extern  int clags2_(int *, float *, complex *, float *, 
	    float *, complex *, float *, float *, complex *, float *, complex *, 
	    float *, complex *), clapll_(int *, complex *, int *, 
	    complex *, int *, float *), csscal_(int *, float *, complex 
	    *, int *);
    int kcycle;
...
/*              Ensure that the diagonal elements of A and B are float. */
