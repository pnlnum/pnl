	...
	int *lwork, double *rwork, int *info)
{
    ...
    extern  int zcopy_(int *, doublecomplex *, int *, 
	    doublecomplex *, int *), ztrsm_(char *, char *, char *, char *
, int *, int *, doublecomplex *, doublecomplex *, int 
	    *, doublecomplex *, int *), 
	    ...
	    doublecomplex *), dlabad_(double *, double *), zgeqp3_(
    ...
    extern  int zunmqr_(char *, char *, int *, int *, 
	    ...
	    doublecomplex *, int *, doublecomplex *, int *, int *), zunmrz_(char *, char *, int *, int *, 
	    int *, int *, doublecomplex *, int *, doublecomplex *, 
	     doublecomplex *, int *, doublecomplex *, int *, int *
), ztzrzf_(int *, int *, doublecomplex *, 
