...
static int c__1 = 1;
 ...
 int dsyrfsx_(char *uplo, char *equed, int *n, int *
	...
	work, int *iwork, int *info)
{
    ...
    double rcond_tmp__;
    int prec_type__;
    extern double dla_syrcond__(char *, int *, double *, int *
	    , double *, int *, int *, int *, double *, 
	    int *, double *, int *, unsigned long);
    double cwise_wrong__;
    extern  int dla_syrfsx_extended__(int *, char *, 
    ...
    extern double dlansy_(char *, char *, int *, double *, 
	    int *, double *);
    extern  int dsycon_(char *, int *, double *, 
