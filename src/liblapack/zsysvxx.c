...
#include "pnl/pnl_f2c.h"
 ...
 int zsysvxx_(char *fact, char *uplo, int *n, int *
	...
	int *info)
{
    ...
    /* Local variables */
    extern  int zsyrfsx_(char *, char *, int *, int *, 
	     doublecomplex *, int *, doublecomplex *, int *, int *
, double *, doublecomplex *, int *, doublecomplex *, 
	    int *, double *, double *, int *, double *, 
	    double *, int *, double *, doublecomplex *, 
	    double *, int *);
    int j;
    double amax, smin, smax;
    extern int lsame_(char *, char *);
    double scond;
    extern double zla_syrpvgrw__(char *, int *, int *, 
	    doublecomplex *, int *, doublecomplex *, int *, int *,
    ...
    double smlnum;
    extern  int zlaqsy_(char *, int *, doublecomplex *, 
	    int *, double *, double *, double *, char *), zsytrf_(char *, int *, doublecomplex *, 
	    int *, int *, doublecomplex *, int *, int *), zlascl2_(int *, int *, double *, 
	    doublecomplex *, int *), zsytrs_(char *, int *, int *, 
	     doublecomplex *, int *, int *, doublecomplex *, int *
, int *), zsyequb_(char *, int *, doublecomplex *, 
