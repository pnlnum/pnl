...
static int c_n1 = -1;
 ...
 int cggev_(char *jobvl, char *jobvr, int *n, complex *a, 
	...
	work, int *lwork, float *rwork, int *info)
{
    ...
    extern  int clacpy_(char *, int *, int *, complex 
	    *, int *, complex *, int *), claset_(char *, 
	    int *, int *, complex *, complex *, complex *, int *), ctgevc_(char *, char *, int *, int *, complex *, 
	    int *, complex *, int *, complex *, int *, complex *, 
	    int *, int *, int *, complex *, float *, int *), xerbla_(char *, int *);
    int ldumma[1];
    char chtemp[1];
    float bignum;
