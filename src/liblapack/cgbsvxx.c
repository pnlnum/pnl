...
#include "pnl/pnl_f2c.h"
 ...
 int cgbsvxx_(char *fact, char *trans, int *n, int *
	kl, int *ku, int *nrhs, complex *ab, int *ldab, complex *
	afb, int *ldafb, int *ipiv, char *equed, float *r__, float *c__, 
	 complex *b, int *ldb, complex *x, int *ldx, float *rcond, 
	float *rpvgrw, float *berr, int *n_err_bnds__, float *
	...
	params, complex *work, float *rwork, int *info)
{
    ...
    int i__, j;
    float amax;
    extern double cla_gbrpvgrw__(int *, int *, int *, int 
	    *, complex *, int *, complex *, int *);
    extern int lsame_(char *, char *);
    float rcmin, rcmax;
    int equil;
    extern  int claqgb_(int *, int *, int *, 
	    int *, complex *, int *, float *, float *, float *, float *, 
	    float *, char *);
    float colcnd;
    extern double slamch_(char *);
    extern  int cgbtrf_(int *, int *, int *, 
    ...
    extern  int clascl2_(int *, int *, float *, 
	    complex *, int *), cgbequb_(int *, int *, int *, 
	    int *, complex *, int *, float *, float *, float *, float *, 
	    float *, int *), cgbrfsx_(char *, char *, int *, int *, 
