...
static double c_b31 = 1.;
 ...
 int zla_gerfsx_extended__(int *prec_type__, int *
	trans_type__, int *n, int *nrhs, doublecomplex *a, int *
	lda, doublecomplex *af, int *ldaf, int *ipiv, int *colequ,
	 double *c__, doublecomplex *b, int *ldb, doublecomplex *y, 
	int *ldy, double *berr_out__, int *n_norms__, double *
	errs_n__, double *errs_c__, doublecomplex *res, double *ayb, 
	doublecomplex *dy, doublecomplex *y_tail__, double *rcond, 
	...
	ignore_cwise__, int *info)
{
    ...
    int i__, j;
    int incr_prec__;
    extern  int zla_geamv__(int *, int *, int *, 
    ...
    extern  int zla_lin_berr__(int *, int *, int *
	    , doublecomplex *, double *, double *), blas_zgemv_x__(
	    int *, int *, int *, doublecomplex *, doublecomplex *,
	     int *, doublecomplex *, int *, doublecomplex *, 
	    doublecomplex *, int *, int *);
    int y_prec_state__;
    extern  int blas_zgemv2_x__(int *, int *, int 
    ...
    double normdx;
    extern  int zgetrs_(char *, int *, int *, 
