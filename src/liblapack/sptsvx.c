	...
	*ldx, float *rcond, float *ferr, float *berr, float *work, int *info)
{
    ...
    extern  int sptcon_(int *, float *, float *, float *, 
	    float *, float *, int *), sptrfs_(int *, int *, float *, 
	    float *, float *, float *, float *, int *, float *, int *, 
	    float *, float *, float *, int *), spttrf_(int *, float *, 
	    float *, int *), spttrs_(int *, int *, float *, float *, 
	    float *, int *, int *);
...
/*  to a float system of linear equations A*X = B, where A is an N-by-N */
