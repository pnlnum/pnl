...
static int c__1 = 1;
 ...
 int clabrd_(int *m, int *n, int *nb, complex *a, 
	int *lda, float *d__, float *e, complex *tauq, complex *taup, 
	complex *x, int *ldx, complex *y, int *ldy)
{
    ...
    extern  int cscal_(int *, complex *, complex *, 
	    int *), cgemv_(char *, int *, int *, complex *, 
	    complex *, int *, complex *, int *, complex *, complex *, 
	    int *), clarfg_(int *, complex *, complex *, 
	    int *, complex *), clacgv_(int *, complex *, int *);
