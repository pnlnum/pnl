...
static int c__1 = 1;
 ...
 int ctgsy2_(char *trans, int *ijob, int *m, int *
	...
	complex *f, int *ldf, float *scale, float *rdsum, float *rdscal, 
	int *info)
{
    ...
    extern  int caxpy_(int *, complex *, complex *, 
	    int *, complex *, int *), cgesc2_(int *, complex *, 
	    int *, complex *, int *, int *, float *), cgetc2_(
	    int *, complex *, int *, int *, int *, int *),
	     clatdf_(int *, int *, complex *, int *, complex *, 
	    float *, float *, int *, int *);
    float scaloc;
