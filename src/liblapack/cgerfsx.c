...
static int c_false = FALSE;
 ...
 int cgerfsx_(char *trans, char *equed, int *n, int *
	nrhs, complex *a, int *lda, complex *af, int *ldaf, int *
	ipiv, float *r__, float *c__, complex *b, int *ldb, complex *x, 
	int *ldx, float *rcond, float *berr, int *n_err_bnds__, float *
	err_bnds_norm__, float *err_bnds_comp__, int *nparams, float *
	params, complex *work, float *rwork, int *info)
{
    ...
    float cwise_wrong__;
    extern  int cla_gerfsx_extended__(int *, int *, 
	    int *, int *, complex *, int *, complex *, int *, 
	    int *, int *, float *, complex *, int *, complex *, 
	    int *, float *, int *, float *, float *, complex *, float *, 
	    complex *, complex *, float *, int *, float *, float *, int *
	    , int *);
    char norm[1];
    int ignore_cwise__;
    extern double cla_gercond_c__(char *, int *, complex *, int *,
	     complex *, int *, int *, float *, int *, int *, 
	    complex *, float *, unsigned long);
    extern int lsame_(char *, char *);
    float anorm;
    extern double cla_gercond_x__(char *, int *, complex *, int *,
	     complex *, int *, int *, complex *, int *, complex *,
	     float *, unsigned long), clange_(char *, int *, int *, complex *, 
	     int *, float *);
    extern  int cgecon_(char *, int *, complex *, int 
...
/*     Compute scaled normwise condition number cond(A*C). */
	...
	if (colequ && notran) {
	    ...
	    rcond_tmp__ = cla_gercond_c__(trans, n, &a[a_offset], lda, &af[
		    ...
		    work[1], &rwork[1], (unsigned long)1);
	}
	i__1 = *nrhs;
	for (j = 1; j <= i__1; ++j) {
