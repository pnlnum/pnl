...
static float c_b8 = 1.f;
 ...
 int sla_gerfsx_extended__(int *prec_type__, int *
	trans_type__, int *n, int *nrhs, float *a, int *lda, float *
	af, int *ldaf, int *ipiv, int *colequ, float *c__, float *b,
	 int *ldb, float *y, int *ldy, float *berr_out__, int *
	n_norms__, float *err_bnds_norm__, float *err_bnds_comp__, float *res, 
	float *ayb, float *dy, float *y_tail__, float *rcond, int *ithresh, 
	float *rthresh, float *dz_ub__, int *ignore_cwise__, int *info)
{
    ...
    int i__, j;
    extern  int sla_geamv__(int *, int *, int *, 
    ...
    extern  int sla_lin_berr__(int *, int *, int *
	    , float *, float *, float *), blas_sgemv_x__(int *, int *, 
	    int *, float *, float *, int *, float *, int *, float *, 
	    float *, int *, int *);
    int y_prec_state__;
    extern  int blas_sgemv2_x__(int *, int *, int 
	    *, float *, float *, int *, float *, float *, int *, float *, 
	    float *, int *, int *), sgemv_(char *, int *, int *
, float *, float *, int *, float *, int *, float *, float *, 
	    int *);
    float dxrat, dzrat;
    char trans[1];
