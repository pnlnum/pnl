	 ...
	 float *ferr, float *berr, float *work, int *iwork, int *info)
{
    ...
    int b_dim1, b_offset, x_dim1, x_offset, i__1, i__2, i__3;
    ...
    extern  int scopy_(int *, float *, int *, float *, 
	    ...
	    int *), stpmv_(char *, char *, char *, int *, float *, 
	    float *, int *), stpsv_(char *, char *, 
	     char *, int *, float *, float *, int *), slacn2_(int *, float *, float *, int *, float *, 
	    int *, int *);
