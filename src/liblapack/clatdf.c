...
static float c_b24 = 1.f;
 ...
 int clatdf_(int *ijob, int *n, complex *z__, int 
	*ldz, complex *rhs, float *rdsum, float *rdscal, int *ipiv, int 
	*jpiv)
{
    ...
    extern  int caxpy_(int *, complex *, complex *, 
	    int *, complex *, int *);
    float rtemp, sminu, rwork[2], splus;
    extern  int cgesc2_(int *, complex *, int *, 
	    complex *, int *, int *, float *), cgecon_(char *, int 
	    *, complex *, int *, float *, float *, complex *, float *, 
	    int *), classq_(int *, complex *, int *, float 
	    *, float *), claswp_(int *, complex *, int *, int *, 
	    int *, int *, int *);
