	 ...
	 double *berr, double *work, int *iwork, int *info)
{
    ...
    extern double dlamch_(char *), dlansb_(char *, char *, 
	    int *, int *, double *, int *, double *);
    extern  int dpbcon_(char *, int *, int *, 
    ...
    extern  int dlacpy_(char *, int *, int *, 
	    ...
	    double *, int *);
    double bignum;
    extern  int dpbrfs_(char *, int *, int *, int 
	    *, double *, int *, double *, int *, double *, 
	     int *, double *, int *, double *, double *, 
	    double *, int *, int *), dpbtrf_(char *, 
	    int *, int *, double *, int *, int *);
    int infequ;
    extern  int dpbtrs_(char *, int *, int *, int 
