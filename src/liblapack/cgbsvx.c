...
static int c__1 = 1;
 ...
 int cgbsvx_(char *fact, char *trans, int *n, int *kl, 
	...
	*ferr, float *berr, complex *work, float *rwork, int *info)
{
    ...
    extern  int ccopy_(int *, complex *, int *, 
	    complex *, int *);
    int equil;
    extern double clangb_(char *, int *, int *, int *, 
	    complex *, int *, float *);
    extern  int claqgb_(int *, int *, int *, 
	    int *, complex *, int *, float *, float *, float *, float *, 
	    float *, char *), cgbcon_(char *, int *, int *, 
	    int *, complex *, int *, int *, float *, float *, 
	    complex *, float *, int *);
    float colcnd;
    extern double clantb_(char *, char *, char *, int *, int *, 
	    complex *, int *, float *);
    extern  int cgbequ_(int *, int *, int *, 
	    int *, complex *, int *, float *, float *, float *, float *, 
	    float *, int *);
    extern double slamch_(char *);
    extern  int cgbrfs_(char *, int *, int *, int 
	    *, int *, complex *, int *, complex *, int *, int 
	    *, complex *, int *, complex *, int *, float *, float *, 
	    complex *, float *, int *), cgbtrf_(int *, int 
