	...
	int *lwork, double *rwork, int *info)
{
    ...
    extern  int zgemm_(char *, char *, int *, int *, 
	    ...
	    int *);
    int wrkbl, itaup, itauq, mnthr, iwork;
