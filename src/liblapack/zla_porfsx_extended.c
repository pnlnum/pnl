...
static double c_b33 = 1.;
 ...
 int zla_porfsx_extended__(int *prec_type__, char *uplo, 
	int *n, int *nrhs, doublecomplex *a, int *lda, 
	doublecomplex *af, int *ldaf, int *colequ, double *c__, 
	doublecomplex *b, int *ldb, doublecomplex *y, int *ldy, 
	double *berr_out__, int *n_norms__, double *
	...
	dz_ub__, int *ignore_cwise__, int *info, unsigned long uplo_len)
{
    ...
    int i__, j;
    int incr_prec__;
    extern  int zla_heamv__(int *, int *, double *
	    , doublecomplex *, int *, doublecomplex *, int *, 
	    double *, double *, int *);
    double prev_dz_z__, yk, final_dx_x__, final_dz_z__;
    ...
    int y_prec_state__;
    extern  int blas_zhemv_x__(int *, int *, 
	    doublecomplex *, doublecomplex *, int *, doublecomplex *, 
	    int *, doublecomplex *, doublecomplex *, int *, int *)
	    ;
    int uplo2;
    extern int lsame_(char *, char *);
    extern  int blas_zhemv2_x__(int *, int *, 
	    doublecomplex *, doublecomplex *, int *, doublecomplex *, 
    ...
    double normdx;
    extern  int zpotrs_(char *, int *, int *, 
