...
static double c_b11 = 1.;
 ...
 int dla_syrfsx_extended__(int *prec_type__, char *uplo, 
	int *n, int *nrhs, double *a, int *lda, double *
	af, int *ldaf, int *ipiv, int *colequ, double *c__, 
	double *b, int *ldb, double *y, int *ldy, double *
	berr_out__, int *n_norms__, double *err_bnds_norm__, 
	double *err_bnds_comp__, double *res, double *ayb, 
	double *dy, double *y_tail__, double *rcond, int *
	ithresh, double *rthresh, double *dz_ub__, int *
	ignore_cwise__, int *info, unsigned long uplo_len)
{
    ...
    int i__, j;
    int incr_prec__;
    extern  int dla_syamv__(int *, int *, double *
    ...
    double ymin;
    int y_prec_state__;
    extern  int blas_dsymv_x__(int *, int *, 
	    double *, double *, int *, double *, int *, 
	    double *, double *, int *, int *);
    int uplo2;
    extern int lsame_(char *, char *);
    extern  int blas_dsymv2_x__(int *, int *, 
    ...
    extern  int daxpy_(int *, double *, double *, 
	    int *, double *, int *), dsymv_(char *, int *, 
	    double *, double *, int *, double *, int *, 
	    double *, double *, int *);
    double normx, normy;
