...
#include "pnl/pnl_f2c.h"
 ...
 int clartv_(int *n, complex *x, int *incx, complex *
	y, int *incy, float *c__, complex *s, int *incc)
{
...
/*  CLARTV applies a vector of complex plane rotations with float cosines */
