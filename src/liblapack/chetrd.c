...
static float c_b23 = 1.f;
 ...
 int chetrd_(char *uplo, int *n, complex *a, int *lda, 
	 float *d__, float *e, complex *tau, complex *work, int *lwork, 
	int *info)
{
    ...
    int nbmin, iinfo;
    int upper;
    extern  int chetd2_(char *, int *, complex *, int 
	    *, float *, float *, complex *, int *), cher2k_(char *, 
	    char *, int *, int *, complex *, complex *, int *, 
	    complex *, int *, float *, complex *, int *), clatrd_(char *, int *, int *, complex *, int 
	    *, float *, complex *, complex *, int *), xerbla_(char 
	    *, int *);
...
/*  CHETRD reduces a complex Hermitian matrix A to float symmetric */
