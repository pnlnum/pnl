...
static int c__3 = 3;
 ...
 int claqr0_(int *wantt, int *wantz, int *n, 
...
/* Computing MAX */
	i__1 = nsr * 3 / 2, i__2 = (int) work[1].r;
...
/* Computing MIN */
		...
		if (nw >= nh - 1) {
		    ...
		    if ((r__1 = h__[i__2].r, ABS(r__1)) + (r__2 = r_imag(&
			    h__[kwtop + (kwtop - 1) * h_dim1]), ABS(r__2)) > 
			    (r__3 = h__[i__3].r, ABS(r__3)) + (r__4 = r_imag(
			    &h__[kwtop - 1 + (kwtop - 2) * h_dim1]), ABS(
			    r__4))) {
			++nw;
		    }
		}
...
/*                    .    because H(KBOT,KBOT-1) is nonzero.) ==== */
			...
			if (ks >= kbot) {
			    ...
			    s = (r__1 = h__[i__2].r, ABS(r__1)) + (r__2 = 
				    ...
				    .r, ABS(r__3)) + (r__4 = r_imag(&h__[
				    kbot + (kbot - 1) * h_dim1]), ABS(r__4)))
				     + ((r__5 = h__[i__4].r, ABS(r__5)) + (
				    r__6 = r_imag(&h__[kbot - 1 + kbot * 
				    h_dim1]), ABS(r__6))) + ((r__7 = h__[
				    i__5].r, ABS(r__7)) + (r__8 = r_imag(&
				    h__[kbot + kbot * h_dim1]), ABS(r__8)));
			    i__2 = kbot - 1 + (kbot - 1) * h_dim1;
