	...
	double *work, int *info)
{
    ...
    extern  int dgeqr2_(int *, int *, double *, 
	    int *, double *, double *, int *), dgerq2_(
	    int *, int *, double *, int *, double *, 
	    double *, int *), dorg2r_(int *, int *, int *, 
	     double *, int *, double *, double *, int *), 
	    dorm2r_(char *, char *, int *, int *, int *, 
	    double *, int *, double *, double *, int *, 
	    double *, int *), dormr2_(char *, char *, 
	    int *, int *, int *, double *, int *, 
	    double *, double *, int *, double *, int *), dgeqpf_(int *, int *, double *, 
	    int *, int *, double *, double *, int *), 
	    dlacpy_(char *, int *, int *, double *, int *, 
	    double *, int *), dlaset_(char *, int *, 
	    int *, double *, double *, double *, int *), xerbla_(char *, int *), dlapmt_(int *, 
