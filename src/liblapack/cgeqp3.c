...
static int c__2 = 2;
 ...
 int cgeqp3_(int *m, int *n, complex *a, int *lda, 
	 int *jpvt, complex *tau, complex *work, int *lwork, float *
	rwork, int *info)
{
    ...
    /* Local variables */
    int j, jb, na, nb, sm, sn, nx, fjb, iws, nfxd, nbmin;
    extern  int cswap_(int *, complex *, int *, 
	    complex *, int *);
    int minmn, minws;
    extern  int claqp2_(int *, int *, int *, 
	    complex *, int *, int *, complex *, float *, float *, 
	    complex *);
    extern double scnrm2_(int *, complex *, int *);
    extern  int cgeqrf_(int *, int *, complex *, 
	    int *, complex *, complex *, int *, int *), xerbla_(
	    char *, int *);
    extern int ilaenv_(int *, char *, char *, int *, int *, 
	    int *, int *);
    extern  int claqps_(int *, int *, int *, 
	    int *, int *, complex *, int *, int *, complex *, 
	    float *, float *, complex *, complex *, int *);
    int topbmn, sminmn;
...
/*  where tau is a float/complex scalar, and v is a float/complex vector */
