...
static int c__1 = 1;
 ...
 int chbevx_(char *jobz, char *range, char *uplo, int *n, 
	...
	m, float *w, complex *z__, int *ldz, complex *work, float *rwork, 
	int *iwork, int *ifail, int *info)
{
    /* System generated locals */
    int ab_dim1, ab_offset, q_dim1, q_offset, z_dim1, z_offset, i__1, 
	    i__2;
    float r__1, r__2;
...
, int *);
    ...
    extern  int clascl_(char *, int *, int *, float *, 
	    float *, int *, int *, complex *, int *, int *), chbtrd_(char *, char *, int *, int *, complex *, 
