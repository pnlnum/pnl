...
static float c_b42 = 1.f;
 ...
 int sgsvj0_(char *jobv, int *m, int *n, float *a, 
	int *lda, float *d__, float *sva, int *mv, float *v, int *
	ldv, float *eps, float *sfmin, float *tol, int *nsweep, float *work, 
	int *lwork, int *info)
{
