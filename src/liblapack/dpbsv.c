	...
	int *info)
{
    ...
    extern  int xerbla_(char *, int *), dpbtrf_(
	    char *, int *, int *, double *, int *, int *), dpbtrs_(char *, int *, int *, int *, 
...
/*  DPBSV computes the solution to a float system of linear equations */
/*     A * X = B, */
