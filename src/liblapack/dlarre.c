...
static int c__2 = 2;
 ...
 int dlarre_(char *range, int *n, double *vl, 
	...
	iwork, int *info)
{
    ...
    extern  int dcopy_(int *, double *, int *, 
	    double *, int *);
    int norep;
    extern  int dlasq2_(int *, double *, int *);
    extern double dlamch_(char *);
    int ibegin;
    int forceb;
    int irange;
    double sgndef;
    extern  int dlarra_(int *, double *, double *, 
	     double *, double *, double *, int *, int *, 
	    int *), dlarrb_(int *, double *, double *, 
	    int *, int *, double *, double *, int *, 
	    double *, double *, double *, double *, int *, 
	     double *, double *, int *, int *), dlarrc_(char *
, int *, double *, double *, double *, double 
	    *, double *, int *, int *, int *, int *);
    int wbegin;
    extern  int dlarrd_(char *, char *, int *, double 
...
, int *, int *, double *, double *, double *, 
    ...
    extern  int dlarrk_(int *, int *, double *, 
	    double *, double *, double *, double *, 
	    double *, double *, double *, int *);
    int usedqd;
    double clwdth, isleft;
    extern  int dlarnv_(int *, int *, int *, 
	    double *);
