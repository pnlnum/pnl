	...
	work, double *rwork, int *info)
{
    ...
    int nofact;
    extern  int xerbla_(char *, int *), zlacpy_(
	    char *, int *, int *, doublecomplex *, int *, 
	    doublecomplex *, int *);
    extern double zlansp_(char *, char *, int *, doublecomplex *, 
	    double *);
    extern  int zspcon_(char *, int *, doublecomplex *, 
	    int *, double *, double *, doublecomplex *, int *), zsprfs_(char *, int *, int *, doublecomplex *, 
	    doublecomplex *, int *, doublecomplex *, int *, 
	    doublecomplex *, int *, double *, double *, 
	    doublecomplex *, double *, int *), zsptrf_(char *, 
	     int *, doublecomplex *, int *, int *), 
	    zsptrs_(char *, int *, int *, doublecomplex *, int *, 
