...
static int c__1 = 1;
 ...
 int clahr2_(int *n, int *k, int *nb, complex *a, 
...
, complex *, int *), cgemv_(char *, int *, 
	     int *, complex *, complex *, int *, complex *, int *, 
	     complex *, complex *, int *), ccopy_(int *, 
	    complex *, int *, complex *, int *), ctrmm_(char *, char *
, char *, char *, int *, int *, complex *, complex *, 
	    int *, complex *, int *), 
	    caxpy_(int *, complex *, complex *, int *, complex *, 
	    int *), ctrmv_(char *, char *, char *, int *, complex *, 
	    int *, complex *, int *), clarfg_(
	    int *, complex *, complex *, int *, complex *), clacgv_(
	    int *, complex *, int *), clacpy_(char *, int *, 
