...
static int c_false = FALSE;
 ...
 int cporfsx_(char *uplo, char *equed, int *n, int *
	nrhs, complex *a, int *lda, complex *af, int *ldaf, float *s, 
	complex *b, int *ldb, complex *x, int *ldx, float *rcond, float 
	*berr, int *n_err_bnds__, float *err_bnds_norm__, float *
	err_bnds_comp__, int *nparams, float *params, complex *work, float *
	rwork, int *info)
{
    ...
    int prec_type__;
    float cwise_wrong__;
    extern  int cla_porfsx_extended__(int *, char *, 
	    int *, int *, complex *, int *, complex *, int *, 
	    int *, float *, complex *, int *, complex *, int *, 
	    float *, int *, float *, float *, complex *, float *, complex *, 
	    complex *, float *, int *, float *, float *, int *, int *
	    , unsigned long);
    char norm[1];
    int ignore_cwise__;
    ...
    float anorm;
    int rcequ;
    extern double cla_porcond_c__(char *, int *, complex *, int *,
	     complex *, int *, float *, int *, int *, complex *, 
	    float *, unsigned long), cla_porcond_x__(char *, int *, complex *, 
	    int *, complex *, int *, complex *, int *, complex *, 
	    float *, unsigned long), clanhe_(char *, char *, int *, complex *, 
	    int *, float *), slamch_(char *);
    extern  int xerbla_(char *, int *), cpocon_(
	    char *, int *, complex *, int *, float *, float *, complex *
, float *, int *);
...
/*     Perform refinement on each right-hand side */
	...
	cla_porfsx_extended__(&prec_type__, uplo, n, nrhs, &a[a_offset], lda, 
		...
		rthresh, &unstable_thresh__, &ignore_cwise__, info, (unsigned long)1)
		;
    }
/* Computing MAX */
