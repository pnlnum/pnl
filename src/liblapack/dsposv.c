...
static int c__1 = 1;
 ...
 int dsposv_(char *uplo, int *n, int *nrhs, 
	...
	int *info)
{
    ...
    extern  int daxpy_(int *, double *, double *, 
	    int *, double *, int *), dsymm_(char *, char *, 
	    int *, int *, double *, double *, int *, 
	    double *, int *, double *, double *, int *), dlag2s_(int *, int *, double *, 
	    int *, float *, int *, int *), slag2d_(int *, 
	    int *, float *, int *, double *, int *, int *),
	     dlat2s_(char *, int *, double *, int *, float *, 
	    int *, int *);
    ...
    extern double dlansy_(char *, char *, int *, double *, 
	    int *, double *);
    extern  int dpotrf_(char *, int *, double *, 
	    int *, int *), dpotrs_(char *, int *, int 
	    *, double *, int *, double *, int *, int *), spotrf_(char *, int *, float *, int *, int *), spotrs_(char *, int *, int *, float *, int *, 
	    float *, int *, int *);
...
/*  DSPOSV computes the solution to a float system of linear equations */
/*     A * X = B, */
