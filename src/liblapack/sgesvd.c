...
static int c__1 = 1;
static int c_n1 = -1;
static float c_b421 = 0.f;
static float c_b443 = 1.f;
	...
	int *ldvt, float *work, int *lwork, int *info)
{
    ...
    extern  int sgemm_(char *, char *, int *, int *, 
	    ...
	    float *, int *);
    int minmn, wrkbl, itaup, itauq, mnthr, iwork;
...
, float *, int *, int *), sormbr_(char *, char *, 
	    char *, int *, int *, int *, float *, int *, float *
, float *, int *, float *, int *, int *);
    int ldwrkr, minwrk, ldwrku, maxwrk;
    extern  int sorglq_(int *, int *, int *, float 
...
/*  SGESVD computes the singular value decomposition (SVD) of a float */
