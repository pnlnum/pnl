	...
	work, double *rwork, int *info)
{
    ...
    extern double zlanhp_(char *, char *, int *, doublecomplex *, 
	    double *);
    extern  int zlaqhp_(char *, int *, doublecomplex *, 
	    double *, double *, double *, char *),
	     zlacpy_(char *, int *, int *, doublecomplex *, int *, 
	     doublecomplex *, int *), zppcon_(char *, int *, 
	    doublecomplex *, double *, double *, doublecomplex *, 
	    double *, int *);
    double smlnum;
    extern  int zppequ_(char *, int *, doublecomplex *, 
	    double *, double *, double *, int *), 
	    zpprfs_(char *, int *, int *, doublecomplex *, 
	    doublecomplex *, doublecomplex *, int *, doublecomplex *, 
	    int *, double *, double *, doublecomplex *, 
	    double *, int *), zpptrf_(char *, int *, 
	    doublecomplex *, int *), zpptrs_(char *, int *, 
