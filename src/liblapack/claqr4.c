...
static int c__3 = 3;
 ...
 int claqr4_(int *wantt, int *wantz, int *n, 
	...
	work, int *lwork, int *info)
{
    ...
    extern  int claqr2_(int *, int *, int *, 
	    int *, int *, int *, complex *, int *, int *, 
	    int *, complex *, int *, int *, int *, complex *, 
	    complex *, int *, int *, complex *, int *, int *, 
	    complex *, int *, complex *, int *), claqr5_(int *, 
	    int *, int *, int *, int *, int *, int *, 
	    complex *, complex *, int *, int *, int *, complex *, 
	    int *, complex *, int *, complex *, int *, int *, 
	    complex *, int *, int *, complex *, int *);
    int nibble;
