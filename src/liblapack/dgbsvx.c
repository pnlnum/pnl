	...
	double *berr, double *work, int *iwork, int *info)
{
    ...
    extern  int dlaqgb_(int *, int *, int *, 
	    int *, double *, int *, double *, double *, 
	    double *, double *, double *, char *), 
	    dgbcon_(char *, int *, int *, int *, double *, 
	    int *, int *, double *, double *, double *, 
	    int *, int *);
    double colcnd;
    extern double dlantb_(char *, char *, char *, int *, int *, 
	    double *, int *, double *);
    extern  int dgbequ_(int *, int *, int *, 
	    int *, double *, int *, double *, double *, 
	    double *, double *, double *, int *), dgbrfs_(
	    char *, int *, int *, int *, int *, double *, 
	    int *, double *, int *, int *, double *, 
	    int *, double *, int *, double *, double *, 
	    double *, int *, int *), dgbtrf_(int *, 
    ...
    extern  int dlacpy_(char *, int *, int *, 
	    ...
	    xerbla_(char *, int *);
    double bignum;
    extern  int dgbtrs_(char *, int *, int *, int 
	    *, int *, double *, int *, int *, double *, 
	    int *, int *);
    int infequ;
    int colequ;
...
/*  DGBSVX uses the LU factorization to compute the solution to a float */
