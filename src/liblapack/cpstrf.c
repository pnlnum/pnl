...
static float c_b30 = 1.f;

 int cpstrf_(char *uplo, int *n, complex *a, int *lda, 
	 int *piv, int *rank, float *tol, float *work, int *info)
{
    ...
    float ajj;
    int pvt;
    extern  int cherk_(char *, char *, int *, int *, 
	    float *, complex *, int *, float *, complex *, int *);
...
, int *);
    ...
    int upper;
    float sstop;
    extern  int cpstf2_(char *, int *, complex *, int 
	    *, int *, int *, float *, float *, int *), 
	    clacgv_(int *, complex *, int *);
