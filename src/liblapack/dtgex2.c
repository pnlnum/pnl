	...
	n1, int *n2, double *work, int *lwork, int *info)
{
    ...
    double taur[4], scpy[16]	/* was [4][4] */, tcpy[16]	/* 
	    was [4][4] */;
    ...
    int iwork[4];
    extern  int dlagv2_(double *, int *, double *, 
	     int *, double *, double *, double *, double *
, double *, double *, double *), dgeqr2_(int *, 
	    int *, double *, int *, double *, double *, 
	    int *), dgerq2_(int *, int *, double *, int *, 
	     double *, double *, int *), dorg2r_(int *, 
	    int *, int *, double *, int *, double *, 
	    double *, int *), dorgr2_(int *, int *, int *, 
	     double *, int *, double *, double *, int *), 
	    dorm2r_(char *, char *, int *, int *, int *, 
	    double *, int *, double *, double *, int *, 
	    double *, int *), dormr2_(char *, char *, 
	    int *, int *, int *, double *, int *, 
	    double *, double *, int *, double *, int *), dtgsy2_(char *, int *, int *, int *, 
    ...
    extern  int dlacpy_(char *, int *, int *, 
	    ...
	    double *), dlaset_(char *, int *, int *, double *, 
	     double *, double *, int *), dlassq_(int *
, double *, int *, double *, double *);
    int dtrong;
