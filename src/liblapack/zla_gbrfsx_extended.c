...
static double c_b31 = 1.;
 ...
 int zla_gbrfsx_extended__(int *prec_type__, int *
	trans_type__, int *n, int *kl, int *ku, int *nrhs, 
	doublecomplex *ab, int *ldab, doublecomplex *afb, int *ldafb, 
	int *ipiv, int *colequ, double *c__, doublecomplex *b, 
	int *ldb, doublecomplex *y, int *ldy, double *berr_out__, 
	int *n_norms__, double *err_bnds_norm__, double *
	err_bnds_comp__, doublecomplex *res, double *ayb, doublecomplex *
	dy, doublecomplex *y_tail__, double *rcond, int *ithresh, 
	...
	int *info)
{
    ...
    int i__, j, m;
    extern  int zla_gbamv__(int *, int *, int *, 
...
, int *, doublecomplex *, doublecomplex *, int *, 
    ...
    double normdx;
    extern  int zgbtrs_(char *, int *, int *, int 
