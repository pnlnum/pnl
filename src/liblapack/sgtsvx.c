	...
	int *info)
{
    ...
    extern double slangt_(char *, int *, float *, float *, float *);
    extern  int slacpy_(char *, int *, int *, float *, 
	    int *, float *, int *), sgtcon_(char *, int *, 
	    float *, float *, float *, float *, int *, float *, float *, float *, 
	     int *, int *);
    int notran;
    extern  int sgtrfs_(char *, int *, int *, float *, 
	    float *, float *, float *, float *, float *, float *, int *, float *, 
	     int *, float *, int *, float *, float *, float *, int *, 
	    int *), sgttrf_(int *, float *, float *, float *, 
	    float *, int *, int *), sgttrs_(char *, int *, int 
...
/*  SGTSVX uses the LU factorization to compute the solution to a float */
