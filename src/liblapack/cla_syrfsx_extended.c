...
static float c_b33 = 1.f;
 ...
 int cla_syrfsx_extended__(int *prec_type__, char *uplo, 
	...
	int *info, unsigned long uplo_len)
{
    ...
    int i__, j;
    int incr_prec__;
    extern  int cla_syamv__(int *, int *, float *, 
    ...
    float ymin;
    int y_prec_state__;
    extern  int blas_csymv_x__(int *, int *, complex *
	    , complex *, int *, complex *, int *, complex *, complex *
	    , int *, int *);
    int uplo2;
    extern int lsame_(char *, char *);
    extern  int blas_csymv2_x__(int *, int *, complex 
	    *, complex *, int *, complex *, complex *, int *, complex 
	    *, complex *, int *, int *), ccopy_(int *, complex *, 
	    int *, complex *, int *);
    float dxrat, dzrat;
    extern  int caxpy_(int *, complex *, complex *, 
	    int *, complex *, int *), csymv_(char *, int *, 
