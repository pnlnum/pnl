...
static int c_n1 = -1;
static int c__1 = 1;
static float c_b80 = 0.f;

 int cgelsd_(int *m, int *n, int *nrhs, complex *
	a, int *lda, complex *b, int *ldb, float *s, float *rcond, 
	...
	iwork, int *info)
{
    ...
    int ie, il, mm;
    float eps, anrm, bnrm;
    int itau, nlvl, iascl, ibscl;
    float sfmin;
    int minmn, maxmn, itaup, itauq, mnthr, nwork;
    ...
    extern  int cgelqf_(int *, int *, complex *, 
	    int *, complex *, complex *, int *, int *), clalsd_(
	    char *, int *, int *, int *, float *, float *, complex *
, int *, float *, int *, complex *, float *, int *, 
	    int *), clascl_(char *, int *, int *, float *, 
	    float *, int *, int *, complex *, int *, int *), cgeqrf_(int *, int *, complex *, int *, 
    ...
    extern  int slascl_(char *, int *, int *, float *, 
	    ...
	    complex *, int *, int *), slaset_(
	    char *, int *, int *, float *, float *, float *, int *), cunmlq_(char *, char *, int *, int *, int *, 
...
/*  CGELSD computes the minimum-norm solution to a float linear least */
/*  squares problem: */
...
/* Computing MAX */
	    i__1 = (int) (log((float) minmn / (float) (smlsiz + 1)) / log(
		    2.f)) + 1;
	    nlvl = MAX(i__1,0);
