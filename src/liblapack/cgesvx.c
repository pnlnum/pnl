	...
	complex *work, float *rwork, int *info)
{
    ...
    extern  int claqge_(int *, int *, complex *, 
	    ...
	    , cgecon_(char *, int *, complex *, int *, float *, float *, 
	     complex *, float *, int *);
    float colcnd;
    extern double slamch_(char *);
    extern  int cgeequ_(int *, int *, complex *, 
	    int *, float *, float *, float *, float *, float *, int *);
    int nofact;
    extern  int cgerfs_(char *, int *, int *, complex 
	    *, int *, complex *, int *, int *, complex *, int 
	    *, complex *, int *, float *, float *, complex *, float *, 
	    int *), cgetrf_(int *, int *, complex *, 
