...
static int c__1 = 1;
 ...
 int chpgvd_(int *itype, char *jobz, char *uplo, int *
	n, complex *ap, complex *bp, float *w, complex *z__, int *ldz, 
	...
	iwork, int *liwork, int *info)
{
    ...
    extern  int ctpsv_(char *, char *, char *, int *, 
	    complex *, complex *, int *);
    int wantz;
    extern  int chpevd_(char *, char *, int *, complex *, 
	    float *, complex *, int *, complex *, int *, float *, 
	    int *, int *, int *, int *), 
	    xerbla_(char *, int *), chpgst_(int *, char *, 
	    int *, complex *, complex *, int *), cpptrf_(char 
	    *, int *, complex *, int *);
    int liwmin, lrwmin;
    int lquery;
...
/* Computing MAX */
    r__1 = (float) lwmin, r__2 = work[1].r;
    lwmin = MAX(r__1,r__2);
/* Computing MAX */
    r__1 = (float) lrwmin;
    lrwmin = MAX(r__1,rwork[1]);
/* Computing MAX */
    r__1 = (float) liwmin, r__2 = (float) iwork[1];
