	...
	ldbb, double *x, int *ldx, double *work, int *info)
{
    ...
    extern  int dger_(int *, int *, double *, 
	    ...
	    int *), drot_(int *, double *, int *, double *
, int *, double *, double *), dscal_(int *, 
	    double *, double *, int *);
    extern int lsame_(char *, char *);
    int upper, wantx;
    extern  int dlar2v_(int *, double *, double *, 
	     double *, int *, double *, double *, int *), 
	    dlaset_(char *, int *, int *, double *, double *, 
	    double *, int *), dlartg_(double *, 
	    double *, double *, double *, double *), xerbla_(
	    char *, int *), dlargv_(int *, double *, 
	    int *, double *, int *, double *, int *);
    int update;
    extern  int dlartv_(int *, double *, int *, 
	    double *, int *, double *, double *, int *);
...
/*  DSBGST reduces a float symmetric-definite banded generalized */
