...
static int c__1 = 1;
 ...
 int chetd2_(char *uplo, int *n, complex *a, int *lda, 
	 float *d__, float *e, complex *tau, int *info)
{
...
), caxpy_(int *, complex *, complex *, int *, 
	    complex *, int *);
    int upper;
...
/*  CHETD2 reduces a complex Hermitian matrix A to float symmetric */
