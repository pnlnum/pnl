	...
	rwork, int *info)
{
    ...
    int givcol_dim1, givcol_offset, difr_dim1, difr_offset, givnum_dim1, 
    ...
    extern  int ccopy_(int *, complex *, int *, 
	    complex *, int *), sgemv_(char *, int *, int *, float *
, float *, int *, float *, int *, float *, float *, int *), csrot_(int *, complex *, int *, complex *, 
	    int *, float *, float *);
    extern double slamc3_(float *, float *);
    extern  int clascl_(char *, int *, int *, float *, 
	    float *, int *, int *, complex *, int *, int *), csscal_(int *, float *, complex *, int *), 
