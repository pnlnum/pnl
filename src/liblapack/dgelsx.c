	...
	info)
{
    ...
    extern  int dtrsm_(char *, char *, char *, char *, 
	    ...
	    double *, double *, double *, double *), dorm2r_(
    ...
    extern  int dlascl_(char *, int *, int *, 
	    ...
	    int *), dlaset_(char *, int *, int *, double *, 
	    double *, double *, int *), xerbla_(char *, 
	    int *);
    double bignum;
    extern  int dlatzm_(char *, int *, int *, 
	    double *, int *, double *, double *, double *, 
	     int *, double *);
    double sminpr, smaxpr, smlnum;
    extern  int dtzrqf_(int *, int *, double *, 
	    int *, double *, int *);
...
/*  DGELSX computes the minimum-norm solution to a float linear least */
/*  squares problem: */
/*      minimize || A * X - B || */
