...
static int c__1 = 1;
 ...
 int chbgst_(char *vect, char *uplo, int *n, int *ka, 
	...
	complex *x, int *ldx, complex *work, float *rwork, int *info)
{
    ...
    extern  int crot_(int *, complex *, int *, 
	    complex *, int *, float *, complex *), cgerc_(int *, 
	    int *, complex *, complex *, int *, complex *, int *, 
	    complex *, int *);
    extern int lsame_(char *, char *);
    extern  int cgeru_(int *, int *, complex *, 
    ...
    extern  int clar2v_(int *, complex *, complex *, 
	    ...
	    complex *, complex *, complex *, int *), clartg_(
	    complex *, complex *, float *, complex *, complex *), xerbla_(char 
	    *, int *), clargv_(int *, complex *, int *, 
	    complex *, int *, float *, int *);
    int update;
    extern  int clartv_(int *, complex *, int *, 
...
/*     The float cosines and complex sines of the rotations are stored in */
