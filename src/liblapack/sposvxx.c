...
#include "pnl/pnl_f2c.h"
 ...
 int sposvxx_(char *fact, char *uplo, int *n, int *
	...
	params, float *work, int *iwork, int *info)
{
    ...
    extern double sla_porpvgrw__(char *, int *, float *, int *, 
	    float *, int *, float *, unsigned long);
    ...
    extern  int slaqsy_(char *, int *, float *, int *, 
	    float *, float *, float *, char *), spotrf_(char *, 
	    int *, float *, int *, int *), spotrs_(char *, 
	    int *, int *, float *, int *, float *, int *, 
	    int *), slascl2_(int *, int *, float *, float *, 
	     int *), spoequb_(int *, float *, int *, float *, float *
, float *, int *), sporfsx_(char *, char *, int *, int 
...
/*     to compute the solution to a float system of linear equations */
...
/*           leading rank-deficient INFO columns of A. */
	    ...
	    *rpvgrw = sla_porpvgrw__(uplo, info, &a[a_offset], lda, &af[
		    af_offset], ldaf, &work[1], (unsigned long)1);
	    return 0;
	}
    }
