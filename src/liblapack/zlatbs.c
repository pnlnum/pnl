	...
	doublecomplex *x, double *scale, double *cnorm, int *info)
{
    ...
    int upper;
    extern /* Double Complex */ VOID zdotu_(doublecomplex *, int *, 
	    doublecomplex *, int *, doublecomplex *, int *);
    extern  int ztbsv_(char *, char *, char *, int *, 
	    int *, doublecomplex *, int *, doublecomplex *, int *), zaxpy_(int *, doublecomplex *, 
	    doublecomplex *, int *, doublecomplex *, int *), dlabad_(
	    double *, double *);
