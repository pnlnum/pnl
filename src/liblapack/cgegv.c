...
static int c__1 = 1;
static int c_n1 = -1;
static float c_b29 = 1.f;

 int cgegv_(char *jobvl, char *jobvr, int *n, complex *a, 
	...
	work, int *lwork, float *rwork, int *info)
{
    ...
    float safmin;
    extern  int ctgevc_(char *, char *, int *, int *, 
	    complex *, int *, complex *, int *, complex *, int *, 
	    complex *, int *, int *, int *, complex *, float *, 
	    int *);
    float safmax;
    char chtemp[1];
    int ldumma[1];
...
/*        Check for significant underflow in float part of ALPHA */
...
/* Computing MAX */
	    ...
	    r__1 = scale, r__2 = safmin / anrm1 / MAX(r__3,r__4);
	    scale = MAX(r__1,r__2);
	}
...
/* Computing MAX */
	    ...
	    r__1 = scale, r__2 = safmin / bnrm1 / MAX(r__3,r__4);
	    scale = MAX(r__1,r__2);
	}
