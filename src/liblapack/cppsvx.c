...
static int c__1 = 1;
 ...
 int cppsvx_(char *fact, char *uplo, int *n, int *
	nrhs, complex *ap, complex *afp, char *equed, float *s, complex *b, 
	int *ldb, complex *x, int *ldx, float *rcond, float *ferr, float 
	*berr, complex *work, float *rwork, int *info)
{
    ...
    extern  int claqhp_(char *, int *, complex *, float *, 
	    float *, float *, char *);
    int nofact;
    extern  int clacpy_(char *, int *, int *, complex 
	    *, int *, complex *, int *), xerbla_(char *, 
	    int *);
    float bignum;
    extern  int cppcon_(char *, int *, complex *, float *, 
	    float *, complex *, float *, int *);
    int infequ;
    extern  int cppequ_(char *, int *, complex *, float *, 
	    float *, float *, int *), cpprfs_(char *, int *, 
	    int *, complex *, complex *, complex *, int *, complex *, 
	    int *, float *, float *, complex *, float *, int *), 
	    cpptrf_(char *, int *, complex *, int *);
    float smlnum;
    extern  int cpptrs_(char *, int *, int *, complex 
	    *, complex *, int *, int *);
