...
static int c_false = FALSE;
 ...
 int zherfsx_(char *uplo, char *equed, int *n, int *
	...
	work, double *rwork, int *info)
{
    ...
    extern  int zla_herfsx_extended__(int *, char *, 
    ...
    double anorm;
    int rcequ;
    extern double zla_hercond_c__(char *, int *, doublecomplex *, 
	    int *, doublecomplex *, int *, int *, double *, 
	    int *, int *, doublecomplex *, double *, unsigned long), 
	    zla_hercond_x__(char *, int *, doublecomplex *, int *, 
    ...
    extern double zlanhe_(char *, char *, int *, doublecomplex *, 
	    int *, double *);
    extern  int zhecon_(char *, int *, doublecomplex *, 
