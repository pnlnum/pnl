...
#include "pnl/pnl_f2c.h"
 ...
 int cgbequb_(int *m, int *n, int *kl, int *
	ku, complex *ab, int *ldab, float *r__, float *c__, float *rowcnd, 
	float *colcnd, float *amax, int *info)
{
    ...
    /* Builtin functions */
    double log(double), r_imag(complex *), pow_ri(float *, int *);

    /* Local variables */
    int i__, j, kd;
    float radix, rcmin, rcmax;
    extern double slamch_(char *);
    extern  int xerbla_(char *, int *);
    float bignum, logrdx, smlnum;
