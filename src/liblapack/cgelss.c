...
static float c_b78 = 0.f;
 ...
 int cgelss_(int *m, int *n, int *nrhs, complex *
...
, int *);
    ...
    extern  int ccopy_(int *, complex *, int *, 
	    complex *, int *);
    int minmn, maxmn, itaup, itauq, mnthr, iwork;
...
, complex *, int *, int *), cgeqrf_(int *, 
    ...
    extern  int clacpy_(char *, int *, int *, complex 
	    *, int *, complex *, int *), claset_(char *, 
	    int *, int *, complex *, complex *, complex *, int *), xerbla_(char *, int *), cbdsqr_(char *, 
    ...
    extern  int cungbr_(char *, int *, int *, int 
	    ...
	    *), slascl_(char *, int *, int *, float *, float *, 
	    int *, int *, float *, int *, int *), 
	    cunmbr_(char *, char *, char *, int *, int *, int *, 
	    complex *, int *, complex *, complex *, int *, complex *, 
	    int *, int *), csrscl_(int *, 
	    float *, complex *, int *), slaset_(char *, int *, int 
	    *, float *, float *, float *, int *), cunmlq_(char *, 
