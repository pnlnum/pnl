	...
	iwork, int *liwork, int *info)
{
    ...
    double smlnum;
    extern  int zstein_(int *, double *, double *, 
	     int *, double *, int *, int *, doublecomplex *, 
	    int *, double *, int *, int *, int *);
    int lquery;
    int lwkopt;
    extern double zlansy_(char *, char *, int *, doublecomplex *, 
	    int *, double *);
    extern  int zstemr_(char *, char *, int *, double 
	    *, double *, double *, double *, int *, int *, 
	     int *, double *, doublecomplex *, int *, int *, 
	    int *, int *, double *, int *, int *, int 
	    *, int *), zunmtr_(char *, char *, char *, 
