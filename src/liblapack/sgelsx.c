	...
	int *rank, float *work, int *info)
{
    ...
    extern  int strsm_(char *, char *, char *, char *, 
	    ...
	    float *, float *, float *, float *, float *, float *, float *), sorm2r_(
...
, float *, float *, int *, float *, int *), 
    ...
    extern  int slascl_(char *, int *, int *, float *, 
	    float *, int *, int *, float *, int *, int *), sgeqpf_(int *, int *, float *, int *, int 
	    *, float *, float *, int *), slaset_(char *, int *, int 
	    *, float *, float *, float *, int *);
    float sminpr, smaxpr, smlnum;
    extern  int slatzm_(char *, int *, int *, float *, 
	    int *, float *, float *, float *, int *, float *), 
	    stzrqf_(int *, int *, float *, int *, float *, int *
);
...
/*  SGELSX computes the minimum-norm solution to a float linear least */
/*  squares problem: */
/*      minimize || A * X - B || */
