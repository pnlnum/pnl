...
static int c__1 = 1;
 ...
 int cgeqpf_(int *m, int *n, complex *a, int *lda, 
	 int *jpvt, complex *tau, complex *work, float *rwork, int *
	info)
{
...
, int *, complex *, complex *, int *, complex *), 
	    cswap_(int *, complex *, int *, complex *, int *);
    int itemp;
    ...
    extern  int cunm2r_(char *, char *, int *, int *, 
	    ...
	    complex *, int *), clarfp_(int *, complex 
	    *, complex *, int *, complex *);
