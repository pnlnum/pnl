	 ...
	 int *info)
{
    ...
    extern  int dcopy_(int *, double *, int *, 
	    double *, int *);
    int maxmn, itaup, itauq, mnthr, iwork;
    ...
    extern  int dormbr_(char *, char *, char *, int *, 
	    int *, int *, double *, int *, double *, 
	    double *, int *, double *, int *, int *), dormlq_(char *, char *, int *, 
	    int *, int *, double *, int *, double *, 
...
/*  DGELSS computes the minimum norm solution to a float linear least */
/*  squares problem: */
