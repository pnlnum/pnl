...
static int c__1 = 1;
static float c_b34 = 0.f;
static float c_b35 = 1.f;
static int c__0 = 0;
static int c_n1 = -1;

 int sgejsv_(char *joba, char *jobu, char *jobv, char *jobr, 
	char *jobt, char *jobp, int *m, int *n, float *a, int *lda, 
	 float *sva, float *u, int *ldu, float *v, int *ldv, float *work, 
	int *lwork, int *iwork, int *info)
{
    /* System generated locals */
    int a_dim1, a_offset, u_dim1, u_offset, v_dim1, v_offset, i__1, i__2, 
    ...
    float condr1, condr2, uscal1, uscal2;
    int l2kill, l2rank, l2tran;
    extern  int sgeqp3_(int *, int *, float *, int 
    ...
    int noscal;
    extern  int sgelqf_(int *, int *, float *, int 
	    *, float *, float *, int *, int *);
    extern int isamax_(int *, float *, int *);
    extern  int slascl_(char *, int *, int *, float *, 
	    float *, int *, int *, float *, int *, int *), sgeqrf_(int *, int *, float *, int *, float *, 
	    float *, int *, int *), slacpy_(char *, int *, int 
	    *, float *, int *, float *, int *), slaset_(char *, 
	    int *, int *, float *, float *, float *, int *);
    float entrat;
    int almort;
    float maxprj;
    extern  int spocon_(char *, int *, float *, int *, 
	    float *, float *, float *, int *, int *);
    int errest;
    extern  int sgesvj_(char *, char *, char *, int *, 
	    int *, float *, int *, float *, int *, float *, int *
, float *, int *, int *), slassq_(
	    int *, float *, int *, float *, float *);
    int transp;
    extern  int slaswp_(int *, float *, int *, int 
	    *, int *, int *, int *), sorgqr_(int *, int *, 
	     int *, float *, int *, float *, float *, int *, int 
	    *), sormlq_(char *, char *, int *, int *, int *, float 
	    *, int *, float *, float *, int *, float *, int *, 
	    int *), sormqr_(char *, char *, int *, 
...
/*  Purpose */
/*  ~~~~~~~ */
/*  SGEJSV computes the singular value decomposition (SVD) of a float M-by-N */
...
/* .             condition number of B. It provides a floatistic error bound. */
...
/*     column norm left from the underflow threshold (extreme case). */
    ...
    scalem = 1.f / sqrt((float) (*m) * (float) (*n));
    noscal = TRUE;
    goscal = TRUE;
    i__1 = *n;
    for (p = 1; p <= i__1; ++p) {
...
/* Computing 2nd power */
	r__1 = maxprj;
	if (r__1 * r__1 >= 1.f - (float) (*n) * epsln) {
	    almort = TRUE;
	}
    }
...
/* #:(          This is a rather pathoint case: no scaled condition */
