	...
	doublecomplex *ab, int *ldab, int *info)
{
    ...
    extern  int zgemm_(char *, char *, int *, int *, 
	    ...
	    int *, double *, doublecomplex *, int *, double *, 
	     doublecomplex *, int *), ztrsm_(char *, char 
	    *, char *, char *, int *, int *, doublecomplex *, 
	    doublecomplex *, int *, doublecomplex *, int *), zpbtf2_(char *, int *, int *, 
	    doublecomplex *, int *, int *), zpotf2_(char *, 
