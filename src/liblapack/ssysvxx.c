...
#include "pnl/pnl_f2c.h"
 ...
 int ssysvxx_(char *fact, char *uplo, int *n, int *
	...
	params, float *work, int *iwork, int *info)
{
    ...
    /* Local variables */
    extern  int ssyrfsx_(char *, char *, int *, int *, 
	     float *, int *, float *, int *, int *, float *, float *, 
	    int *, float *, int *, float *, float *, int *, float *, 
	    float *, int *, float *, float *, int *, int *);
    int j;
    float amax, smin, smax;
    extern double sla_syrpvgrw__(char *, int *, int *, float *, 
	    int *, float *, int *, int *, float *, unsigned long);
    ...
    extern  int slacpy_(char *, int *, int *, float *, 
	    int *, float *, int *);
    float smlnum;
    extern  int slaqsy_(char *, int *, float *, int *, 
	    float *, float *, float *, char *), ssytrf_(char *, 
	    int *, float *, int *, int *, float *, int *, 
	    int *), slascl2_(int *, int *, float *, float *, 
	     int *), ssytrs_(char *, int *, int *, float *, 
	    int *, int *, float *, int *, int *), 
	    ssyequb_(char *, int *, float *, int *, float *, float *, 
	    float *, float *, int *);
...
/*     solution to a float system of linear equations A * X = B, where A */
...
/*           leading rank-deficient INFO columns of A. */
		...
		*rpvgrw = sla_syrpvgrw__(uplo, n, info, &a[a_offset], lda, &
			af[af_offset], ldaf, &ipiv[1], &work[1], (unsigned long)1);
	    }
	    return 0;
	}
    }
...
/*     Compute the reciprocal pivot growth factor RPVGRW. */
	...
	*rpvgrw = sla_syrpvgrw__(uplo, n, info, &a[a_offset], lda, &af[
		af_offset], ldaf, &ipiv[1], &work[1], (unsigned long)1);
    }
