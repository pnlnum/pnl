...
static int c__1 = 1;
 ...
 int cpprfs_(char *uplo, int *n, int *nrhs, complex *
	ap, complex *afp, complex *b, int *ldb, complex *x, int *ldx, 
	float *ferr, float *berr, complex *work, float *rwork, int *info)
{
    ...
    extern  int ccopy_(int *, complex *, int *, 
	    complex *, int *), chpmv_(char *, int *, complex *, 
	    complex *, complex *, int *, complex *, complex *, int *), caxpy_(int *, complex *, complex *, int *, 
	    complex *, int *);
    int count;
    int upper;
    ...
    float safmin;
    extern  int xerbla_(char *, int *), cpptrs_(
	    char *, int *, int *, complex *, complex *, int *, 
	    int *);
    float lstres;
...
/*        Compute ABS(A)*ABS(X) + ABS(B). */
	...
	if (upper) {
		...
		for (i__ = 1; i__ <= i__3; ++i__) {
		    ...
		    i__4 = ik;
		    i__5 = i__ + j * x_dim1;
		    s += ((r__1 = ap[i__4].r, ABS(r__1)) + (r__2 = r_imag(&
			    ap[ik]), ABS(r__2))) * ((r__3 = x[i__5].r, ABS(
...
/* L40: */
		...
		i__3 = kk + k - 1;
		rwork[k] = rwork[k] + (r__1 = ap[i__3].r, ABS(r__1)) * xk + 
			s;
		kk += k;
/* L50: */
	    }
