...
static int c__1 = 1;
 ...
 int cggsvd_(char *jobu, char *jobv, char *jobq, int *m, 
	...
	lda, complex *b, int *ldb, float *alpha, float *beta, complex *u, 
	int *ldu, complex *v, int *ldv, complex *q, int *ldq, 
	complex *work, float *rwork, int *iwork, int *info)
{
    ...
    extern  int ctgsja_(char *, char *, char *, int *, 
	    int *, int *, int *, int *, complex *, int *, 
	    complex *, int *, float *, float *, float *, float *, complex *, 
	    int *, complex *, int *, complex *, int *, complex *, 
	    int *, int *);
    int ncycle;
    extern  int xerbla_(char *, int *), cggsvp_(
	    char *, char *, char *, int *, int *, int *, complex *
, int *, complex *, int *, float *, float *, int *, 
	    int *, complex *, int *, complex *, int *, complex *, 
	    int *, int *, float *, complex *, complex *, int *);
