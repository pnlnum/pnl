...
static list vect_tests[] =
  {
    ...
    MAKE_ENUM(5, pnl_vect_create_from_double_test),
    ...
    MAKE_ENUM(12, pnl_vect_mult_double_test),
    MAKE_ENUM(13, pnl_vect_inv_term_test),
    MAKE_ENUM(14, pnl_vect_div_vect_term_test),
    MAKE_ENUM(15, pnl_vect_mult_vect_term_test),
    MAKE_ENUM(16, pnl_vect_set_double_test),
    MAKE_ENUM(17, pnl_vect_sum_test),
    MAKE_ENUM(18, pnl_vect_map_test),
    /*MAKE_ENUM(19, pnl_vect_map_vect_test),*/
    MAKE_ENUM(20, pnl_vect_scalar_prod_test),
    MAKE_ENUM(21, pnl_vect_prod_test),
    MAKE_ENUM(22, pnl_vect_minmax_test),
    MAKE_ENUM(24, pnl_vect_complex_set_test),
    MAKE_ENUM(25, pnl_vect_complex_get_test),
    MAKE_ENUM(26, pnl_vect_complex_lget_test),
    MAKE_ENUM(27, pnl_vect_complex_create_from_fcomplex_test),
    MAKE_ENUM(28, pnl_vect_complex_create_from_ptr_test),/* */
    MAKE_ENUM(29, pnl_vect_complex_copy_test),
    MAKE_ENUM(30, pnl_vect_complex_clone_test),
    MAKE_ENUM(31, pnl_vect_complex_plus_vect_test),/* */
    MAKE_ENUM(32, pnl_vect_complex_map_inplace_test),
    MAKE_ENUM(33, pnl_vect_complex_plus_complex_test),
    MAKE_ENUM(34, pnl_vect_complex_mult_complex_test),
    MAKE_ENUM(35, pnl_vect_complex_inv_term_test),
    MAKE_ENUM(36, pnl_vect_complex_div_vect_term_test),
    MAKE_ENUM(37, pnl_vect_complex_mult_vect_term_test),
    MAKE_ENUM(38, pnl_vect_complex_set_complex_test),
    MAKE_ENUM(39, pnl_vect_complex_sum_test),
    MAKE_ENUM(40, pnl_vect_complex_map_test),
    /*MAKE_ENUM(41, pnl_vect_complex_map_vect_test),*/
    MAKE_ENUM(42, pnl_vect_complex_scalar_prod_test),
    MAKE_ENUM(43, pnl_vect_complex_prod_test),
    MAKE_ENUM(44, pnl_vect_qsort_test),
    MAKE_ENUM(45, pnl_vect_extract_test),
