...
extern double pnl_bs_call_delta_forward (double Vol,double Bond, double Forward, double Strike, double Maturity); /*<! delta forward  */
extern double pnl_bs_put_delta_forward  (double Vol,double Bond, double Forward, double Strike, double Maturity); /*<! delta forward */
extern double pnl_bs_call_put (int Is_Call, double Vol,double Bond, double Forward, double Strike, double Maturity);
extern double pnl_bs_call_put_delta_forward (int Is_Call, double Vol,double Bond, double Forward, double Strike, double Maturity);
...
extern double pnl_bs_implicit_vol(int Is_Call, double Price,double Bond, double Forward, double Strike, double Maturity);  
extern int pnl_bs_matrix_implicit_vol(const PnlMatUint * Is_Call, const PnlMat * Price,double spot,double rate, double divid, 
                                      const PnlVect * Strike,const PnlVect * Maturity,PnlMat * Vol);

extern int pnl_cf_call_bs(double s,double k,double t,double r,double divid,double sigma,double *ptprice,double *ptdelta);
extern int pnl_cf_put_bs(double s,double k,double t,double r,double divid,double sigma,double *ptprice,double *ptdelta);
