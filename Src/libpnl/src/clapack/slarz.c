...
/*           w( 1:n ) = w( 1:n ) + C( m-l+1:m, 1:n )' * v( 1:l ) */
	    ...
	    sgemv_("Transpose", l, n, &c_b5, &c___ref(*m - *l + 1, 1), ldc, &
...
/*           C( m-l+1:m, 1:n ) = C( m-l+1:m, 1:n ) - ...   
	    ...
	    r__1 = -(*tau);
	    sger_(l, n, &r__1, &v[1], incv, &work[1], &c__1, &c___ref(*m - *l 
		    + 1, 1), ldc);
	}
...
/*           w( 1:m ) = w( 1:m ) + C( 1:m, n-l+1:n, 1:n ) * v( 1:l ) */
	    ...
	    sgemv_("No transpose", m, l, &c_b5, &c___ref(1, *n - *l + 1), ldc,
		     &v[1], incv, &c_b5, &work[1], &c__1);
...
/*           C( 1:m, n-l+1:n ) = C( 1:m, n-l+1:n ) - ...   
	    ...
	    r__1 = -(*tau);
	    sger_(m, l, &r__1, &work[1], &c__1, &v[1], incv, &c___ref(1, *n - 
		    *l + 1), ldc);
