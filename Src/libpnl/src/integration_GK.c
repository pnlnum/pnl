...
/* The function pnl_integration_GK and all the values declared in the static
 * arrays of this file originnaly come from the GSL with the following 
 * copyright
 *
 *
 * GSL Copyright (C) 1996, 1997, 1998, 1999, 2000, 2007 Brian Gough
 * 
 * This program is free software; you can redistribute it and/or modify
 * it under the terms of the GNU General Public License as published by
