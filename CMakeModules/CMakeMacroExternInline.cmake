...
function(check_extern_inline result)
    ...
    if(HAS_EXTERN_INLINE)
        set(HAVE_INLINE true cache internal "have 'extern inline' definition")
...
if (HAS_EXTERN_INLINE OR HAS_C99_INLINE)
    set(HAVE_INLINE true cache internal "Can build inline functions")
else ()
    set(HAVE_INLINE false cache internal "Cannot build inline functions")
